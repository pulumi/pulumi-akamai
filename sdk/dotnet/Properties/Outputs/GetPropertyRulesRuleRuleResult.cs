...
namespace Pulumi.Akamai.Properties.Outputs
{
    ...
    public sealed class GetPropertyRulesRuleRuleResult
    {
        ...
        [OutputConstructor]
        private GetPropertyRulesRuleRuleResult(
            ImmutableArray<Outputs.GetPropertyRulesRuleRuleBehaviorResult> behaviors,

            string? comment,

            string? criteriaMatch,

            ImmutableArray<Outputs.GetPropertyRulesRuleRuleCriteriaResult> criterias,

            string name,

            ImmutableArray<Outputs.GetPropertyRulesRuleRuleRuleResult> rules)
        {
            Behaviors = behaviors;
            Comment = comment;
