...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class GetPropertyRulesBuilderRulesV20240531CriterionInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionAdvancedImMatchInputArgs>? AdvancedImMatch { get; set; }
        ...
        /// </summary>
        [Input("bucket")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionBucketInputArgs>? Bucket { get; set; }
        ...
        /// </summary>
        [Input("cacheability")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionCacheabilityInputArgs>? Cacheability { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionChinaCdnRegionInputArgs>? ChinaCdnRegion { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionClientCertificateInputArgs>? ClientCertificate { get; set; }
        ...
        /// </summary>
        [Input("clientIp")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionClientIpInputArgs>? ClientIp { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionClientIpVersionInputArgs>? ClientIpVersion { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionCloudletsOriginInputArgs>? CloudletsOrigin { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionContentDeliveryNetworkInputArgs>? ContentDeliveryNetwork { get; set; }

        /// <summary>
        /// Matches the HTTP response header's `Content-Type`. This criterion can be used in includes.
        /// </summary>
        [Input("contentType")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionContentTypeInputArgs>? ContentType { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionDeviceCharacteristicInputArgs>? DeviceCharacteristic { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdAuthGroups")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionEcmdAuthGroupsInputArgs>? EcmdAuthGroups { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdAuthScheme")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionEcmdAuthSchemeInputArgs>? EcmdAuthScheme { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdIsAuthenticated")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionEcmdIsAuthenticatedInputArgs>? EcmdIsAuthenticated { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdUsername")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionEcmdUsernameInputArgs>? EcmdUsername { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionEdgeWorkersFailureInputArgs>? EdgeWorkersFailure { get; set; }

        /// <summary>
        /// Matches the requested filename's extension, if present. This criterion can be used in includes.
        /// </summary>
        [Input("fileExtension")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionFileExtensionInputArgs>? FileExtension { get; set; }

        /// <summary>
        /// Matches the requested filename, or test whether it is present. This criterion can be used in includes.
        /// </summary>
        [Input("filename")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionFilenameInputArgs>? Filename { get; set; }

        /// <summary>
        /// Matches the requested hostname. This criterion can be used in includes.
        /// </summary>
        [Input("hostname")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionHostnameInputArgs>? Hostname { get; set; }
        ...
        /// </summary>
        [Input("matchAdvanced")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionMatchAdvancedInputArgs>? MatchAdvanced { get; set; }

        /// <summary>
        /// Match the assigned content provider code. This criterion can be used in includes.
        /// </summary>
        [Input("matchCpCode")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionMatchCpCodeInputArgs>? MatchCpCode { get; set; }

        /// <summary>
        /// Match a set or range of HTTP response codes. This criterion can be used in includes.
        /// </summary>
        [Input("matchResponseCode")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionMatchResponseCodeInputArgs>? MatchResponseCode { get; set; }
        ...
        /// </summary>
        [Input("matchVariable")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionMatchVariableInputArgs>? MatchVariable { get; set; }
        ...
        /// </summary>
        [Input("metadataStage")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionMetadataStageInputArgs>? MetadataStage { get; set; }

        /// <summary>
        /// Matches when the origin responds with a timeout error. This criterion can be used in includes.
        /// </summary>
        [Input("originTimeout")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionOriginTimeoutInputArgs>? OriginTimeout { get; set; }

        /// <summary>
        /// Matches the URL's non-hostname path component. This criterion can be used in includes.
        /// </summary>
        [Input("path")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionPathInputArgs>? Path { get; set; }

        /// <summary>
        /// Matches query string field names or values. This criterion can be used in includes.
        /// </summary>
        [Input("queryStringParameter")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionQueryStringParameterInputArgs>? QueryStringParameter { get; set; }
        ...
        /// </summary>
        [Input("random")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRandomInputArgs>? Random { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRecoveryConfigInputArgs>? RecoveryConfig { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRegularExpressionInputArgs>? RegularExpression { get; set; }

        /// <summary>
        /// Match the cookie name or value passed with the request. This criterion can be used in includes.
        /// </summary>
        [Input("requestCookie")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRequestCookieInputArgs>? RequestCookie { get; set; }

        /// <summary>
        /// Match HTTP header names or values. This criterion can be used in includes.
        /// </summary>
        [Input("requestHeader")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRequestHeaderInputArgs>? RequestHeader { get; set; }
        ...
        /// </summary>
        [Input("requestMethod")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRequestMethodInputArgs>? RequestMethod { get; set; }

        /// <summary>
        /// Matches whether the request uses the HTTP or HTTPS protocol. This criterion can be used in includes.
        /// </summary>
        [Input("requestProtocol")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRequestProtocolInputArgs>? RequestProtocol { get; set; }
        ...
        /// </summary>
        [Input("requestType")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionRequestTypeInputArgs>? RequestType { get; set; }

        /// <summary>
        /// Match HTTP header names or values. This criterion can be used in includes.
        /// </summary>
        [Input("responseHeader")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionResponseHeaderInputArgs>? ResponseHeader { get; set; }

        /// <summary>
        /// The location of the Akamai server handling the request. This criterion can be used in includes.
        /// </summary>
        [Input("serverLocation")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionServerLocationInputArgs>? ServerLocation { get; set; }

        /// <summary>
        /// Specifies ranges of times during which the request occurred. This criterion can be used in includes.
        /// </summary>
        [Input("time")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionTimeInputArgs>? Time { get; set; }

        /// <summary>
        /// Match on Auth Token 2.0 verification results. This criterion can be used in includes.
        /// </summary>
        [Input("tokenAuthorization")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionTokenAuthorizationInputArgs>? TokenAuthorization { get; set; }

        /// <summary>
        /// Matches the user agent string that helps identify the client browser and device. This criterion can be used in includes.
        /// </summary>
        [Input("userAgent")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionUserAgentInputArgs>? UserAgent { get; set; }
        ...
        /// </summary>
        [Input("userLocation")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionUserLocationInputArgs>? UserLocation { get; set; }
        ...
        /// </summary>
        [Input("userNetwork")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionUserNetworkInputArgs>? UserNetwork { get; set; }
        ...
        /// </summary>
        [Input("variableError")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionVariableErrorInputArgs>? VariableError { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionVirtualWaitingRoomRequestInputArgs>? VirtualWaitingRoomRequest { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240531CriterionVisitorPrioritizationRequestInputArgs>? VisitorPrioritizationRequest { get; set; }

        public GetPropertyRulesBuilderRulesV20240531CriterionInputArgs()
        {
        }
        public static new GetPropertyRulesBuilderRulesV20240531CriterionInputArgs Empty => new GetPropertyRulesBuilderRulesV20240531CriterionInputArgs();
    }
}
