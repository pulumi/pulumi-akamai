...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class OriginInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.OriginCustomCertificateAuthorityInputArgs>? _customCertificateAuthorities;
        public InputList<Inputs.OriginCustomCertificateAuthorityInputArgs> CustomCertificateAuthorities
        {
            get => _customCertificateAuthorities ?? (_customCertificateAuthorities = new InputList<Inputs.OriginCustomCertificateAuthorityInputArgs>());
            set => _customCertificateAuthorities = value;
        }

        [Input("customCertificates")]
        private InputList<Inputs.OriginCustomCertificateInputArgs>? _customCertificates;
        public InputList<Inputs.OriginCustomCertificateInputArgs> CustomCertificates
        {
            get => _customCertificates ?? (_customCertificates = new InputList<Inputs.OriginCustomCertificateInputArgs>());
        ...
        [Input("netStorage")]
        public Input<Inputs.OriginNetStorageInputArgs>? NetStorage { get; set; }
        ...
        public OriginInputArgs()
        {
        }
        public static new OriginInputArgs Empty => new OriginInputArgs();
    }
}
