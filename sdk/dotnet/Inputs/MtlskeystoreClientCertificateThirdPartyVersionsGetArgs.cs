...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class MtlskeystoreClientCertificateThirdPartyVersionsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Details of the certificate block for the client certificate version.
        /// </summary>
        [Input("certificateBlock")]
        public Input<Inputs.MtlskeystoreClientCertificateThirdPartyVersionsCertificateBlockGetArgs>? CertificateBlock { get; set; }

        /// <summary>
        /// The user who uploaded the THIRD_PARTY client certificate version. Appears as null if not specified.
        /// </summary>
        [Input("certificateSubmittedBy")]
        public Input<string>? CertificateSubmittedBy { get; set; }
        ...
        /// </summary>
        [Input("certificateSubmittedDate")]
        public Input<string>? CertificateSubmittedDate { get; set; }
        ...
        /// </summary>
        [Input("csrBlock")]
        public Input<Inputs.MtlskeystoreClientCertificateThirdPartyVersionsCsrBlockGetArgs>? CsrBlock { get; set; }
        ...
        public MtlskeystoreClientCertificateThirdPartyVersionsGetArgs()
        {
        }
        public static new MtlskeystoreClientCertificateThirdPartyVersionsGetArgs Empty => new MtlskeystoreClientCertificateThirdPartyVersionsGetArgs();
    }
}
