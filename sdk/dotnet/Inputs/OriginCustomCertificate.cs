...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class OriginCustomCertificateArgs : global::Pulumi.InvokeArgs
    {
        [Input("canBeCa")]
        ...
        [Input("issuerRdns")]
        public Inputs.OriginCustomCertificateIssuerRdnsArgs? IssuerRdns { get; set; }
        ...
        [Input("subjectRdns")]
        public Inputs.OriginCustomCertificateSubjectRdnsArgs? SubjectRdns { get; set; }

        [Input("version")]
        public int? Version { get; set; }

        public OriginCustomCertificateArgs()
        {
        }
        public static new OriginCustomCertificateArgs Empty => new OriginCustomCertificateArgs();
    }
}
