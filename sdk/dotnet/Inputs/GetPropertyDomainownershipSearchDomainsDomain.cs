...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class GetPropertyDomainownershipSearchDomainsDomainArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// Your account's ID.
        /// </summary>
        ...
        public string DomainStatus { get; set; } = null!;

        /// <summary>
        /// The domain's validation challenge details.
        /// </summary>
        [Input("validationChallenge", required: true)]
        public Inputs.GetPropertyDomainownershipSearchDomainsDomainValidationChallengeArgs ValidationChallenge { get; set; } = null!;

        /// <summary>
        /// The timestamp indicating when the domain validation was completed.
        /// </summary>
        [Input("validationCompletedDate", required: true)]
        public string ValidationCompletedDate { get; set; } = null!;
        ...
        public string ValidationLevel { get; set; } = null!;
        ...
        public GetPropertyDomainownershipSearchDomainsDomainArgs()
        {
        }
        public static new GetPropertyDomainownershipSearchDomainsDomainArgs Empty => new GetPropertyDomainownershipSearchDomainsDomainArgs();
    }
}
