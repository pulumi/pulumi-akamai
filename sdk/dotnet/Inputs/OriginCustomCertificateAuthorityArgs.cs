...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class OriginCustomCertificateAuthorityInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("canBeCa")]
        ...
        [Input("issuerRdns")]
        public Input<Inputs.OriginCustomCertificateAuthorityIssuerRdnsInputArgs>? IssuerRdns { get; set; }
        ...
        [Input("subjectRdns")]
        public Input<Inputs.OriginCustomCertificateAuthoritySubjectRdnsInputArgs>? SubjectRdns { get; set; }

        [Input("version")]
        public Input<int>? Version { get; set; }

        public OriginCustomCertificateAuthorityInputArgs()
        {
        }
        public static new OriginCustomCertificateAuthorityInputArgs Empty => new OriginCustomCertificateAuthorityInputArgs();
    }
}
