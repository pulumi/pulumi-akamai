...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class GetPropertyRulesBuilderRulesV20240212BehaviorOriginInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateAuthorityInputArgs>? _customCertificateAuthorities;
        ...
        /// </summary>
        public InputList<Inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateAuthorityInputArgs> CustomCertificateAuthorities
        {
            get => _customCertificateAuthorities ?? (_customCertificateAuthorities = new InputList<Inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateAuthorityInputArgs>());
            set => _customCertificateAuthorities = value;
        }

        [Input("customCertificates")]
        private InputList<Inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateInputArgs>? _customCertificates;

        /// <summary>
        /// Specifies an array of certification objects. See the `verification settings in the Origin Server behavior` or contact your Akamai representative for details on this object's requirements.
        /// </summary>
        public InputList<Inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateInputArgs> CustomCertificates
        {
            get => _customCertificates ?? (_customCertificates = new InputList<Inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateInputArgs>());
        ...
        /// </summary>
        [Input("netStorage")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginNetStorageInputArgs>? NetStorage { get; set; }
        ...
        /// </summary>
        [Input("tls13Support")]
        public Input<bool>? Tls13Support { get; set; }

        /// <summary>
        /// This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
        /// </summary>
        [Input("tlsVersionTitle")]
        public Input<string>? TlsVersionTitle { get; set; }
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorOriginInputArgs()
        {
        }
        public static new GetPropertyRulesBuilderRulesV20240212BehaviorOriginInputArgs Empty => new GetPropertyRulesBuilderRulesV20240212BehaviorOriginInputArgs();
    }
}
