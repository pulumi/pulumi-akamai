...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class GetPropertyRulesBuilderRulesV20240212CriterionInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionAdvancedImMatchInputArgs>? AdvancedImMatch { get; set; }
        ...
        /// </summary>
        [Input("bucket")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionBucketInputArgs>? Bucket { get; set; }
        ...
        /// </summary>
        [Input("cacheability")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionCacheabilityInputArgs>? Cacheability { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionChinaCdnRegionInputArgs>? ChinaCdnRegion { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionClientCertificateInputArgs>? ClientCertificate { get; set; }
        ...
        /// </summary>
        [Input("clientIp")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionClientIpInputArgs>? ClientIp { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionClientIpVersionInputArgs>? ClientIpVersion { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionCloudletsOriginInputArgs>? CloudletsOrigin { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionContentDeliveryNetworkInputArgs>? ContentDeliveryNetwork { get; set; }

        /// <summary>
        /// Matches the HTTP response header's `Content-Type`. This criterion can be used in includes.
        /// </summary>
        [Input("contentType")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionContentTypeInputArgs>? ContentType { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionDeviceCharacteristicInputArgs>? DeviceCharacteristic { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdAuthGroups")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionEcmdAuthGroupsInputArgs>? EcmdAuthGroups { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdAuthScheme")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionEcmdAuthSchemeInputArgs>? EcmdAuthScheme { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdIsAuthenticated")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionEcmdIsAuthenticatedInputArgs>? EcmdIsAuthenticated { get; set; }

        /// <summary>
        /// This criterion can be used in includes.
        /// </summary>
        [Input("ecmdUsername")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionEcmdUsernameInputArgs>? EcmdUsername { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionEdgeWorkersFailureInputArgs>? EdgeWorkersFailure { get; set; }

        /// <summary>
        /// Matches the requested filename's extension, if present. This criterion can be used in includes.
        /// </summary>
        [Input("fileExtension")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionFileExtensionInputArgs>? FileExtension { get; set; }

        /// <summary>
        /// Matches the requested filename, or test whether it is present. This criterion can be used in includes.
        /// </summary>
        [Input("filename")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionFilenameInputArgs>? Filename { get; set; }

        /// <summary>
        /// Matches the requested hostname. This criterion can be used in includes.
        /// </summary>
        [Input("hostname")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionHostnameInputArgs>? Hostname { get; set; }
        ...
        /// </summary>
        [Input("matchAdvanced")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionMatchAdvancedInputArgs>? MatchAdvanced { get; set; }

        /// <summary>
        /// Match the assigned content provider code. This criterion can be used in includes.
        /// </summary>
        [Input("matchCpCode")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionMatchCpCodeInputArgs>? MatchCpCode { get; set; }

        /// <summary>
        /// Match a set or range of HTTP response codes. This criterion can be used in includes.
        /// </summary>
        [Input("matchResponseCode")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionMatchResponseCodeInputArgs>? MatchResponseCode { get; set; }
        ...
        /// </summary>
        [Input("matchVariable")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionMatchVariableInputArgs>? MatchVariable { get; set; }
        ...
        /// </summary>
        [Input("metadataStage")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionMetadataStageInputArgs>? MetadataStage { get; set; }

        /// <summary>
        /// Matches when the origin responds with a timeout error. This criterion can be used in includes.
        /// </summary>
        [Input("originTimeout")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionOriginTimeoutInputArgs>? OriginTimeout { get; set; }

        /// <summary>
        /// Matches the URL's non-hostname path component. This criterion can be used in includes.
        /// </summary>
        [Input("path")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionPathInputArgs>? Path { get; set; }

        /// <summary>
        /// Matches query string field names or values. This criterion can be used in includes.
        /// </summary>
        [Input("queryStringParameter")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionQueryStringParameterInputArgs>? QueryStringParameter { get; set; }
        ...
        /// </summary>
        [Input("random")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRandomInputArgs>? Random { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRecoveryConfigInputArgs>? RecoveryConfig { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRegularExpressionInputArgs>? RegularExpression { get; set; }

        /// <summary>
        /// Match the cookie name or value passed with the request. This criterion can be used in includes.
        /// </summary>
        [Input("requestCookie")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRequestCookieInputArgs>? RequestCookie { get; set; }

        /// <summary>
        /// Match HTTP header names or values. This criterion can be used in includes.
        /// </summary>
        [Input("requestHeader")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRequestHeaderInputArgs>? RequestHeader { get; set; }
        ...
        /// </summary>
        [Input("requestMethod")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRequestMethodInputArgs>? RequestMethod { get; set; }

        /// <summary>
        /// Matches whether the request uses the HTTP or HTTPS protocol. This criterion can be used in includes.
        /// </summary>
        [Input("requestProtocol")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRequestProtocolInputArgs>? RequestProtocol { get; set; }
        ...
        /// </summary>
        [Input("requestType")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionRequestTypeInputArgs>? RequestType { get; set; }

        /// <summary>
        /// Match HTTP header names or values. This criterion can be used in includes.
        /// </summary>
        [Input("responseHeader")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionResponseHeaderInputArgs>? ResponseHeader { get; set; }

        /// <summary>
        /// The location of the Akamai server handling the request. This criterion can be used in includes.
        /// </summary>
        [Input("serverLocation")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionServerLocationInputArgs>? ServerLocation { get; set; }

        /// <summary>
        /// Specifies ranges of times during which the request occurred. This criterion can be used in includes.
        /// </summary>
        [Input("time")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionTimeInputArgs>? Time { get; set; }

        /// <summary>
        /// Match on Auth Token 2.0 verification results. This criterion can be used in includes.
        /// </summary>
        [Input("tokenAuthorization")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionTokenAuthorizationInputArgs>? TokenAuthorization { get; set; }

        /// <summary>
        /// Matches the user agent string that helps identify the client browser and device. This criterion can be used in includes.
        /// </summary>
        [Input("userAgent")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionUserAgentInputArgs>? UserAgent { get; set; }
        ...
        /// </summary>
        [Input("userLocation")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionUserLocationInputArgs>? UserLocation { get; set; }
        ...
        /// </summary>
        [Input("userNetwork")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionUserNetworkInputArgs>? UserNetwork { get; set; }
        ...
        /// </summary>
        [Input("variableError")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionVariableErrorInputArgs>? VariableError { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionVirtualWaitingRoomRequestInputArgs>? VirtualWaitingRoomRequest { get; set; }
        ...
        public Input<Inputs.GetPropertyRulesBuilderRulesV20240212CriterionVisitorPrioritizationRequestInputArgs>? VisitorPrioritizationRequest { get; set; }

        public GetPropertyRulesBuilderRulesV20240212CriterionInputArgs()
        {
        }
        public static new GetPropertyRulesBuilderRulesV20240212CriterionInputArgs Empty => new GetPropertyRulesBuilderRulesV20240212CriterionInputArgs();
    }
}
