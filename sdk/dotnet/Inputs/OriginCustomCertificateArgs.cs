...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class OriginCustomCertificateInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("canBeCa")]
        ...
        [Input("issuerRdns")]
        public Input<Inputs.OriginCustomCertificateIssuerRdnsInputArgs>? IssuerRdns { get; set; }
        ...
        [Input("subjectRdns")]
        public Input<Inputs.OriginCustomCertificateSubjectRdnsInputArgs>? SubjectRdns { get; set; }

        [Input("version")]
        public Input<int>? Version { get; set; }

        public OriginCustomCertificateInputArgs()
        {
        }
        public static new OriginCustomCertificateInputArgs Empty => new OriginCustomCertificateInputArgs();
    }
}
