...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class OriginCustomCertificateAuthorityArgs : global::Pulumi.InvokeArgs
    {
        [Input("canBeCa")]
        ...
        [Input("issuerRdns")]
        public Inputs.OriginCustomCertificateAuthorityIssuerRdnsArgs? IssuerRdns { get; set; }
        ...
        [Input("subjectRdns")]
        public Inputs.OriginCustomCertificateAuthoritySubjectRdnsArgs? SubjectRdns { get; set; }

        [Input("version")]
        public int? Version { get; set; }

        public OriginCustomCertificateAuthorityArgs()
        {
        }
        public static new OriginCustomCertificateAuthorityArgs Empty => new OriginCustomCertificateAuthorityArgs();
    }
}
