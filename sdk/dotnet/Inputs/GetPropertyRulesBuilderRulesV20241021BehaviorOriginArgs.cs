...
namespace Pulumi.Akamai.Inputs
{
    ...
    public sealed class GetPropertyRulesBuilderRulesV20241021BehaviorOriginInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthorityInputArgs>? _customCertificateAuthorities;
        ...
        /// </summary>
        public InputList<Inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthorityInputArgs> CustomCertificateAuthorities
        {
            get => _customCertificateAuthorities ?? (_customCertificateAuthorities = new InputList<Inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthorityInputArgs>());
            set => _customCertificateAuthorities = value;
        }

        [Input("customCertificates")]
        private InputList<Inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateInputArgs>? _customCertificates;

        /// <summary>
        /// Specifies an array of certification objects. See the `verification settings in the Origin Server behavior` or contact your Akamai representative for details on this object's requirements.
        /// </summary>
        public InputList<Inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateInputArgs> CustomCertificates
        {
            get => _customCertificates ?? (_customCertificates = new InputList<Inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateInputArgs>());
        ...
        /// </summary>
        [Input("http2Title")]
        public Input<string>? Http2Title { get; set; }
        ...
        /// </summary>
        [Input("netStorage")]
        public Input<Inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginNetStorageInputArgs>? NetStorage { get; set; }
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorOriginInputArgs()
        {
        }
        public static new GetPropertyRulesBuilderRulesV20241021BehaviorOriginInputArgs Empty => new GetPropertyRulesBuilderRulesV20241021BehaviorOriginInputArgs();
    }
}
