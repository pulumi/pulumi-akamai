...
namespace Pulumi.Akamai
{
    public partial class PropertyVariables : Pulumi.CustomResource
    {
        ...
        public PropertyVariables(string name, PropertyVariablesArgs? args = null, CustomResourceOptions? options = null)
            : base("akamai:index/propertyVariables:PropertyVariables", name, args ?? new PropertyVariablesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private PropertyVariables(string name, Input<string> id, PropertyVariablesState? state = null, CustomResourceOptions? options = null)
            : base("akamai:index/propertyVariables:PropertyVariables", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Pulumi.Alias { Type = "akamai:properties/propertyVariables:PropertyVariables"},
                },
            };
