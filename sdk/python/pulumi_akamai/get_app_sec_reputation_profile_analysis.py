...
@pulumi.output_type
class GetAppSecReputationProfileAnalysisResult:
    """
...
class AwaitableGetAppSecReputationProfileAnalysisResult(GetAppSecReputationProfileAnalysisResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppSecReputationProfileAnalysisResult(
...
def get_app_sec_reputation_profile_analysis(config_id: Optional[_builtins.int] = None,
...
def get_app_sec_reputation_profile_analysis_output(config_id: Optional[pulumi.Input[_builtins.int]] = None,
