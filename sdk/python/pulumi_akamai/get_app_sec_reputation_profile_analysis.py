...
def get_app_sec_reputation_profile_analysis(config_id: Optional[builtins.int] = None,
...
def get_app_sec_reputation_profile_analysis_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
