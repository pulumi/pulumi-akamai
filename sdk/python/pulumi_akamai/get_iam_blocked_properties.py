...
class GetIamBlockedPropertiesResult:
    ...
    def ui_identity_id(self) -> builtins.str:
...
def get_iam_blocked_properties(contract_id: Optional[builtins.str] = None,
                               group_id: Optional[builtins.int] = None,
                               ui_identity_id: Optional[builtins.str] = None,
...
def get_iam_blocked_properties_output(contract_id: Optional[pulumi.Input[builtins.str]] = None,
                                      group_id: Optional[pulumi.Input[builtins.int]] = None,
                                      ui_identity_id: Optional[pulumi.Input[builtins.str]] = None,
