...
def get_botman_javascript_injection(config_id: Optional[_builtins.int] = None,
...
def get_botman_javascript_injection_output(config_id: Optional[pulumi.Input[_builtins.int]] = None,
