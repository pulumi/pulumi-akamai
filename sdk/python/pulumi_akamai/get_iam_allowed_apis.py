...
class GetIamAllowedApisResult:
    ...
    def allow_account_switch(self) -> Optional[builtins.bool]:
...
def get_iam_allowed_apis(allow_account_switch: Optional[builtins.bool] = None,
...
def get_iam_allowed_apis_output(allow_account_switch: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                client_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
