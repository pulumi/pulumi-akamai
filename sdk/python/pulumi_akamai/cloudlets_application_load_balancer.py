...
class CloudletsApplicationLoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 balancing_type: pulumi.Input[Optional[_builtins.str]] = None,
                 data_centers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudletsApplicationLoadBalancerDataCenterArgs', 'CloudletsApplicationLoadBalancerDataCenterArgsDict', 'outputs.CloudletsApplicationLoadBalancerDataCenter']]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 liveness_settings: pulumi.Input[Optional[Union['CloudletsApplicationLoadBalancerLivenessSettingsArgs', 'CloudletsApplicationLoadBalancerLivenessSettingsArgsDict', 'outputs.CloudletsApplicationLoadBalancerLivenessSettings']]] = None,
                 origin_description: pulumi.Input[Optional[_builtins.str]] = None,
                 origin_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] balancing_type: The type of load balancing being performed. Options include WEIGHTED and PERFORMANCE
        :param pulumi.Input[Sequence[pulumi.Input[Union['CloudletsApplicationLoadBalancerDataCenterArgs', 'CloudletsApplicationLoadBalancerDataCenterArgsDict', 'outputs.CloudletsApplicationLoadBalancerDataCenter']]]] data_centers: The object containing information on conditional origins being used as data centers for an Application Load Balancer implementation. Only Conditional Origins with an originType of CUSTOMER or NETSTORAGE can be used as data centers in an application load balancer configuration.
        :param pulumi.Input[_builtins.str] description: The load balancer configuration version description
        :param pulumi.Input[_builtins.str] origin_description: The load balancer configuration description
        :param pulumi.Input[_builtins.str] origin_id: The conditional origin's unique identifier
        """
