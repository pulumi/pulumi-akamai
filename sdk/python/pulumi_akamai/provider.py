...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 config_section: Optional[pulumi.Input[builtins.str]] = None,
                 edgerc: Optional[pulumi.Input[builtins.str]] = None,
                 request_limit: Optional[pulumi.Input[builtins.int]] = None,
                 retry_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 retry_max: Optional[pulumi.Input[builtins.int]] = None,
                 retry_wait_max: Optional[pulumi.Input[builtins.int]] = None,
                 retry_wait_min: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] config_section: The section of the edgerc file to use for configuration
        :param pulumi.Input[builtins.int] request_limit: The maximum number of API requests to be made per second (0 for no limit)
        :param pulumi.Input[builtins.bool] retry_disabled: Should the retries of API requests be disabled, default false
        :param pulumi.Input[builtins.int] retry_max: The maximum number retires of API requests, default 10
        :param pulumi.Input[builtins.int] retry_wait_max: The maximum wait time in seconds between API requests retries, default is 30 sec
        :param pulumi.Input[builtins.int] retry_wait_min: The minimum wait time in seconds between API requests retries, default is 1 sec
        """
    ...
    def config_section(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_section(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_section", value)

    @property
    @pulumi.getter
    def edgerc(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "edgerc")

    @edgerc.setter
    def edgerc(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "edgerc", value)

    @property
    @pulumi.getter(name="requestLimit")
    def request_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def request_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "request_limit", value)

    @property
    @pulumi.getter(name="retryDisabled")
    def retry_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def retry_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def retry_wait_max(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def retry_wait_max(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retry_wait_max", value)

    @property
    @pulumi.getter(name="retryWaitMin")
    def retry_wait_min(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def retry_wait_min(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retry_wait_min", value)


class Provider(pulumi.ProviderResource):

    pulumi_type = "pulumi:providers:akamai"
    ...
    @property
    @pulumi.getter(name="configSection")
    def config_section(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The section of the edgerc file to use for configuration
        """
        return pulumi.get(self, "config_section")
    ...
    @property
    @pulumi.getter
    def edgerc(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "edgerc")
