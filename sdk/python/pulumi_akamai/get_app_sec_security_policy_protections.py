...
def get_app_sec_security_policy_protections(config_id: Optional[_builtins.int] = None,
...
def get_app_sec_security_policy_protections_output(config_id: pulumi.Input[Optional[_builtins.int]] = None,
