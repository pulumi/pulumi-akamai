...
class GetAppsecAapSelectedHostnamesResult:
    ...
    def evaluated_hosts(self) -> Sequence[_builtins.str]:
    ...
    def match_targets(self) -> _builtins.str:
    ...
    def selected_hosts(self) -> Sequence[_builtins.str]:
...
def get_appsec_aap_selected_hostnames(config_id: Optional[_builtins.int] = None,
