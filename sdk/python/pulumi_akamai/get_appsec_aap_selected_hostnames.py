...
class GetAppsecAapSelectedHostnamesResult:
    ...
    def evaluated_hosts(self) -> Sequence[builtins.str]:
    ...
    def match_targets(self) -> builtins.str:
    ...
    def protected_hosts(self) -> Sequence[builtins.str]:
    ...
    def selected_hosts(self) -> Sequence[builtins.str]:
...
def get_appsec_aap_selected_hostnames(config_id: Optional[builtins.int] = None,
...
def get_appsec_aap_selected_hostnames_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
