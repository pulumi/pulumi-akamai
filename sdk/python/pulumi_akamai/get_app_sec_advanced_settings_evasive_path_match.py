...
def get_app_sec_advanced_settings_evasive_path_match(config_id: Optional[builtins.int] = None,
...
def get_app_sec_advanced_settings_evasive_path_match_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
