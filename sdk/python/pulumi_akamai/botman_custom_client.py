...
class BotmanCustomClientArgs:
    def __init__(__self__, *,
        ...
        """
        BotmanCustomClientArgs._configure(
    ...
    def _configure(
        ...
        if custom_client is None and 'customClient' in kwargs:
            custom_client = kwargs['customClient']
        if custom_client is None:
            raise TypeError("Missing 'custom_client' argument")

        _setter("config_id", config_id)
        _setter("custom_client", custom_client)
...
class _BotmanCustomClientState:
    def __init__(__self__, *,
        ...
        """
        _BotmanCustomClientState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            config_id=config_id,
            custom_client=custom_client,
    ...
    def _configure(
        ...
        if custom_client is None and 'customClient' in kwargs:
            custom_client = kwargs['customClient']
        if custom_client_id is None and 'customClientId' in kwargs:
            custom_client_id = kwargs['customClientId']
        ...
        if custom_client_id is not None:
            _setter("custom_client_id", custom_client_id)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BotmanCustomClientArgs._configure(_setter, **kwargs)
