...
class BotmanCustomClientArgs:
    def __init__(__self__, *,
                 ...
                 custom_client: pulumi.Input[builtins.str]):
        """
    ...
    def custom_client(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "custom_client")

    @custom_client.setter
    def custom_client(self, value: pulumi.Input[builtins.str]):
...
class _BotmanCustomClientState:
    def __init__(__self__, *,
                 ...
                 custom_client: Optional[pulumi.Input[builtins.str]] = None,
                 custom_client_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="customClient")
    def custom_client(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_client")

    @custom_client.setter
    def custom_client(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_client", value)

    @property
    @pulumi.getter(name="customClientId")
    def custom_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_client_id")

    @custom_client_id.setter
    def custom_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_client_id", value)


@pulumi.type_token("akamai:index/botmanCustomClient:BotmanCustomClient")
class BotmanCustomClient(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            custom_client: Optional[pulumi.Input[builtins.str]] = None,
            custom_client_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanCustomClient':
        """
    ...
    @property
    @pulumi.getter(name="customClient")
    def custom_client(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "custom_client")

    @property
    @pulumi.getter(name="customClientId")
    def custom_client_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "custom_client_id")
