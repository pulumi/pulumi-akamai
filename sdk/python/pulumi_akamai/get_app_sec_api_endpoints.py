...
class GetAppSecApiEndpointsResult:
    ...
    def id_lists(self) -> Sequence[builtins.int]:
...
def get_app_sec_api_endpoints(api_name: Optional[builtins.str] = None,
...
def get_app_sec_api_endpoints_output(api_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
