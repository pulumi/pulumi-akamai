...
class GetAppSecThreatIntelResult:
    ...
    def threat_intel(self) -> builtins.str:
...
def get_app_sec_threat_intel(config_id: Optional[builtins.int] = None,
...
def get_app_sec_threat_intel_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
