...
class GetAppSecThreatIntelResult:
    ...
    def threat_intel(self) -> _builtins.str:
...
def get_app_sec_threat_intel(config_id: Optional[_builtins.int] = None,
...
def get_app_sec_threat_intel_output(config_id: pulumi.Input[Optional[_builtins.int]] = None,
