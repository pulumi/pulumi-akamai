...
class AppSecReputationProfileActionArgs:
    def __init__(__self__, *,
                 ...
                 reputation_profile_id: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] action: Action to be taken when the reputation profile is triggered
    ...
    def reputation_profile_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def reputation_profile_id(self, value: pulumi.Input[builtins.int]):
...
class AppSecReputationProfileAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            reputation_profile_id: Optional[pulumi.Input[builtins.int]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AppSecReputationProfileAction':
        """
