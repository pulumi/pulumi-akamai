...
class BotmanJavascriptInjectionArgs:
    def __init__(__self__, *,
                 ...
                 javascript_injection: pulumi.Input[builtins.str],
    ...
    def javascript_injection(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "javascript_injection")

    @javascript_injection.setter
    def javascript_injection(self, value: pulumi.Input[builtins.str]):
...
class _BotmanJavascriptInjectionState:
    def __init__(__self__, *,
                 ...
                 javascript_injection: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="javascriptInjection")
    def javascript_injection(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "javascript_injection")

    @javascript_injection.setter
    def javascript_injection(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "javascript_injection", value)
...
@pulumi.type_token("akamai:index/botmanJavascriptInjection:BotmanJavascriptInjection")
class BotmanJavascriptInjection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanJavascriptInjection resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanJavascriptInjectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanJavascriptInjectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanJavascriptInjectionArgs.__new__(BotmanJavascriptInjectionArgs)

            if config_id is None and not opts.urn:
                raise TypeError("Missing required property 'config_id'")
            __props__.__dict__["config_id"] = config_id
            if javascript_injection is None and not opts.urn:
                raise TypeError("Missing required property 'javascript_injection'")
            __props__.__dict__["javascript_injection"] = javascript_injection
            if security_policy_id is None and not opts.urn:
                raise TypeError("Missing required property 'security_policy_id'")
            __props__.__dict__["security_policy_id"] = security_policy_id
        super(BotmanJavascriptInjection, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            javascript_injection: Optional[pulumi.Input[builtins.str]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanJavascriptInjection':
        """
        ...
        __props__ = _BotmanJavascriptInjectionState.__new__(_BotmanJavascriptInjectionState)
    ...
    @property
    @pulumi.getter(name="javascriptInjection")
    def javascript_injection(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "javascript_injection")
