...
class GetClientlistListsResult:
    ...
    def list_ids(self) -> Sequence[builtins.str]:
...
def get_clientlist_lists(name: Optional[builtins.str] = None,
...
def get_clientlist_lists_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
