...
class GetNetworkListsResult:
    ...
    def sync_point(self) -> builtins.int:
...
def get_network_lists(name: Optional[builtins.str] = None,
                      network_list_id: Optional[builtins.str] = None,
...
def get_network_lists_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             network_list_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
