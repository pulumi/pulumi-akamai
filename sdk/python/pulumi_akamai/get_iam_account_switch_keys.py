...
def get_iam_account_switch_keys(client_id: Optional[builtins.str] = None,
...
def get_iam_account_switch_keys_output(client_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
