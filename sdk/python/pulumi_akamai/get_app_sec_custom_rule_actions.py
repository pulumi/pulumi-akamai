...
class GetAppSecCustomRuleActionsResult:
    ...
    def custom_rule_id(self) -> Optional[builtins.int]:
...
def get_app_sec_custom_rule_actions(config_id: Optional[builtins.int] = None,
                                    custom_rule_id: Optional[builtins.int] = None,
...
def get_app_sec_custom_rule_actions_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
                                           custom_rule_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
