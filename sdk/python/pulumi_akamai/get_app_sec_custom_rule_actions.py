...
class GetAppSecCustomRuleActionsResult:
    ...
    def custom_rule_id(self) -> Optional[_builtins.int]:
...
def get_app_sec_custom_rule_actions(config_id: Optional[_builtins.int] = None,
                                    custom_rule_id: Optional[_builtins.int] = None,
...
def get_app_sec_custom_rule_actions_output(config_id: pulumi.Input[Optional[_builtins.int]] = None,
                                           custom_rule_id: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
