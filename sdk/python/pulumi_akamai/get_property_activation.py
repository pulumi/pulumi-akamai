...
def get_property_activation(network: Optional[builtins.str] = None,
...
def get_property_activation_output(network: Optional[pulumi.Input[Optional[builtins.str]]] = None,
