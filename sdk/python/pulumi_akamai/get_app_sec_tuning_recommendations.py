...
class GetAppSecTuningRecommendationsResult:
    ...
    def attack_group(self) -> Optional[builtins.str]:
    ...
    def ruleset_type(self) -> Optional[builtins.str]:
...
def get_app_sec_tuning_recommendations(attack_group: Optional[builtins.str] = None,
                                       config_id: Optional[builtins.int] = None,
                                       rule_id: Optional[builtins.int] = None,
                                       ruleset_type: Optional[builtins.str] = None,
...
def get_app_sec_tuning_recommendations_output(attack_group: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              config_id: Optional[pulumi.Input[builtins.int]] = None,
                                              rule_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                              ruleset_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
