...
class GetAppSecTuningRecommendationsResult:
    ...
    def ruleset_type(self) -> Optional[_builtins.str]:
...
def get_app_sec_tuning_recommendations(attack_group: Optional[_builtins.str] = None,
                                       config_id: Optional[_builtins.int] = None,
                                       rule_id: Optional[_builtins.int] = None,
                                       ruleset_type: Optional[_builtins.str] = None,
