...
def get_property_products(contract_id: Optional[_builtins.str] = None,
...
def get_property_products_output(contract_id: Optional[pulumi.Input[_builtins.str]] = None,
