...
def get_app_sec_advanced_settings_logging(config_id: Optional[builtins.int] = None,
...
def get_app_sec_advanced_settings_logging_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
