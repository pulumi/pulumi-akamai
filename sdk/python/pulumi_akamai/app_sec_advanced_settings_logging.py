...
class AppSecAdvancedSettingsLoggingArgs:
    def __init__(__self__, *,
                 ...
                 logging: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] logging: Whether to enable, disable, or update HTTP header logging settings
    ...
    @property
    @pulumi.getter
    def logging(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @logging.setter
    def logging(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("akamai:index/appSecAdvancedSettingsLogging:AppSecAdvancedSettingsLogging")
class AppSecAdvancedSettingsLogging(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            logging: Optional[pulumi.Input[builtins.str]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AppSecAdvancedSettingsLogging':
        """
    ...
    @property
    @pulumi.getter
    def logging(self) -> pulumi.Output[builtins.str]:
        """
        Whether to enable, disable, or update HTTP header logging settings
        """
        return pulumi.get(self, "logging")
