...
def get_cloudlets_application_load_balancer_match_rule(match_rules: Optional[Sequence[Union['GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleArgs', 'GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleArgsDict', 'outputs.GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleResult']]] = None,
...
def get_cloudlets_application_load_balancer_match_rule_output(match_rules: pulumi.Input[Optional[Optional[Sequence[Union['GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleArgs', 'GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleArgsDict', 'outputs.GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleResult']]]]] = None,
