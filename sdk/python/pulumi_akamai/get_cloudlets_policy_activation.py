...
class GetCloudletsPolicyActivationResult:
    ...
    def associated_properties(self) -> Optional[Sequence[builtins.str]]:
...
def get_cloudlets_policy_activation(associated_properties: Optional[Sequence[builtins.str]] = None,
...
def get_cloudlets_policy_activation_output(associated_properties: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
