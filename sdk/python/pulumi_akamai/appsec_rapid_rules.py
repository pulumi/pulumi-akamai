...
class AppsecRapidRulesArgs:
    def __init__(__self__, *,
                 ...
                 rule_definitions: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] default_action: Default action that applies to violations of all rapid rules
        :param pulumi.Input[str] rule_definitions: JSON-formatted list of rule definition (ID, action, action lock and exception)
        """
    ...
    def rule_definitions(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def rule_definitions(self, value: Optional[pulumi.Input[str]]):
...
class _AppsecRapidRulesState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] config_id: Unique identifier of the security configuration
        :param pulumi.Input[str] default_action: Default action that applies to violations of all rapid rules
        :param pulumi.Input[bool] enabled: Hidden attribute containing information about rapid rules status enabled/disabled
        :param pulumi.Input[str] rule_definitions: JSON-formatted list of rule definition (ID, action, action lock and exception)
        :param pulumi.Input[str] security_policy_id: Unique identifier of the security policy
        """
...
class AppsecRapidRules(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[bool]] = None,
            rule_definitions: Optional[pulumi.Input[str]] = None,
            security_policy_id: Optional[pulumi.Input[str]] = None) -> 'AppsecRapidRules':
        """
    ...
    @property
    @pulumi.getter(name="ruleDefinitions")
    def rule_definitions(self) -> pulumi.Output[str]:
        """
        JSON-formatted list of rule definition (ID, action, action lock and exception)
        """
        return pulumi.get(self, "rule_definitions")
