...
def get_app_sec_configuration_version(config_id: Optional[builtins.int] = None,
...
def get_app_sec_configuration_version_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
