...
def get_cloudlets_forward_rewrite_match_rule_output(match_rules: pulumi.Input[Optional[Optional[Sequence[Union['GetCloudletsForwardRewriteMatchRuleMatchRuleArgs', 'GetCloudletsForwardRewriteMatchRuleMatchRuleArgsDict']]]]] = None,
