...
def get_datastream_dataset_fields(product_id: Optional[builtins.str] = None,
...
def get_datastream_dataset_fields_output(product_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
