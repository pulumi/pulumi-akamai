...
class NetworkListSubscriptionArgs:
    def __init__(__self__, *,
                 network_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
    ...
    def network_lists(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "network_lists")

    @network_lists.setter
    def network_lists(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class NetworkListSubscription(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="networkLists")
    def network_lists(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "network_lists")
