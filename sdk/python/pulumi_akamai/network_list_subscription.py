...
class NetworkListSubscriptionArgs:
    def __init__(__self__, *,
                 network_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
    ...
    def network_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "network_lists")

    @network_lists.setter
    def network_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _NetworkListSubscriptionState:
    def __init__(__self__, *,
                 network_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="networkLists")
    def network_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "network_lists")

    @network_lists.setter
    def network_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "network_lists", value)
...
class NetworkListSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            network_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            recipients: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'NetworkListSubscription':
        """
    ...
    @property
    @pulumi.getter(name="networkLists")
    def network_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "network_lists")
