...
class GetIamCidrBlockResult:
    ...
    def cidr_block_id(self) -> builtins.int:
...
def get_iam_cidr_block(cidr_block_id: Optional[builtins.int] = None,
...
def get_iam_cidr_block_output(cidr_block_id: Optional[pulumi.Input[builtins.int]] = None,
