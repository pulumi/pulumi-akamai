...
def get_property_include_parents(contract_id: Optional[builtins.str] = None,
...
def get_property_include_parents_output(contract_id: Optional[pulumi.Input[builtins.str]] = None,
