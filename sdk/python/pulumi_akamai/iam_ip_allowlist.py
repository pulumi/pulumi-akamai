...
class IamIpAllowlistArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable: Whether to enable or disable the allowlist.
        """
...
@pulumi.type_token("akamai:index/iamIpAllowlist:IamIpAllowlist")
class IamIpAllowlist(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            enable: Optional[pulumi.Input[builtins.bool]] = None) -> 'IamIpAllowlist':
        """
