...
class BotmanClientSideSecurityArgs:
    def __init__(__self__, *,
                 client_side_security: pulumi.Input[builtins.str],
    ...
    def client_side_security(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "client_side_security")

    @client_side_security.setter
    def client_side_security(self, value: pulumi.Input[builtins.str]):
...
class _BotmanClientSideSecurityState:
    def __init__(__self__, *,
                 client_side_security: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="clientSideSecurity")
    def client_side_security(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "client_side_security")

    @client_side_security.setter
    def client_side_security(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_side_security", value)
...
class BotmanClientSideSecurity(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanClientSideSecurity resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanClientSideSecurityArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanClientSideSecurityArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanClientSideSecurityArgs.__new__(BotmanClientSideSecurityArgs)

            if client_side_security is None and not opts.urn:
                raise TypeError("Missing required property 'client_side_security'")
            __props__.__dict__["client_side_security"] = client_side_security
            if config_id is None and not opts.urn:
                raise TypeError("Missing required property 'config_id'")
            __props__.__dict__["config_id"] = config_id
        super(BotmanClientSideSecurity, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            client_side_security: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None) -> 'BotmanClientSideSecurity':
        """
        ...
        __props__ = _BotmanClientSideSecurityState.__new__(_BotmanClientSideSecurityState)
    ...
    @property
    @pulumi.getter(name="clientSideSecurity")
    def client_side_security(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "client_side_security")
