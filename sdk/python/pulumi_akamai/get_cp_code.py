...
class GetCpCodeResult:
    ...
    """
    def __init__(__self__, contract_id=None, cp_code_id=None, cp_code_name=None, created_date=None, group_id=None, id=None, product_ids=None):
...
def get_cp_code_output(contract_id: pulumi.Input[Optional[_builtins.str]] = None,
