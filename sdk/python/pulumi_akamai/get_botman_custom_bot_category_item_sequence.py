...
class GetBotmanCustomBotCategoryItemSequenceResult:
    ...
    def bot_ids(self) -> Sequence[builtins.str]:
...
def get_botman_custom_bot_category_item_sequence(category_id: Optional[builtins.str] = None,
...
def get_botman_custom_bot_category_item_sequence_output(category_id: Optional[pulumi.Input[builtins.str]] = None,
