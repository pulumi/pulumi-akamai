...
class GtmGeomap(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 assignments: pulumi.Input[Optional[Sequence[pulumi.Input[Union['GtmGeomapAssignmentArgs', 'GtmGeomapAssignmentArgsDict', 'outputs.GtmGeomapAssignment']]]]] = None,
                 default_datacenter: pulumi.Input[Optional[Union['GtmGeomapDefaultDatacenterArgs', 'GtmGeomapDefaultDatacenterArgsDict', 'outputs.GtmGeomapDefaultDatacenter']]] = None,
                 domain: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 wait_on_complete: pulumi.Input[Optional[_builtins.bool]] = None,
                 __props__=None):
