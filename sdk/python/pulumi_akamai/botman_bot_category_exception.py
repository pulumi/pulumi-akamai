...
class BotmanBotCategoryExceptionArgs:
    def __init__(__self__, *,
                 bot_category_exception: pulumi.Input[builtins.str],
    ...
    def bot_category_exception(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "bot_category_exception")

    @bot_category_exception.setter
    def bot_category_exception(self, value: pulumi.Input[builtins.str]):
...
class _BotmanBotCategoryExceptionState:
    def __init__(__self__, *,
                 bot_category_exception: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="botCategoryException")
    def bot_category_exception(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bot_category_exception")

    @bot_category_exception.setter
    def bot_category_exception(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bot_category_exception", value)
...
class BotmanBotCategoryException(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanBotCategoryException resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanBotCategoryExceptionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanBotCategoryExceptionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanBotCategoryExceptionArgs.__new__(BotmanBotCategoryExceptionArgs)

            if bot_category_exception is None and not opts.urn:
                raise TypeError("Missing required property 'bot_category_exception'")
            __props__.__dict__["bot_category_exception"] = bot_category_exception
        ...
        super(BotmanBotCategoryException, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            bot_category_exception: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanBotCategoryException':
        """
        ...
        __props__ = _BotmanBotCategoryExceptionState.__new__(_BotmanBotCategoryExceptionState)
    ...
    @property
    @pulumi.getter(name="botCategoryException")
    def bot_category_exception(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "bot_category_exception")
