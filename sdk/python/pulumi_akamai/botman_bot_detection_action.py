...
class BotmanBotDetectionActionArgs:
    def __init__(__self__, *,
                 bot_detection_action: pulumi.Input[builtins.str],
                 config_id: pulumi.Input[builtins.int],
                 detection_id: pulumi.Input[builtins.str],
    ...
    def bot_detection_action(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "bot_detection_action")

    @bot_detection_action.setter
    def bot_detection_action(self, value: pulumi.Input[builtins.str]):
    ...
    def detection_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "detection_id")

    @detection_id.setter
    def detection_id(self, value: pulumi.Input[builtins.str]):
...
class _BotmanBotDetectionActionState:
    def __init__(__self__, *,
                 bot_detection_action: Optional[pulumi.Input[builtins.str]] = None,
                 config_id: Optional[pulumi.Input[builtins.int]] = None,
                 detection_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="botDetectionAction")
    def bot_detection_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bot_detection_action")

    @bot_detection_action.setter
    def bot_detection_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bot_detection_action", value)
    ...
    @property
    @pulumi.getter(name="detectionId")
    def detection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "detection_id")

    @detection_id.setter
    def detection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "detection_id", value)
...
@pulumi.type_token("akamai:index/botmanBotDetectionAction:BotmanBotDetectionAction")
class BotmanBotDetectionAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            detection_id: Optional[pulumi.Input[builtins.str]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanBotDetectionAction':
        """
    ...
    @property
    @pulumi.getter(name="botDetectionAction")
    def bot_detection_action(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "bot_detection_action")
    ...
    @property
    @pulumi.getter(name="detectionId")
    def detection_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "detection_id")
