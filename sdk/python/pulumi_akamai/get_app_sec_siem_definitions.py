...
def get_app_sec_siem_definitions(siem_definition_name: Optional[_builtins.str] = None,
...
def get_app_sec_siem_definitions_output(siem_definition_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
