...
class GetAppSecSiemDefinitionsResult:
    ...
    def siem_definition_name(self) -> Optional[builtins.str]:
...
def get_app_sec_siem_definitions(siem_definition_name: Optional[builtins.str] = None,
...
def get_app_sec_siem_definitions_output(siem_definition_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
