...
def get_app_sec_rule_upgrade_details(config_id: Optional[_builtins.int] = None,
...
def get_app_sec_rule_upgrade_details_output(config_id: Optional[pulumi.Input[_builtins.int]] = None,
