...
def get_app_sec_rule_upgrade_details(config_id: Optional[builtins.int] = None,
...
def get_app_sec_rule_upgrade_details_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
