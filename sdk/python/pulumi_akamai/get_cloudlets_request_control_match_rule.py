...
def get_cloudlets_request_control_match_rule(match_rules: Optional[Sequence[pulumi.InputType['GetCloudletsRequestControlMatchRuleMatchRuleArgs']]] = None,
    ...
    example = akamai.get_cloudlets_request_control_match_rule(match_rules=[
        akamai.GetCloudletsRequestControlMatchRuleMatchRuleArgs(
            allow_deny="allow",
            disabled=False,
            end=2,
            matches=[akamai.GetCloudletsRequestControlMatchRuleMatchRuleMatchArgs(
