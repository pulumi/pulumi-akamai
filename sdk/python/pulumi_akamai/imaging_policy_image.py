...
class ImagingPolicyImageArgs:
    def __init__(__self__, *,
                 ...
                 policyset_id: pulumi.Input[builtins.str],
                 activate_on_production: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ImagingPolicyImage resource.
        :param pulumi.Input[builtins.str] contract_id: Unique identifier for the Akamai Contract containing the Policy Set(s)
        :param pulumi.Input[builtins.str] json: A JSON encoded policy
        ...
        :param pulumi.Input[builtins.bool] activate_on_production: With this flag set to false, the user can perform modifications on staging without affecting the version already saved
    ...
    def policyset_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @policyset_id.setter
    def policyset_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "policyset_id", value)

    @property
    @pulumi.getter(name="activateOnProduction")
    def activate_on_production(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def activate_on_production(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ImagingPolicyImageState:
    def __init__(__self__, *,
                 ...
                 policyset_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="policysetId")
    def policyset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique identifier for the Image & Video Manager Policy Set.
        """
        return pulumi.get(self, "policyset_id")
    ...
    @policyset_id.setter
    def policyset_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policyset_id", value)
...
class ImagingPolicyImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_id: Optional[pulumi.Input[builtins.str]] = None,
            policyset_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'ImagingPolicyImage':
        """
    ...
    @property
    @pulumi.getter(name="activateOnProduction")
    def activate_on_production(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        With this flag set to false, the user can perform modifications on staging without affecting the version already saved
        to production. With this flag set to true, the policy will be saved on the production network. It is possible to change
        it back to false only when there are any changes to the policy qualifying it for the new version.
    ...
    @property
    @pulumi.getter(name="policysetId")
    def policyset_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier for the Image & Video Manager Policy Set.
        """
        return pulumi.get(self, "policyset_id")
