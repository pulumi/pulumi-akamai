...
__all__ = ['BotmanContentProtectionRuleArgs', 'BotmanContentProtectionRule']

@pulumi.input_type
class BotmanContentProtectionRuleArgs:
    def __init__(__self__, *,
                 config_id: pulumi.Input[builtins.int],
                 content_protection_rule: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] content_protection_rule: The content protection rule
    ...
    def content_protection_rule(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def content_protection_rule(self, value: pulumi.Input[builtins.str]):
...
class _BotmanContentProtectionRuleState:
    def __init__(__self__, *,
                 ...
                 content_protection_rule: Optional[pulumi.Input[builtins.str]] = None,
                 content_protection_rule_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] config_id: Unique identifier of the security configuration
        :param pulumi.Input[builtins.str] content_protection_rule: The content protection rule
        :param pulumi.Input[builtins.str] content_protection_rule_id: Unique identifier of a content protection rule
        :param pulumi.Input[builtins.str] security_policy_id: Unique identifier of the security policy
        """
        if config_id is not None:
            pulumi.set(__self__, "config_id", config_id)
        if content_protection_rule is not None:
            pulumi.set(__self__, "content_protection_rule", content_protection_rule)
        if content_protection_rule_id is not None:
            pulumi.set(__self__, "content_protection_rule_id", content_protection_rule_id)
    ...
    @property
    @pulumi.getter(name="contentProtectionRule")
    def content_protection_rule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The content protection rule
        """
        return pulumi.get(self, "content_protection_rule")
    ...
    @content_protection_rule.setter
    def content_protection_rule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "content_protection_rule", value)

    @property
    @pulumi.getter(name="contentProtectionRuleId")
    def content_protection_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_protection_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("akamai:index/botmanContentProtectionRule:BotmanContentProtectionRule")
class BotmanContentProtectionRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanContentProtectionRule resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanContentProtectionRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanContentProtectionRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanContentProtectionRuleArgs.__new__(BotmanContentProtectionRuleArgs)

            if config_id is None and not opts.urn:
                raise TypeError("Missing required property 'config_id'")
            __props__.__dict__["config_id"] = config_id
            if content_protection_rule is None and not opts.urn:
                raise TypeError("Missing required property 'content_protection_rule'")
            __props__.__dict__["content_protection_rule"] = content_protection_rule
            if security_policy_id is None and not opts.urn:
                raise TypeError("Missing required property 'security_policy_id'")
            __props__.__dict__["security_policy_id"] = security_policy_id
            __props__.__dict__["content_protection_rule_id"] = None
        super(BotmanContentProtectionRule, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            content_protection_rule: Optional[pulumi.Input[builtins.str]] = None,
            content_protection_rule_id: Optional[pulumi.Input[builtins.str]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanContentProtectionRule':
        """
        ...
        __props__ = _BotmanContentProtectionRuleState.__new__(_BotmanContentProtectionRuleState)

        __props__.__dict__["config_id"] = config_id
        __props__.__dict__["content_protection_rule"] = content_protection_rule
        __props__.__dict__["content_protection_rule_id"] = content_protection_rule_id
        __props__.__dict__["security_policy_id"] = security_policy_id
    ...
    @property
    @pulumi.getter(name="contentProtectionRule")
    def content_protection_rule(self) -> pulumi.Output[builtins.str]:
        """
        The content protection rule
        """
        return pulumi.get(self, "content_protection_rule")
    ...
    @property
    @pulumi.getter(name="contentProtectionRuleId")
    def content_protection_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of a content protection rule
        """
        return pulumi.get(self, "content_protection_rule_id")
