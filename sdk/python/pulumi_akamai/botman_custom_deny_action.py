...
class BotmanCustomDenyActionArgs:
    def __init__(__self__, *,
                 ...
                 custom_deny_action: pulumi.Input[builtins.str]):
        """
    ...
    def custom_deny_action(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "custom_deny_action")

    @custom_deny_action.setter
    def custom_deny_action(self, value: pulumi.Input[builtins.str]):
...
class _BotmanCustomDenyActionState:
    def __init__(__self__, *,
                 ...
                 custom_deny_action: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="customDenyAction")
    def custom_deny_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_deny_action")

    @custom_deny_action.setter
    def custom_deny_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_deny_action", value)
...
class BotmanCustomDenyAction(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanCustomDenyAction resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanCustomDenyActionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanCustomDenyActionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanCustomDenyActionArgs.__new__(BotmanCustomDenyActionArgs)

            if config_id is None and not opts.urn:
                raise TypeError("Missing required property 'config_id'")
            __props__.__dict__["config_id"] = config_id
            if custom_deny_action is None and not opts.urn:
                raise TypeError("Missing required property 'custom_deny_action'")
            __props__.__dict__["custom_deny_action"] = custom_deny_action
            __props__.__dict__["action_id"] = None
        super(BotmanCustomDenyAction, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            action_id: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            custom_deny_action: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanCustomDenyAction':
        """
        ...
        __props__ = _BotmanCustomDenyActionState.__new__(_BotmanCustomDenyActionState)
    ...
    @property
    @pulumi.getter(name="customDenyAction")
    def custom_deny_action(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "custom_deny_action")
