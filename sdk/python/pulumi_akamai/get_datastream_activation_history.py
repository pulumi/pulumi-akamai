...
def get_datastream_activation_history(stream_id: Optional[builtins.int] = None,
...
def get_datastream_activation_history_output(stream_id: Optional[pulumi.Input[builtins.int]] = None,
