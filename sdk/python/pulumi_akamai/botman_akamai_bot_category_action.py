...
class BotmanAkamaiBotCategoryActionArgs:
    ...
    def akamai_bot_category_action(self) -> pulumi.Input[str]:
        return pulumi.get(self, "akamai_bot_category_action")

    @akamai_bot_category_action.setter
    def akamai_bot_category_action(self, value: pulumi.Input[str]):
...
class _BotmanAkamaiBotCategoryActionState:
    ...
    @property
    @pulumi.getter(name="akamaiBotCategoryAction")
    def akamai_bot_category_action(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "akamai_bot_category_action")

    @akamai_bot_category_action.setter
    def akamai_bot_category_action(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "akamai_bot_category_action", value)
...
class BotmanAkamaiBotCategoryAction(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        Create a BotmanAkamaiBotCategoryAction resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanAkamaiBotCategoryActionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanAkamaiBotCategoryActionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanAkamaiBotCategoryActionArgs.__new__(BotmanAkamaiBotCategoryActionArgs)

            if akamai_bot_category_action is None and not opts.urn:
                raise TypeError("Missing required property 'akamai_bot_category_action'")
            __props__.__dict__["akamai_bot_category_action"] = akamai_bot_category_action
        ...
        super(BotmanAkamaiBotCategoryAction, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            category_id: Optional[pulumi.Input[str]] = None,
            config_id: Optional[pulumi.Input[int]] = None,
            security_policy_id: Optional[pulumi.Input[str]] = None) -> 'BotmanAkamaiBotCategoryAction':
        """
        ...
        __props__ = _BotmanAkamaiBotCategoryActionState.__new__(_BotmanAkamaiBotCategoryActionState)
    ...
    @property
    @pulumi.getter(name="akamaiBotCategoryAction")
    def akamai_bot_category_action(self) -> pulumi.Output[str]:
        return pulumi.get(self, "akamai_bot_category_action")
