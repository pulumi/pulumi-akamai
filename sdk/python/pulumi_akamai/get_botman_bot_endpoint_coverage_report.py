...
def get_botman_bot_endpoint_coverage_report(config_id: Optional[builtins.int] = None,
...
def get_botman_bot_endpoint_coverage_report_output(config_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
