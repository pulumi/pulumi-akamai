...
class GetAppSecApiRequestConstraintsResult:
    ...
    """
    def __init__(__self__, api_id=None, config_id=None, id=None, json=None, security_policy_id=None):
    ...
    def api_id(self) -> Optional[_builtins.int]:
...
def get_app_sec_api_request_constraints(api_id: Optional[_builtins.int] = None,
...
def get_app_sec_api_request_constraints_output(api_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
