...
class GetAppSecApiRequestConstraintsResult:
    ...
    def api_id(self) -> Optional[builtins.int]:
...
def get_app_sec_api_request_constraints(api_id: Optional[builtins.int] = None,
...
def get_app_sec_api_request_constraints_output(api_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
