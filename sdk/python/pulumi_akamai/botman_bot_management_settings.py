...
class _BotmanBotManagementSettingsState:
    def __init__(__self__, *,
                 bot_management_settings: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="botManagementSettings")
    def bot_management_settings(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "bot_management_settings")

    @bot_management_settings.setter
    def bot_management_settings(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "bot_management_settings", value)
...
class BotmanBotManagementSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bot_management_settings: pulumi.Input[Optional[_builtins.str]] = None,
            config_id: pulumi.Input[Optional[_builtins.int]] = None,
            security_policy_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'BotmanBotManagementSettings':
        """
