...
class GetAppSecRatePolicyActionsResult:
    ...
    def rate_policy_id(self) -> Optional[builtins.int]:
...
def get_app_sec_rate_policy_actions(config_id: Optional[builtins.int] = None,
                                    rate_policy_id: Optional[builtins.int] = None,
...
def get_app_sec_rate_policy_actions_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
                                           rate_policy_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
