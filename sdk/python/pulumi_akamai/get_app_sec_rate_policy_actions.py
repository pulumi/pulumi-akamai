...
def get_app_sec_rate_policy_actions(config_id: Optional[_builtins.int] = None,
                                    rate_policy_id: Optional[_builtins.int] = None,
...
def get_app_sec_rate_policy_actions_output(config_id: pulumi.Input[Optional[_builtins.int]] = None,
