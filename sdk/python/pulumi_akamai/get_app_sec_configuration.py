...
def get_app_sec_configuration(name: Optional[_builtins.str] = None,
...
def get_app_sec_configuration_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
