...
def get_app_sec_configuration(name: Optional[builtins.str] = None,
...
def get_app_sec_configuration_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
