...
class GetAppSecCustomDenyResult:
    ...
    def custom_deny_id(self) -> Optional[builtins.str]:
...
def get_app_sec_custom_deny(config_id: Optional[builtins.int] = None,
                            custom_deny_id: Optional[builtins.str] = None,
...
def get_app_sec_custom_deny_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
                                   custom_deny_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
