...
def get_app_sec_advanced_settings_pragma_header(config_id: Optional[builtins.int] = None,
...
def get_app_sec_advanced_settings_pragma_header_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
