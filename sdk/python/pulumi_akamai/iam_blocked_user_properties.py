...
class IamBlockedUserPropertiesArgs:
    def __init__(__self__, *,
                 blocked_properties: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]],
    ...
    def blocked_properties(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]:
        """
    ...
    def blocked_properties(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]):
...
class IamBlockedUserProperties(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="blockedProperties")
    def blocked_properties(self) -> pulumi.Output[Sequence[_builtins.int]]:
        """
        List of properties to block for a user.
        """
        return pulumi.get(self, "blocked_properties")
