...
class IamBlockedUserPropertiesArgs:
    def __init__(__self__, *,
                 blocked_properties: pulumi.Input[Sequence[pulumi.Input[builtins.int]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] blocked_properties: List of properties to block for a user.
        :param pulumi.Input[builtins.int] group_id: A unique identifier for a group.
        :param pulumi.Input[builtins.str] identity_id: A unique identifier for a user's profile, which corresponds to a user's actual profile or client ID.
        """
    ...
    def blocked_properties(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
    ...
    def blocked_properties(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
...
class _IamBlockedUserPropertiesState:
    def __init__(__self__, *,
                 blocked_properties: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
    ...
    @property
    @pulumi.getter(name="blockedProperties")
    def blocked_properties(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        List of properties to block for a user.
        """
        return pulumi.get(self, "blocked_properties")
    ...
    @blocked_properties.setter
    def blocked_properties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "blocked_properties", value)
...
class IamBlockedUserProperties(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            blocked_properties: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
            group_id: Optional[pulumi.Input[builtins.int]] = None,
            identity_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IamBlockedUserProperties':
        """
    ...
    @property
    @pulumi.getter(name="blockedProperties")
    def blocked_properties(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        List of properties to block for a user.
        """
        return pulumi.get(self, "blocked_properties")
