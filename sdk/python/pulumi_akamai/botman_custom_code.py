...
__all__ = ['BotmanCustomCodeArgs', 'BotmanCustomCode']

@pulumi.input_type
class BotmanCustomCodeArgs:
    def __init__(__self__, *,
                 config_id: pulumi.Input[builtins.int],
                 custom_code: pulumi.Input[builtins.str]):
        """
    ...
    def custom_code(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "custom_code")

    @custom_code.setter
    def custom_code(self, value: pulumi.Input[builtins.str]):
...
class _BotmanCustomCodeState:
    def __init__(__self__, *,
                 ...
                 custom_code: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="customCode")
    def custom_code(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_code")

    @custom_code.setter
    def custom_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_code", value)
...
class BotmanCustomCode(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanCustomCode resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanCustomCodeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanCustomCodeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanCustomCodeArgs.__new__(BotmanCustomCodeArgs)

            if config_id is None and not opts.urn:
                raise TypeError("Missing required property 'config_id'")
            __props__.__dict__["config_id"] = config_id
            if custom_code is None and not opts.urn:
                raise TypeError("Missing required property 'custom_code'")
            __props__.__dict__["custom_code"] = custom_code
        super(BotmanCustomCode, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            custom_code: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanCustomCode':
        """
        ...
        __props__ = _BotmanCustomCodeState.__new__(_BotmanCustomCodeState)
    ...
    @property
    @pulumi.getter(name="customCode")
    def custom_code(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "custom_code")
