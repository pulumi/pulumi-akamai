...
class GtmCidrmap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if default_datacenter is not None and not isinstance(default_datacenter, GtmCidrmapDefaultDatacenterArgs):
                default_datacenter = default_datacenter or {}
                def _setter(key, value):
                    default_datacenter[key] = value
                GtmCidrmapDefaultDatacenterArgs._configure(_setter, **default_datacenter)
