...
class BotmanContentProtectionRuleSequenceArgs:
    def __init__(__self__, *,
                 ...
                 content_protection_rule_ids: pulumi.Input[Sequence[pulumi.Input[str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] content_protection_rule_ids: Unique identifiers of content protection rules, listed in the order of their evaluation
    ...
    def content_protection_rule_ids(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
    ...
    def content_protection_rule_ids(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
...
class _BotmanContentProtectionRuleSequenceState:
    def __init__(__self__, *,
                 ...
                 content_protection_rule_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
    ...
    @property
    @pulumi.getter(name="contentProtectionRuleIds")
    def content_protection_rule_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        Unique identifiers of content protection rules, listed in the order of their evaluation
        """
        return pulumi.get(self, "content_protection_rule_ids")
    ...
    @content_protection_rule_ids.setter
    def content_protection_rule_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "content_protection_rule_ids", value)
...
class BotmanContentProtectionRuleSequence(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[int]] = None,
            content_protection_rule_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            security_policy_id: Optional[pulumi.Input[str]] = None) -> 'BotmanContentProtectionRuleSequence':
        """
    ...
    @property
    @pulumi.getter(name="contentProtectionRuleIds")
    def content_protection_rule_ids(self) -> pulumi.Output[Sequence[str]]:
        """
        Unique identifiers of content protection rules, listed in the order of their evaluation
        """
        return pulumi.get(self, "content_protection_rule_ids")
