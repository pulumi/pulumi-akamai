...
def get_appsec_advanced_settings_attack_payload_logging(config_id: Optional[builtins.int] = None,
...
def get_appsec_advanced_settings_attack_payload_logging_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
