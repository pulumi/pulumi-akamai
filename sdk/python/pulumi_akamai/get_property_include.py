...
class GetPropertyIncludeResult:
    ...
    def latest_version(self) -> builtins.int:
    ...
    def production_version(self) -> builtins.int:
        return pulumi.get(self, "production_version")

    @property
    @pulumi.getter(name="stagingVersion")
    def staging_version(self) -> builtins.int:
...
def get_property_include(contract_id: Optional[builtins.str] = None,
                         group_id: Optional[builtins.str] = None,
                         include_id: Optional[builtins.str] = None,
...
def get_property_include_output(contract_id: Optional[pulumi.Input[builtins.str]] = None,
