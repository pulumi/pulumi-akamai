...
def get_appsec_penalty_box_conditions(config_id: Optional[_builtins.int] = None,
...
def get_appsec_penalty_box_conditions_output(config_id: Optional[pulumi.Input[_builtins.int]] = None,
