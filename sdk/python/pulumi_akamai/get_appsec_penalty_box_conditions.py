...
def get_appsec_penalty_box_conditions(config_id: Optional[builtins.int] = None,
...
def get_appsec_penalty_box_conditions_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
