...
class AppSecCustomDenyArgs:
    def __init__(__self__, *,
                 ...
                 custom_deny: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] custom_deny: JSON-formatted information about the properties and property values for the custom deny
        """
    ...
    def custom_deny(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @custom_deny.setter
    def custom_deny(self, value: pulumi.Input[builtins.str]):
...
class _AppSecCustomDenyState:
    def __init__(__self__, *,
                 ...
                 custom_deny: Optional[pulumi.Input[builtins.str]] = None,
                 custom_deny_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering AppSecCustomDeny resources.
        :param pulumi.Input[builtins.int] config_id: Unique identifier of the security configuration
        :param pulumi.Input[builtins.str] custom_deny: JSON-formatted information about the properties and property values for the custom deny
        :param pulumi.Input[builtins.str] custom_deny_id: custom_deny_id
        """
    ...
    @property
    @pulumi.getter(name="customDeny")
    def custom_deny(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        JSON-formatted information about the properties and property values for the custom deny
        """
        return pulumi.get(self, "custom_deny")
    ...
    @custom_deny.setter
    def custom_deny(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_deny", value)

    @property
    @pulumi.getter(name="customDenyId")
    def custom_deny_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        custom_deny_id
        """
    ...
    def custom_deny_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AppSecCustomDeny(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            custom_deny: Optional[pulumi.Input[builtins.str]] = None,
            custom_deny_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AppSecCustomDeny':
        """
    ...
    @property
    @pulumi.getter(name="customDeny")
    def custom_deny(self) -> pulumi.Output[builtins.str]:
        """
        JSON-formatted information about the properties and property values for the custom deny
        """
        return pulumi.get(self, "custom_deny")
    ...
    @property
    @pulumi.getter(name="customDenyId")
    def custom_deny_id(self) -> pulumi.Output[builtins.str]:
        """
        custom_deny_id
        """
        return pulumi.get(self, "custom_deny_id")
