...
class GetAppSecMatchTargetsResult:
    ...
    def match_target_id(self) -> Optional[builtins.int]:
...
def get_app_sec_match_targets(config_id: Optional[builtins.int] = None,
                              match_target_id: Optional[builtins.int] = None,
...
def get_app_sec_match_targets_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
                                     match_target_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
