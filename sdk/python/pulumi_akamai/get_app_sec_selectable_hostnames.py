...
class GetAppSecSelectableHostnamesResult:
    ...
    def active_in_production(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "active_in_production")

    @property
    @pulumi.getter(name="activeInStaging")
    def active_in_staging(self) -> Optional[builtins.bool]:
    ...
    @property
    @pulumi.getter
    def contractid(self) -> Optional[builtins.str]:
        return pulumi.get(self, "contractid")

    @property
    @pulumi.getter
    def groupid(self) -> Optional[builtins.int]:
...
def get_app_sec_selectable_hostnames(active_in_production: Optional[builtins.bool] = None,
                                     active_in_staging: Optional[builtins.bool] = None,
                                     config_id: Optional[builtins.int] = None,
                                     contractid: Optional[builtins.str] = None,
                                     groupid: Optional[builtins.int] = None,
...
def get_app_sec_selectable_hostnames_output(active_in_production: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                            active_in_staging: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                            config_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                            contractid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            groupid: Optional[pulumi.Input[Optional[builtins.int]]] = None,
