...
class GetAppSecReputationProfileActionsResult:
    ...
    """
    def __init__(__self__, action=None, config_id=None, id=None, json=None, reputation_profile_id=None, security_policy_id=None):
...
def get_app_sec_reputation_profile_actions(config_id: Optional[_builtins.int] = None,
                                           reputation_profile_id: Optional[_builtins.int] = None,
