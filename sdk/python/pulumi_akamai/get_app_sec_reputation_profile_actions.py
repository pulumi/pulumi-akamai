...
class GetAppSecReputationProfileActionsResult:
    ...
    def reputation_profile_id(self) -> Optional[builtins.int]:
...
def get_app_sec_reputation_profile_actions(config_id: Optional[builtins.int] = None,
                                           reputation_profile_id: Optional[builtins.int] = None,
...
def get_app_sec_reputation_profile_actions_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
                                                  reputation_profile_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
