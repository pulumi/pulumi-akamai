...
class BotmanCustomDefinedBotArgs:
    def __init__(__self__, *,
                 ...
                 custom_defined_bot: pulumi.Input[builtins.str]):
        """
    ...
    def custom_defined_bot(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "custom_defined_bot")

    @custom_defined_bot.setter
    def custom_defined_bot(self, value: pulumi.Input[builtins.str]):
...
class _BotmanCustomDefinedBotState:
    def __init__(__self__, *,
                 ...
                 custom_defined_bot: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="customDefinedBot")
    def custom_defined_bot(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_defined_bot")

    @custom_defined_bot.setter
    def custom_defined_bot(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_defined_bot", value)


@pulumi.type_token("akamai:index/botmanCustomDefinedBot:BotmanCustomDefinedBot")
class BotmanCustomDefinedBot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bot_id: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            custom_defined_bot: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanCustomDefinedBot':
        """
    ...
    @property
    @pulumi.getter(name="customDefinedBot")
    def custom_defined_bot(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "custom_defined_bot")
