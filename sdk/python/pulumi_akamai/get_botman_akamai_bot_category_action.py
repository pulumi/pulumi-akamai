...
def get_botman_akamai_bot_category_action(category_id: Optional[builtins.str] = None,
...
def get_botman_akamai_bot_category_action_output(category_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
