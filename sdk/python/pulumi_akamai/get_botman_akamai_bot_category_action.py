...
__all__ = [
    ...
    'AwaitableGetBotmanAkamaiBotCategoryActionResult',
    'get_botman_akamai_bot_category_action',
    'get_botman_akamai_bot_category_action_output',
]

@pulumi.output_type
class GetBotmanAkamaiBotCategoryActionResult:
    """
...
class AwaitableGetBotmanAkamaiBotCategoryActionResult(GetBotmanAkamaiBotCategoryActionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBotmanAkamaiBotCategoryActionResult(
...
def get_botman_akamai_bot_category_action(category_id: Optional[_builtins.str] = None,
                                          config_id: Optional[_builtins.int] = None,
                                          security_policy_id: Optional[_builtins.str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBotmanAkamaiBotCategoryActionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('akamai:index/getBotmanAkamaiBotCategoryAction:getBotmanAkamaiBotCategoryAction', __args__, opts=opts, typ=GetBotmanAkamaiBotCategoryActionResult).value

    return AwaitableGetBotmanAkamaiBotCategoryActionResult(
        category_id=pulumi.get(__ret__, 'category_id'),
        config_id=pulumi.get(__ret__, 'config_id'),
        id=pulumi.get(__ret__, 'id'),
        json=pulumi.get(__ret__, 'json'),
        security_policy_id=pulumi.get(__ret__, 'security_policy_id'))
def get_botman_akamai_bot_category_action_output(category_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
