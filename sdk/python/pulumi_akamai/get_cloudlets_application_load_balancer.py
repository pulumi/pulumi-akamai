...
def get_cloudlets_application_load_balancer(origin_id: Optional[builtins.str] = None,
...
def get_cloudlets_application_load_balancer_output(origin_id: Optional[pulumi.Input[builtins.str]] = None,
