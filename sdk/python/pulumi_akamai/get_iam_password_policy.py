...
class GetIamPasswordPolicyResult:
    ...
    def case_dif(self) -> builtins.int:
    ...
    def max_repeating(self) -> builtins.int:
        return pulumi.get(self, "max_repeating")

    @property
    @pulumi.getter(name="minDigits")
    def min_digits(self) -> builtins.int:
