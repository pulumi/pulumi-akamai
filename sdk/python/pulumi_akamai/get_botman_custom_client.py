...
class GetBotmanCustomClientResult:
    ...
    def custom_client_id(self) -> Optional[builtins.str]:
...
def get_botman_custom_client(config_id: Optional[builtins.int] = None,
                             custom_client_id: Optional[builtins.str] = None,
...
def get_botman_custom_client_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
                                    custom_client_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
