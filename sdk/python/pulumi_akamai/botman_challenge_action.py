...
class BotmanChallengeActionArgs:
    def __init__(__self__, *,
                 challenge_action: pulumi.Input[builtins.str],
    ...
    def challenge_action(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "challenge_action")

    @challenge_action.setter
    def challenge_action(self, value: pulumi.Input[builtins.str]):
...
class _BotmanChallengeActionState:
    def __init__(__self__, *,
                 ...
                 challenge_action: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="challengeAction")
    def challenge_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "challenge_action")

    @challenge_action.setter
    def challenge_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "challenge_action", value)
...
class BotmanChallengeAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            action_id: Optional[pulumi.Input[builtins.str]] = None,
            challenge_action: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None) -> 'BotmanChallengeAction':
        """
    ...
    @property
    @pulumi.getter(name="challengeAction")
    def challenge_action(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "challenge_action")
