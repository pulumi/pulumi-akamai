...
class GtmAsmap(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 assignments: pulumi.Input[Optional[Sequence[pulumi.Input[Union['GtmAsmapAssignmentArgs', 'GtmAsmapAssignmentArgsDict', 'outputs.GtmAsmapAssignment']]]]] = None,
                 default_datacenter: pulumi.Input[Optional[Union['GtmAsmapDefaultDatacenterArgs', 'GtmAsmapDefaultDatacenterArgsDict', 'outputs.GtmAsmapDefaultDatacenter']]] = None,
                 domain: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 wait_on_complete: pulumi.Input[Optional[_builtins.bool]] = None,
                 __props__=None):
