...
class CpsDvValidationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] enrollment_id: The unique identifier of enrollment
        :param pulumi.Input[builtins.bool] acknowledge_post_verification_warnings: Whether to acknowledge all post-verification warnings
...
class _CpsDvValidationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] enrollment_id: The unique identifier of enrollment
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sans: List of SANs
        :param pulumi.Input[builtins.str] status: Status of validation
        :param pulumi.Input['CpsDvValidationTimeoutsArgs'] timeouts: Enables to set timeout for processing
        """
        if acknowledge_post_verification_warnings is not None:
            pulumi.set(__self__, "acknowledge_post_verification_warnings", acknowledge_post_verification_warnings)
