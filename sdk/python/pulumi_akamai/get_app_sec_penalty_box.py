...
def get_app_sec_penalty_box(config_id: Optional[_builtins.int] = None,
...
def get_app_sec_penalty_box_output(config_id: pulumi.Input[Optional[_builtins.int]] = None,
