...
class GetAppSecContractsGroupsResult:
    ...
    def default_groupid(self) -> builtins.int:
...
def get_app_sec_contracts_groups(contractid: Optional[builtins.str] = None,
...
def get_app_sec_contracts_groups_output(contractid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
