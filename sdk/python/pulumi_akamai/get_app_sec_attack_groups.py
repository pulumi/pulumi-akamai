...
class GetAppSecAttackGroupsResult:
    ...
    def attack_group(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "attack_group")

    @_builtins.property
    @pulumi.getter(name="attackGroupAction")
    def attack_group_action(self) -> _builtins.str:
...
def get_app_sec_attack_groups(attack_group: Optional[_builtins.str] = None,
...
def get_app_sec_attack_groups_output(attack_group: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
