        ...
        * Move origin functionality to the edge.
        ...
        The **variables** object supports the following:
          ...
          * `variables` (`pulumi.Input[list]`)
            ...
            * `hidden` (`pulumi.Input[bool]`) - — (Optional) Whether to hide the variable when debugging requests
            * `name` (`pulumi.Input[str]`) - — (Required) The name of the variable.
            * `sensitive` (`pulumi.Input[bool]`) - — (Optional) Whether to obscure the value when debugging requests
