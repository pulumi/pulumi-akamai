...
class GetEdgeWorkerResult:
    ...
    def edgeworker_id(self) -> builtins.int:
    ...
    def local_bundle(self) -> Optional[builtins.str]:
    ...
    def resource_tier_id(self) -> builtins.int:
...
def get_edge_worker(edgeworker_id: Optional[builtins.int] = None,
                    local_bundle: Optional[builtins.str] = None,
...
def get_edge_worker_output(edgeworker_id: Optional[pulumi.Input[builtins.int]] = None,
                           local_bundle: Optional[pulumi.Input[Optional[builtins.str]]] = None,
