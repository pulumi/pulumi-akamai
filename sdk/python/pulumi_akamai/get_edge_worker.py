...
def get_edge_worker_output(edgeworker_id: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                           local_bundle: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
