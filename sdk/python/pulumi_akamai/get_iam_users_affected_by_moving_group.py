...
class GetIamUsersAffectedByMovingGroupResult:
    ...
    def destination_group_id(self) -> builtins.int:
    ...
    def source_group_id(self) -> builtins.int:
...
def get_iam_users_affected_by_moving_group(destination_group_id: Optional[builtins.int] = None,
                                           source_group_id: Optional[builtins.int] = None,
...
def get_iam_users_affected_by_moving_group_output(destination_group_id: Optional[pulumi.Input[builtins.int]] = None,
                                                  source_group_id: Optional[pulumi.Input[builtins.int]] = None,
