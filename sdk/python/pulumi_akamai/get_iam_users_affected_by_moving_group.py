...
class GetIamUsersAffectedByMovingGroupResult:
    ...
    def source_group_id(self) -> _builtins.int:
...
def get_iam_users_affected_by_moving_group(destination_group_id: Optional[_builtins.int] = None,
                                           source_group_id: Optional[_builtins.int] = None,
