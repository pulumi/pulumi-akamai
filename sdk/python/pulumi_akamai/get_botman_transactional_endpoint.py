...
def get_botman_transactional_endpoint(config_id: Optional[builtins.int] = None,
...
def get_botman_transactional_endpoint_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
