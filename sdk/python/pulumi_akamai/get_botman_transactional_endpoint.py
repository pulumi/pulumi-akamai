...
def get_botman_transactional_endpoint(config_id: Optional[_builtins.int] = None,
...
def get_botman_transactional_endpoint_output(config_id: Optional[pulumi.Input[_builtins.int]] = None,
