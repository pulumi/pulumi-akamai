...
__all__ = [
    'GetAppsecAdvancedSettingsRequestBodyResult',
    'AwaitableGetAppsecAdvancedSettingsRequestBodyResult',
    'get_appsec_advanced_settings_request_body',
    'get_appsec_advanced_settings_request_body_output',
]

@pulumi.output_type
class GetAppsecAdvancedSettingsRequestBodyResult:
    """
...
class AwaitableGetAppsecAdvancedSettingsRequestBodyResult(GetAppsecAdvancedSettingsRequestBodyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppsecAdvancedSettingsRequestBodyResult(
...
def get_appsec_advanced_settings_request_body(config_id: Optional[builtins.int] = None,
                                              security_policy_id: Optional[builtins.str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppsecAdvancedSettingsRequestBodyResult:
    """
...
def get_appsec_advanced_settings_request_body_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
