...
class GetCPSEnrollmentResult:
    ...
    def assigned_slots(self) -> Sequence[builtins.int]:
    ...
    def enable_multi_stacked_certificates(self) -> builtins.bool:
        return pulumi.get(self, "enable_multi_stacked_certificates")

    @property
    @pulumi.getter(name="enrollmentId")
    def enrollment_id(self) -> builtins.int:
    ...
    def pending_changes(self) -> builtins.bool:
        return pulumi.get(self, "pending_changes")

    @property
    @pulumi.getter(name="productionSlots")
    def production_slots(self) -> Sequence[builtins.int]:
    ...
    def sni_only(self) -> builtins.bool:
        return pulumi.get(self, "sni_only")

    @property
    @pulumi.getter(name="stagingSlots")
    def staging_slots(self) -> Sequence[builtins.int]:
...
def get_cps_enrollment(enrollment_id: Optional[builtins.int] = None,
...
def get_cps_enrollment_output(enrollment_id: Optional[pulumi.Input[builtins.int]] = None,
