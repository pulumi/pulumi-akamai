...
class BotmanChallengeInjectionRulesArgs:
    def __init__(__self__, *,
                 challenge_injection_rules: pulumi.Input[builtins.str],
    ...
    def challenge_injection_rules(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "challenge_injection_rules")

    @challenge_injection_rules.setter
    def challenge_injection_rules(self, value: pulumi.Input[builtins.str]):
...
class _BotmanChallengeInjectionRulesState:
    def __init__(__self__, *,
                 challenge_injection_rules: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="challengeInjectionRules")
    def challenge_injection_rules(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "challenge_injection_rules")

    @challenge_injection_rules.setter
    def challenge_injection_rules(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "challenge_injection_rules", value)
...
class BotmanChallengeInjectionRules(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            challenge_injection_rules: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None) -> 'BotmanChallengeInjectionRules':
        """
    ...
    @property
    @pulumi.getter(name="challengeInjectionRules")
    def challenge_injection_rules(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "challenge_injection_rules")
