...
class AppSecMatchTargetArgs:
    def __init__(__self__, *,
                 ...
                 match_target: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] match_target: JSON-formatted definition of the match target
        """
    ...
    def match_target(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @match_target.setter
    def match_target(self, value: pulumi.Input[builtins.str]):
...
class _AppSecMatchTargetState:
    def __init__(__self__, *,
                 ...
                 match_target: Optional[pulumi.Input[builtins.str]] = None,
                 match_target_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering AppSecMatchTarget resources.
        :param pulumi.Input[builtins.int] config_id: Unique identifier of the security configuration
        :param pulumi.Input[builtins.str] match_target: JSON-formatted definition of the match target
        :param pulumi.Input[builtins.int] match_target_id: Unique identifier of the match target
        """
    ...
    @property
    @pulumi.getter(name="matchTarget")
    def match_target(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        JSON-formatted definition of the match target
        """
        return pulumi.get(self, "match_target")
    ...
    @match_target.setter
    def match_target(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "match_target", value)

    @property
    @pulumi.getter(name="matchTargetId")
    def match_target_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def match_target_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AppSecMatchTarget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            match_target: Optional[pulumi.Input[builtins.str]] = None,
            match_target_id: Optional[pulumi.Input[builtins.int]] = None) -> 'AppSecMatchTarget':
        """
    ...
    @property
    @pulumi.getter(name="matchTarget")
    def match_target(self) -> pulumi.Output[builtins.str]:
        """
        JSON-formatted definition of the match target
        """
        return pulumi.get(self, "match_target")
    ...
    @property
    @pulumi.getter(name="matchTargetId")
    def match_target_id(self) -> pulumi.Output[builtins.int]:
        """
        Unique identifier of the match target
        """
        return pulumi.get(self, "match_target_id")
