...
class AppsecAdvancedSettingsAttackPayloadLoggingArgs:
    def __init__(__self__, *,
                 attack_payload_logging: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] attack_payload_logging: Whether to enable, disable, or update attack payload logging settings
    ...
    def attack_payload_logging(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def attack_payload_logging(self, value: pulumi.Input[builtins.str]):
...
class _AppsecAdvancedSettingsAttackPayloadLoggingState:
    def __init__(__self__, *,
                 attack_payload_logging: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="attackPayloadLogging")
    def attack_payload_logging(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to enable, disable, or update attack payload logging settings
        """
        return pulumi.get(self, "attack_payload_logging")
    ...
    @attack_payload_logging.setter
    def attack_payload_logging(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "attack_payload_logging", value)
...
@pulumi.type_token("akamai:index/appsecAdvancedSettingsAttackPayloadLogging:AppsecAdvancedSettingsAttackPayloadLogging")
class AppsecAdvancedSettingsAttackPayloadLogging(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            attack_payload_logging: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AppsecAdvancedSettingsAttackPayloadLogging':
        """
    ...
    @property
    @pulumi.getter(name="attackPayloadLogging")
    def attack_payload_logging(self) -> pulumi.Output[builtins.str]:
        """
        Whether to enable, disable, or update attack payload logging settings
        """
        return pulumi.get(self, "attack_payload_logging")
