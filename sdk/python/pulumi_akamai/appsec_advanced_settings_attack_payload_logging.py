...
class AppsecAdvancedSettingsAttackPayloadLoggingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] attack_payload_logging: . JSON representation of the Attack Payload Logging settings to be configured.
        :param pulumi.Input[int] config_id: . Unique identifier of the security configuration containing the Attack Payload Logging settings being modified.
        :param pulumi.Input[str] security_policy_id: . Unique identifier of the security policies whose settings are being modified. If not included, the Attack Payload Logging settings are modified at the configuration scope and, as a result, apply to all the security policies associated with the configuration.
        """
