...
class AppSecThreatIntelArgs:
    def __init__(__self__, *,
                 ...
                 threat_intel: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] threat_intel: Whether threat intelligence protection should be on or off
        """
    ...
    def threat_intel(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @threat_intel.setter
    def threat_intel(self, value: pulumi.Input[builtins.str]):
...
class _AppSecThreatIntelState:
    def __init__(__self__, *,
                 ...
                 threat_intel: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="threatIntel")
    def threat_intel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether threat intelligence protection should be on or off
        """
        return pulumi.get(self, "threat_intel")
    ...
    @threat_intel.setter
    def threat_intel(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "threat_intel", value)


@pulumi.type_token("akamai:index/appSecThreatIntel:AppSecThreatIntel")
class AppSecThreatIntel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            threat_intel: Optional[pulumi.Input[builtins.str]] = None) -> 'AppSecThreatIntel':
        """
    ...
    @property
    @pulumi.getter(name="threatIntel")
    def threat_intel(self) -> pulumi.Output[builtins.str]:
        """
        Whether threat intelligence protection should be on or off
        """
        return pulumi.get(self, "threat_intel")
