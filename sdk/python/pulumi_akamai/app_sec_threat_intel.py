...
class _AppSecThreatIntelState:
    def __init__(__self__, *,
                 ...
                 threat_intel: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="threatIntel")
    def threat_intel(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Whether threat intelligence protection should be on or off
        """
        return pulumi.get(self, "threat_intel")
    ...
    @threat_intel.setter
    def threat_intel(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "threat_intel", value)
...
class AppSecThreatIntel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: pulumi.Input[Optional[_builtins.int]] = None,
            security_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
            threat_intel: pulumi.Input[Optional[_builtins.str]] = None) -> 'AppSecThreatIntel':
        """
