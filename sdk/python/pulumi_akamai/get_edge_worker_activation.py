...
def get_edge_worker_activation(edgeworker_id: Optional[builtins.int] = None,
...
def get_edge_worker_activation_output(edgeworker_id: Optional[pulumi.Input[builtins.int]] = None,
