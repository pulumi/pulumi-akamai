...
class GetAppSecWafModeResult:
    ...
    def eval_expiration_date(self) -> builtins.str:
        return pulumi.get(self, "eval_expiration_date")

    @property
    @pulumi.getter(name="evalRuleset")
    def eval_ruleset(self) -> builtins.str:
...
def get_app_sec_waf_mode(config_id: Optional[builtins.int] = None,
...
def get_app_sec_waf_mode_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
