...
def get_app_sec_rate_policies(config_id: Optional[builtins.int] = None,
...
def get_app_sec_rate_policies_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
