...
class GetBotmanBotDetectionResult:
    ...
    def detection_name(self) -> Optional[builtins.str]:
...
def get_botman_bot_detection(detection_name: Optional[builtins.str] = None,
...
def get_botman_bot_detection_output(detection_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
