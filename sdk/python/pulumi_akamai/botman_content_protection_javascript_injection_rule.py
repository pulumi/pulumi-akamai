...
class BotmanContentProtectionJavascriptInjectionRuleArgs:
    def __init__(__self__, *,
                 ...
                 content_protection_javascript_injection_rule: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] content_protection_javascript_injection_rule: The content protection JavaScript injection rule
    ...
    def content_protection_javascript_injection_rule(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def content_protection_javascript_injection_rule(self, value: pulumi.Input[builtins.str]):
...
class _BotmanContentProtectionJavascriptInjectionRuleState:
    def __init__(__self__, *,
                 ...
                 content_protection_javascript_injection_rule: Optional[pulumi.Input[builtins.str]] = None,
                 content_protection_javascript_injection_rule_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] config_id: Unique identifier of the security configuration
        :param pulumi.Input[builtins.str] content_protection_javascript_injection_rule: The content protection JavaScript injection rule
        :param pulumi.Input[builtins.str] content_protection_javascript_injection_rule_id: Unique identifier of a content protection JavaScript injection rule
        :param pulumi.Input[builtins.str] security_policy_id: Unique identifier of the security policy
        """
    ...
    @property
    @pulumi.getter(name="contentProtectionJavascriptInjectionRule")
    def content_protection_javascript_injection_rule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The content protection JavaScript injection rule
        """
        return pulumi.get(self, "content_protection_javascript_injection_rule")
    ...
    @content_protection_javascript_injection_rule.setter
    def content_protection_javascript_injection_rule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "content_protection_javascript_injection_rule", value)

    @property
    @pulumi.getter(name="contentProtectionJavascriptInjectionRuleId")
    def content_protection_javascript_injection_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_protection_javascript_injection_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BotmanContentProtectionJavascriptInjectionRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            content_protection_javascript_injection_rule: Optional[pulumi.Input[builtins.str]] = None,
            content_protection_javascript_injection_rule_id: Optional[pulumi.Input[builtins.str]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanContentProtectionJavascriptInjectionRule':
        """
    ...
    @property
    @pulumi.getter(name="contentProtectionJavascriptInjectionRule")
    def content_protection_javascript_injection_rule(self) -> pulumi.Output[builtins.str]:
        """
        The content protection JavaScript injection rule
        """
        return pulumi.get(self, "content_protection_javascript_injection_rule")
    ...
    @property
    @pulumi.getter(name="contentProtectionJavascriptInjectionRuleId")
    def content_protection_javascript_injection_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of a content protection JavaScript injection rule
        """
        return pulumi.get(self, "content_protection_javascript_injection_rule_id")
