...
class AppSecReputationProfileAnalysisArgs:
    def __init__(__self__, *,
                 ...
                 forward_shared_ip_to_http_header_siem: pulumi.Input[builtins.bool],
                 forward_to_http_header: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] forward_shared_ip_to_http_header_siem: Whether to add a value indicating that shared IPs are included in HTTP header and SIEM integration
        :param pulumi.Input[builtins.bool] forward_to_http_header: Whether to add client reputation details to requests forwarded to the origin server
    ...
    def forward_shared_ip_to_http_header_siem(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def forward_shared_ip_to_http_header_siem(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "forward_shared_ip_to_http_header_siem", value)

    @property
    @pulumi.getter(name="forwardToHttpHeader")
    def forward_to_http_header(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def forward_to_http_header(self, value: pulumi.Input[builtins.bool]):
...
class _AppSecReputationProfileAnalysisState:
    def __init__(__self__, *,
                 ...
                 forward_shared_ip_to_http_header_siem: Optional[pulumi.Input[builtins.bool]] = None,
                 forward_to_http_header: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="forwardSharedIpToHttpHeaderSiem")
    def forward_shared_ip_to_http_header_siem(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to add a value indicating that shared IPs are included in HTTP header and SIEM integration
        """
        return pulumi.get(self, "forward_shared_ip_to_http_header_siem")
    ...
    @forward_shared_ip_to_http_header_siem.setter
    def forward_shared_ip_to_http_header_siem(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "forward_shared_ip_to_http_header_siem", value)

    @property
    @pulumi.getter(name="forwardToHttpHeader")
    def forward_to_http_header(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to add client reputation details to requests forwarded to the origin server
        """
        return pulumi.get(self, "forward_to_http_header")
    ...
    @forward_to_http_header.setter
    def forward_to_http_header(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "forward_to_http_header", value)
...
class AppSecReputationProfileAnalysis(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            forward_shared_ip_to_http_header_siem: Optional[pulumi.Input[builtins.bool]] = None,
            forward_to_http_header: Optional[pulumi.Input[builtins.bool]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AppSecReputationProfileAnalysis':
        """
    ...
    @property
    @pulumi.getter(name="forwardSharedIpToHttpHeaderSiem")
    def forward_shared_ip_to_http_header_siem(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to add a value indicating that shared IPs are included in HTTP header and SIEM integration
        """
        return pulumi.get(self, "forward_shared_ip_to_http_header_siem")
    ...
    @property
    @pulumi.getter(name="forwardToHttpHeader")
    def forward_to_http_header(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to add client reputation details to requests forwarded to the origin server
        """
        return pulumi.get(self, "forward_to_http_header")
