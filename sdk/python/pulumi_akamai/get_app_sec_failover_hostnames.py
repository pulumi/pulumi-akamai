...
def get_app_sec_failover_hostnames(config_id: Optional[builtins.int] = None,
...
def get_app_sec_failover_hostnames_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
