...
class AppSecSecurityPolicyCloneArgs:
    def __init__(__self__, *,
                 ...
                 create_from_security_policy_id: pulumi.Input[str],
        ...
        :param pulumi.Input[str] create_from_security_policy_id: The ID of the security policy to clone.
        :param pulumi.Input[str] security_policy_name: The name to be used for the new security policy. If not specified, the name will be autogenerated with the pattern 'clone from '.
        :param pulumi.Input[str] security_policy_prefix: The four-character policy prefix to be used for the new security policy. If not specified, the prefix will be autogenerated.
        """
    ...
    def create_from_security_policy_id(self) -> pulumi.Input[str]:
        """
    ...
    def create_from_security_policy_id(self, value: pulumi.Input[str]):
...
class _AppSecSecurityPolicyCloneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] config_id: The ID of the security configuration to use.
        :param pulumi.Input[str] create_from_security_policy_id: The ID of the security policy to clone.
        :param pulumi.Input[str] security_policy_id: The ID of the new security policy.
        :param pulumi.Input[str] security_policy_name: The name to be used for the new security policy. If not specified, the name will be autogenerated with the pattern 'clone from '.
        :param pulumi.Input[str] security_policy_prefix: The four-character policy prefix to be used for the new security policy. If not specified, the prefix will be autogenerated.
        """
...
class AppSecSecurityPolicyClone(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if create_from_security_policy_id is None and not opts.urn:
                raise TypeError("Missing required property 'create_from_security_policy_id'")
    ...
    @property
    @pulumi.getter(name="createFromSecurityPolicyId")
    def create_from_security_policy_id(self) -> pulumi.Output[str]:
        """
        The ID of the security policy to clone.
        """
        return pulumi.get(self, "create_from_security_policy_id")
    ...
    @property
    @pulumi.getter(name="securityPolicyPrefix")
    def security_policy_prefix(self) -> pulumi.Output[Optional[str]]:
        """
        The four-character policy prefix to be used for the new security policy. If not specified, the prefix will be autogenerated.
        """
        return pulumi.get(self, "security_policy_prefix")
