...
def get_property_include_activation(contract_id: Optional[builtins.str] = None,
...
def get_property_include_activation_output(contract_id: Optional[pulumi.Input[builtins.str]] = None,
