...
class GetCpsCsrResult:
    ...
    def csr_ecdsa(self) -> builtins.str:
        return pulumi.get(self, "csr_ecdsa")

    @property
    @pulumi.getter(name="csrRsa")
    def csr_rsa(self) -> builtins.str:
...
def get_cps_csr(enrollment_id: Optional[builtins.int] = None,
...
def get_cps_csr_output(enrollment_id: Optional[pulumi.Input[builtins.int]] = None,
