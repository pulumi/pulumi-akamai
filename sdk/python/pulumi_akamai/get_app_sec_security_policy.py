...
class GetAppSecSecurityPolicyResult:
    ...
    def security_policy_id_lists(self) -> Sequence[builtins.str]:
...
def get_app_sec_security_policy(config_id: Optional[builtins.int] = None,
...
def get_app_sec_security_policy_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
