...
def get_app_sec_hostname_coverage_match_targets(config_id: Optional[builtins.int] = None,
...
def get_app_sec_hostname_coverage_match_targets_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
