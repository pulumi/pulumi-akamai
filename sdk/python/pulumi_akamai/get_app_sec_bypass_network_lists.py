...
class GetAppSecBypassNetworkListsResult:
    ...
    def bypass_network_lists(self) -> Sequence[builtins.str]:
...
def get_app_sec_bypass_network_lists(config_id: Optional[builtins.int] = None,
...
def get_app_sec_bypass_network_lists_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
