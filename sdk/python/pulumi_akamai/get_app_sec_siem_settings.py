...
def get_app_sec_siem_settings(config_id: Optional[_builtins.int] = None,
...
def get_app_sec_siem_settings_output(config_id: Optional[pulumi.Input[_builtins.int]] = None,
