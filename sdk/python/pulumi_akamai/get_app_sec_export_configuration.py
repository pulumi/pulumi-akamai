...
def get_app_sec_export_configuration(config_id: Optional[builtins.int] = None,
...
def get_app_sec_export_configuration_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
                                            searches: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
