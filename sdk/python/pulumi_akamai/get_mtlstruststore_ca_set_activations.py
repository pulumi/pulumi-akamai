...
class GetMtlstruststoreCaSetActivationsResult:
    ...
    """
    def __init__(__self__, activations=None, ca_set_id=None, ca_set_name=None, network=None, status=None, type=None, version=None):
...
def get_mtlstruststore_ca_set_activations_output(ca_set_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
