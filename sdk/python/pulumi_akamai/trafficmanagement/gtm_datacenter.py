...
class GtmDatacenter(pulumi.CustomResource):
    ...
    def clone_of(self) -> Optional[float]:
    ...
    def cloud_server_targeting(self) -> Optional[bool]:
        """
        — (Boolean)
        """
    ...
    def default_load_object(self) -> Optional['outputs.GtmDatacenterDefaultLoadObject']:
