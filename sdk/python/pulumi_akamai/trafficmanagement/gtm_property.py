...
class GtmProperty(pulumi.CustomResource):
    ...
    def liveness_tests(self) -> Optional[List['outputs.GtmPropertyLivenessTest']]:
        """
        — (multiple allowed)
        """
    ...
    def max_unreachable_penalty(self) -> Optional[float]:
        return pulumi.get(self, "max_unreachable_penalty")

    @property
    @pulumi.getter(name="minLiveFraction")
    def min_live_fraction(self) -> Optional[float]:
    ...
    def score_aggregation_type(self) -> str:
        return pulumi.get(self, "score_aggregation_type")

    @property
    @pulumi.getter(name="staticRrSets")
    def static_rr_sets(self) -> Optional[List['outputs.GtmPropertyStaticRrSet']]:
        """
        — (multiple allowed)
        * `type`
        * `ttl`
    ...
    def unreachable_threshold(self) -> Optional[float]:
        return pulumi.get(self, "unreachable_threshold")

    @property
    @pulumi.getter(name="useComputedTargets")
    def use_computed_targets(self) -> Optional[bool]:
        """
        — (Boolean)
        * `backup_ip`
        """
