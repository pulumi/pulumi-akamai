...
class GtmCidrmap(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 assignments: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GtmCidrmapAssignmentArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['GtmCidrmapAssignmentArgs']]]] assignments: — (multiple allowed)
               * `datacenter_id`
               * `nickname`
    ...
    @property
    @pulumi.getter
    def assignments(self) -> Optional[List['outputs.GtmCidrmapAssignment']]:
        """
        — (multiple allowed)
        * `datacenter_id`
        * `nickname`
    ...
    def default_datacenter(self) -> 'outputs.GtmCidrmapDefaultDatacenter':
