...
class GetAppSecRulesResult:
    ...
    """
    def __init__(__self__, condition_exception=None, config_id=None, id=None, json=None, rule_action=None, rule_id=None, security_policy_id=None):
...
def get_app_sec_rules(config_id: Optional[_builtins.int] = None,
...
def get_app_sec_rules_output(config_id: Optional[pulumi.Input[_builtins.int]] = None,
