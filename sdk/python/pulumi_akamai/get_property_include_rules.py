...
def get_property_include_rules(contract_id: Optional[builtins.str] = None,
...
def get_property_include_rules_output(contract_id: Optional[pulumi.Input[builtins.str]] = None,
