...
class BotmanCustomClientSequenceArgs:
    def __init__(__self__, *,
                 ...
                 custom_client_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
    ...
    def custom_client_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "custom_client_ids")

    @custom_client_ids.setter
    def custom_client_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _BotmanCustomClientSequenceState:
    def __init__(__self__, *,
                 ...
                 custom_client_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="customClientIds")
    def custom_client_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "custom_client_ids")

    @custom_client_ids.setter
    def custom_client_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "custom_client_ids", value)
...
class BotmanCustomClientSequence(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanCustomClientSequence resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanCustomClientSequenceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanCustomClientSequenceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanCustomClientSequenceArgs.__new__(BotmanCustomClientSequenceArgs)

            if config_id is None and not opts.urn:
                raise TypeError("Missing required property 'config_id'")
            __props__.__dict__["config_id"] = config_id
            if custom_client_ids is None and not opts.urn:
                raise TypeError("Missing required property 'custom_client_ids'")
            __props__.__dict__["custom_client_ids"] = custom_client_ids
        super(BotmanCustomClientSequence, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            custom_client_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'BotmanCustomClientSequence':
        """
        ...
        __props__ = _BotmanCustomClientSequenceState.__new__(_BotmanCustomClientSequenceState)
    ...
    @property
    @pulumi.getter(name="customClientIds")
    def custom_client_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "custom_client_ids")
