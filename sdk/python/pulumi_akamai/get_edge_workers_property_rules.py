...
def get_edge_workers_property_rules(edgeworker_id: Optional[builtins.int] = None,
...
def get_edge_workers_property_rules_output(edgeworker_id: Optional[pulumi.Input[builtins.int]] = None,
