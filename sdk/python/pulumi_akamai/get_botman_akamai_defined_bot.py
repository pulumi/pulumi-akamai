...
class GetBotmanAkamaiDefinedBotResult:
    ...
    def bot_name(self) -> Optional[builtins.str]:
...
def get_botman_akamai_defined_bot(bot_name: Optional[builtins.str] = None,
...
def get_botman_akamai_defined_bot_output(bot_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
