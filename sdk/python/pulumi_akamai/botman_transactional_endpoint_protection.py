...
class BotmanTransactionalEndpointProtectionArgs:
    def __init__(__self__, *,
                 ...
                 transactional_endpoint_protection: pulumi.Input[builtins.str]):
        """
    ...
    def transactional_endpoint_protection(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "transactional_endpoint_protection")

    @transactional_endpoint_protection.setter
    def transactional_endpoint_protection(self, value: pulumi.Input[builtins.str]):
...
class _BotmanTransactionalEndpointProtectionState:
    def __init__(__self__, *,
                 ...
                 transactional_endpoint_protection: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="transactionalEndpointProtection")
    def transactional_endpoint_protection(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "transactional_endpoint_protection")

    @transactional_endpoint_protection.setter
    def transactional_endpoint_protection(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transactional_endpoint_protection", value)


@pulumi.type_token("akamai:index/botmanTransactionalEndpointProtection:BotmanTransactionalEndpointProtection")
class BotmanTransactionalEndpointProtection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None,
            transactional_endpoint_protection: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanTransactionalEndpointProtection':
        """
    ...
    @property
    @pulumi.getter(name="transactionalEndpointProtection")
    def transactional_endpoint_protection(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "transactional_endpoint_protection")
