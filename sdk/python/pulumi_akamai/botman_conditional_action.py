...
class BotmanConditionalActionArgs:
    def __init__(__self__, *,
                 conditional_action: pulumi.Input[builtins.str],
    ...
    def conditional_action(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "conditional_action")

    @conditional_action.setter
    def conditional_action(self, value: pulumi.Input[builtins.str]):
...
class _BotmanConditionalActionState:
    def __init__(__self__, *,
                 ...
                 conditional_action: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="conditionalAction")
    def conditional_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "conditional_action")

    @conditional_action.setter
    def conditional_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "conditional_action", value)
...
class BotmanConditionalAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            action_id: Optional[pulumi.Input[builtins.str]] = None,
            conditional_action: Optional[pulumi.Input[builtins.str]] = None,
            config_id: Optional[pulumi.Input[builtins.int]] = None) -> 'BotmanConditionalAction':
        """
    ...
    @property
    @pulumi.getter(name="conditionalAction")
    def conditional_action(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "conditional_action")
