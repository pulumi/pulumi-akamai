...
class BotmanTransactionalEndpointArgs:
    def __init__(__self__, *,
                 ...
                 transactional_endpoint: pulumi.Input[builtins.str]):
        """
    ...
    def transactional_endpoint(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "transactional_endpoint")

    @transactional_endpoint.setter
    def transactional_endpoint(self, value: pulumi.Input[builtins.str]):
...
class _BotmanTransactionalEndpointState:
    def __init__(__self__, *,
                 ...
                 transactional_endpoint: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="transactionalEndpoint")
    def transactional_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "transactional_endpoint")

    @transactional_endpoint.setter
    def transactional_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transactional_endpoint", value)
...
class BotmanTransactionalEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a BotmanTransactionalEndpoint resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BotmanTransactionalEndpointArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BotmanTransactionalEndpointArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BotmanTransactionalEndpointArgs.__new__(BotmanTransactionalEndpointArgs)
            ...
            if transactional_endpoint is None and not opts.urn:
                raise TypeError("Missing required property 'transactional_endpoint'")
            __props__.__dict__["transactional_endpoint"] = transactional_endpoint
        super(BotmanTransactionalEndpoint, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            operation_id: Optional[pulumi.Input[builtins.str]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            transactional_endpoint: Optional[pulumi.Input[builtins.str]] = None) -> 'BotmanTransactionalEndpoint':
        """
        ...
        __props__ = _BotmanTransactionalEndpointState.__new__(_BotmanTransactionalEndpointState)
    ...
    @property
    @pulumi.getter(name="transactionalEndpoint")
    def transactional_endpoint(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "transactional_endpoint")
