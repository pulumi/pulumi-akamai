...
class BotmanTransactionalEndpointArgs:
    ...
    def transactional_endpoint(self) -> pulumi.Input[str]:
        return pulumi.get(self, "transactional_endpoint")

    @transactional_endpoint.setter
    def transactional_endpoint(self, value: pulumi.Input[str]):
...
class _BotmanTransactionalEndpointState:
    ...
    @property
    @pulumi.getter(name="transactionalEndpoint")
    def transactional_endpoint(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "transactional_endpoint")

    @transactional_endpoint.setter
    def transactional_endpoint(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "transactional_endpoint", value)
...
class BotmanTransactionalEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            operation_id: Optional[pulumi.Input[str]] = None,
            security_policy_id: Optional[pulumi.Input[str]] = None,
            transactional_endpoint: Optional[pulumi.Input[str]] = None) -> 'BotmanTransactionalEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="transactionalEndpoint")
    def transactional_endpoint(self) -> pulumi.Output[str]:
        return pulumi.get(self, "transactional_endpoint")
