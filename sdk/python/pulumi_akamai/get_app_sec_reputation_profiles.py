...
def get_app_sec_reputation_profiles(config_id: Optional[builtins.int] = None,
...
def get_app_sec_reputation_profiles_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
