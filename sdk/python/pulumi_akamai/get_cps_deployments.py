...
class GetCpsDeploymentsResult:
    ...
    def auto_renewal_start_time(self) -> builtins.str:
...
def get_cps_deployments(enrollment_id: Optional[builtins.int] = None,
...
def get_cps_deployments_output(enrollment_id: Optional[pulumi.Input[builtins.int]] = None,
