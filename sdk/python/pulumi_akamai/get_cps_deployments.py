...
class GetCpsDeploymentsResult:
    ...
    def auto_renewal_start_time(self) -> _builtins.str:
...
def get_cps_deployments(enrollment_id: Optional[_builtins.int] = None,
