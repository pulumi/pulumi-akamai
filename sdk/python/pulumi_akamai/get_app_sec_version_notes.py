...
def get_app_sec_version_notes(config_id: Optional[builtins.int] = None,
...
def get_app_sec_version_notes_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
