...
def get_app_sec_custom_rules(config_id: Optional[builtins.int] = None,
...
def get_app_sec_custom_rules_output(config_id: Optional[pulumi.Input[builtins.int]] = None,
