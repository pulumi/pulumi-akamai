 ...
 * 
 * const demoAsmap = new akamai.TrafficManagement.GtmASmap("demoAsmap", {
 *     defaultDatacenter: {
 *         datacenterId: 5400,
 ...
 * ```
 *
 * > This content is derived from https://github.com/terraform-providers/terraform-provider-akamai/blob/master/website/docs/r/gtm_asmap.html.markdown.
 */
