 ...
 * 
 * const demoResource = new akamai.TrafficManagement.GtmResource("demoResource", {
 ...
 * ```
 *
 * > This content is derived from https://github.com/terraform-providers/terraform-provider-akamai/blob/master/website/docs/r/gtm_resource.html.markdown.
 */
