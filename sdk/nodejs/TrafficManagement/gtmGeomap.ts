 ...
 * 
 * const demoGeomap = new akamai.TrafficManagement.GtmGeomap("demoGeomap", {
 *     defaultDatacenter: {
 *         datacenterId: 5400,
 *         nickname: "All Others",
 *     },
 ...
 * ```
 *
 * > This content is derived from https://github.com/terraform-providers/terraform-provider-akamai/blob/master/website/docs/r/gtm_geomap.html.markdown.
 */
