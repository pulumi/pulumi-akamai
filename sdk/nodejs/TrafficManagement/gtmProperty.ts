 ...
 * 
 * const demoProperty = new akamai.TrafficManagement.GtmProperty("demoProperty", {
 ...
 * ```
 *
 * > This content is derived from https://github.com/terraform-providers/terraform-provider-akamai/blob/master/website/docs/r/gtm_property.html.markdown.
 */
