...
export class PropertyActivation extends pulumi.CustomResource {
     ...
     */
    public readonly complianceRecord!: pulumi.Output<outputs.properties.PropertyActivationComplianceRecord | undefined>;
...
export interface PropertyActivationState {
     ...
     * Provides an audit record when activating on a production network
     */
    complianceRecord?: pulumi.Input<inputs.properties.PropertyActivationComplianceRecord>;
