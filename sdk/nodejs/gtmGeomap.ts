...
export class GtmGeomap extends pulumi.CustomResource {
    ...
    declare public readonly assignments: pulumi.Output<outputs.GtmGeomapAssignment[] | undefined>;
    declare public readonly defaultDatacenter: pulumi.Output<outputs.GtmGeomapDefaultDatacenter>;
