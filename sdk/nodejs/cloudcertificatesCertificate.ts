...
export class CloudcertificatesCertificate extends pulumi.CustomResource {
     ...
     */
    declare public readonly renewBeforeExpirationDays: pulumi.Output<number | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CloudcertificatesCertificateArgs | CloudcertificatesCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["renewBeforeExpirationDays"] = state?.renewBeforeExpirationDays;
            ...
            resourceInputs["renewBeforeExpirationDays"] = args?.renewBeforeExpirationDays;
...
export interface CloudcertificatesCertificateState {
     ...
     * Number of days before the certificate's expiration date when renewal should be indicated. Only non-negative values are accepted.
     */
    renewBeforeExpirationDays?: pulumi.Input<number>;
    /**
     * Indicates whether the certificate needs renewal. Set to true when the current time is within 'renew_before_expiration_days' of the certificate's expiration date.
     */
