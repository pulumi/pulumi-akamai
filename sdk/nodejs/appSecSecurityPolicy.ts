...
export class AppSecSecurityPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly createFromSecurityPolicyId: pulumi.Output<string | undefined>;
    /**
     * Whether to assign default settings to the new security policy
     */
    declare public readonly defaultSettings: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AppSecSecurityPolicyArgs | AppSecSecurityPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["createFromSecurityPolicyId"] = state?.createFromSecurityPolicyId;
            ...
            resourceInputs["createFromSecurityPolicyId"] = args?.createFromSecurityPolicyId;
