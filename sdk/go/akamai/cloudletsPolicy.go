...
// The description of this specific policy.
func (o CloudletsPolicyOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *CloudletsPolicy) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
