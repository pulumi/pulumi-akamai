...
func (o GetAppSecAttackGroupsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAppSecAttackGroupsResult] {
	return pulumix.Output[GetAppSecAttackGroupsResult]{
