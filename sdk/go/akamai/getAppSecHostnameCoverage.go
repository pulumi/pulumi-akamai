...
func GetAppSecHostnameCoverageOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetAppSecHostnameCoverageResultOutput {
	...
	return ctx.InvokeOutput("akamai:index/getAppSecHostnameCoverage:getAppSecHostnameCoverage", nil, GetAppSecHostnameCoverageResultOutput{}, options).(GetAppSecHostnameCoverageResultOutput)
}
