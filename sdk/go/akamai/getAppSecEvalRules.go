...
func (o GetAppSecEvalRulesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAppSecEvalRulesResult] {
	return pulumix.Output[GetAppSecEvalRulesResult]{
