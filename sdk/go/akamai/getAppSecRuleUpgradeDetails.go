...
func (o GetAppSecRuleUpgradeDetailsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAppSecRuleUpgradeDetailsResult] {
	return pulumix.Output[GetAppSecRuleUpgradeDetailsResult]{
