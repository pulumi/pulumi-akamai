...
func (o GetPropertyProductsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetPropertyProductsResult] {
	return pulumix.Output[GetPropertyProductsResult]{
