...
func (o GetAppSecCustomRuleActionsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAppSecCustomRuleActionsResult] {
	return pulumix.Output[GetAppSecCustomRuleActionsResult]{
