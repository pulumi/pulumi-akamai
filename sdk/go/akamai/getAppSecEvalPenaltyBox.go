...
func (o LookupAppSecEvalPenaltyBoxResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAppSecEvalPenaltyBoxResult] {
	return pulumix.Output[LookupAppSecEvalPenaltyBoxResult]{
