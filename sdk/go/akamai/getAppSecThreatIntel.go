...
func (o LookupAppSecThreatIntelResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAppSecThreatIntelResult] {
	return pulumix.Output[LookupAppSecThreatIntelResult]{
