...
func (o GetAppSecCustomRulesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAppSecCustomRulesResult] {
	return pulumix.Output[GetAppSecCustomRulesResult]{
