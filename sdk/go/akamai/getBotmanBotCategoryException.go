...
func (o LookupBotmanBotCategoryExceptionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupBotmanBotCategoryExceptionResult] {
	return pulumix.Output[LookupBotmanBotCategoryExceptionResult]{
