...
public final class WebApplicationFirewallFirewallConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebApplicationFirewallFirewallConfigurationArgs Empty = new WebApplicationFirewallFirewallConfigurationArgs();
    ...
    private WebApplicationFirewallFirewallConfigurationArgs() {}

    private WebApplicationFirewallFirewallConfigurationArgs(WebApplicationFirewallFirewallConfigurationArgs $) {
    ...
    public static Builder builder(WebApplicationFirewallFirewallConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebApplicationFirewallFirewallConfigurationArgs();
        }

        public Builder(WebApplicationFirewallFirewallConfigurationArgs defaults) {
            $ = new WebApplicationFirewallFirewallConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebApplicationFirewallFirewallConfigurationArgs build() {
            return $;
        }
    }
