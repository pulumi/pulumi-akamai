...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitMirrorArgs build() {
            return $;
        }
    }
