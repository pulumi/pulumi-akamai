...
public final class GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationContrastArgs build() {
            return $;
        }
    }
