...
public final class MobileSdkPerformanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final MobileSdkPerformanceArgs Empty = new MobileSdkPerformanceArgs();
    ...
    private MobileSdkPerformanceArgs() {}

    private MobileSdkPerformanceArgs(MobileSdkPerformanceArgs $) {
    ...
    public static Builder builder(MobileSdkPerformanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MobileSdkPerformanceArgs();
        }

        public Builder(MobileSdkPerformanceArgs defaults) {
            $ = new MobileSdkPerformanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MobileSdkPerformanceArgs build() {
            return $;
        }
    }
