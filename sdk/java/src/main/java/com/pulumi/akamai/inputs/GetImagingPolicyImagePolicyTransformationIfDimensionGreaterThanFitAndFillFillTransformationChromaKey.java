...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationChromaKey build() {
            return $;
        }
    }
