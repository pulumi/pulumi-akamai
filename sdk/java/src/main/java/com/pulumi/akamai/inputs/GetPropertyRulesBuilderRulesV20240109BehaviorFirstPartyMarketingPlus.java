...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlus build() {
            return $;
        }
    }
