...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite(GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewrite build() {
            return $;
        }
    }
