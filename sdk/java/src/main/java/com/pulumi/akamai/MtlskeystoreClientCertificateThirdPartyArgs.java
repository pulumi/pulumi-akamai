...
public final class MtlskeystoreClientCertificateThirdPartyArgs extends com.pulumi.resources.ResourceArgs {

    public static final MtlskeystoreClientCertificateThirdPartyArgs Empty = new MtlskeystoreClientCertificateThirdPartyArgs();
    ...
    private Output<Map<String,MtlskeystoreClientCertificateThirdPartyVersionsArgs>> versions;
     ...
     * 
     */
    public Output<Map<String,MtlskeystoreClientCertificateThirdPartyVersionsArgs>> versions() {
        return this.versions;
    }

    private MtlskeystoreClientCertificateThirdPartyArgs() {}

    private MtlskeystoreClientCertificateThirdPartyArgs(MtlskeystoreClientCertificateThirdPartyArgs $) {
    ...
    public static Builder builder(MtlskeystoreClientCertificateThirdPartyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MtlskeystoreClientCertificateThirdPartyArgs();
        }

        public Builder(MtlskeystoreClientCertificateThirdPartyArgs defaults) {
            $ = new MtlskeystoreClientCertificateThirdPartyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder versions(Output<Map<String,MtlskeystoreClientCertificateThirdPartyVersionsArgs>> versions) {
            $.versions = versions;
            return this;
        }
        ...
        public MtlskeystoreClientCertificateThirdPartyArgs build() {
            if ($.certificateName == null) {
                throw new MissingRequiredPropertyException("MtlskeystoreClientCertificateThirdPartyArgs", "certificateName");
            }
            if ($.contractId == null) {
                throw new MissingRequiredPropertyException("MtlskeystoreClientCertificateThirdPartyArgs", "contractId");
            }
            if ($.geography == null) {
                throw new MissingRequiredPropertyException("MtlskeystoreClientCertificateThirdPartyArgs", "geography");
            }
            if ($.groupId == null) {
                throw new MissingRequiredPropertyException("MtlskeystoreClientCertificateThirdPartyArgs", "groupId");
            }
            if ($.notificationEmails == null) {
                throw new MissingRequiredPropertyException("MtlskeystoreClientCertificateThirdPartyArgs", "notificationEmails");
            }
            if ($.secureNetwork == null) {
                throw new MissingRequiredPropertyException("MtlskeystoreClientCertificateThirdPartyArgs", "secureNetwork");
            }
            if ($.versions == null) {
                throw new MissingRequiredPropertyException("MtlskeystoreClientCertificateThirdPartyArgs", "versions");
            }
            return $;
        }
    }
