...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationAspectCropArgs build() {
            return $;
        }
    }
