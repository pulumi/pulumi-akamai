...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColorArgs build() {
            return $;
        }
    }
