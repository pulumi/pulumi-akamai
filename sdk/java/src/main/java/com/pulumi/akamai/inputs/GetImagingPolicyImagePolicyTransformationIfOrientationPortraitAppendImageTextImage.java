...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitAppendImageTextImage build() {
            return $;
        }
    }
