...
public final class TieredDistributionArgs extends com.pulumi.resources.ResourceArgs {

    public static final TieredDistributionArgs Empty = new TieredDistributionArgs();
    ...
    private TieredDistributionArgs() {}

    private TieredDistributionArgs(TieredDistributionArgs $) {
    ...
    public static Builder builder(TieredDistributionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TieredDistributionArgs();
        }

        public Builder(TieredDistributionArgs defaults) {
            $ = new TieredDistributionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TieredDistributionArgs build() {
            return $;
        }
    }
