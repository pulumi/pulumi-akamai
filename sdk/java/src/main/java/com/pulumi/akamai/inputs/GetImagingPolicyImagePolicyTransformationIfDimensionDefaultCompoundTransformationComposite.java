...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImage image;

    public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationComposite build() {
