...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanGoop build() {
            return $;
        }
    }
