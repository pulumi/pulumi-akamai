...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginalArgs>> cpCodeOriginal() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginalArgs cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed) {
         ...
         * 
         */
        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoArgs build() {
            return $;
        }
    }
