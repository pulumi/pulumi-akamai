...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropRegionOfInterestArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropRegionOfInterestArgs> regionOfInterest;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropRegionOfInterestArgs> regionOfInterest() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder regionOfInterest(Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropRegionOfInterestArgs> regionOfInterest) {
            $.regionOfInterest = regionOfInterest;
            return this;
        }

        public Builder regionOfInterest(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropRegionOfInterestArgs regionOfInterest) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRegionOfInterestCropArgs build() {
