...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomCpCode;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomCpCode> waitingRoomCpCode() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage;

    /**
     * @return Specifies the NetStorage domain for the waiting room page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomNetStorage> waitingRoomNetStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization(GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder waitingRoomCpCode(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode) {
         ...
         * 
         */
        public Builder waitingRoomNetStorage(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorVisitorPrioritization build() {
            return $;
        }
    }
