...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration();
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration(GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorWebApplicationFirewallFirewallConfiguration build() {
            return $;
        }
    }
