...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageTextImageArgs build() {
            return $;
        }
    }
