...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationPortraitIfOrientationPortraitCompositeArgs build() {
