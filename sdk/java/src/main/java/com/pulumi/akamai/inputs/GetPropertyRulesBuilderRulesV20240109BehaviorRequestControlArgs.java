...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorageArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorageArgs> netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorageArgs>> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorageArgs netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlArgs build() {
            return $;
        }
    }
