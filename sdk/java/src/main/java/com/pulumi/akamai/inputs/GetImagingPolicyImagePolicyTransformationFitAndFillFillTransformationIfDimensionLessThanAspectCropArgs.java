...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanAspectCropArgs build() {
            return $;
        }
    }
