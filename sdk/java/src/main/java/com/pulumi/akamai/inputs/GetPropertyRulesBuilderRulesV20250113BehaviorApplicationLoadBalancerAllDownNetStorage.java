...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage();
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage(GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage $) {
        this.cpCode = $.cpCode;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage(Objects.requireNonNull(defaults));
        }
