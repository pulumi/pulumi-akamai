...
public final class VirtualWaitingRoom extends com.pulumi.resources.InvokeArgs {

    public static final VirtualWaitingRoom Empty = new VirtualWaitingRoom();
    ...
    private VirtualWaitingRoom() {}

    private VirtualWaitingRoom(VirtualWaitingRoom $) {
    ...
    public static Builder builder(VirtualWaitingRoom defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualWaitingRoom();
        }

        public Builder(VirtualWaitingRoom defaults) {
            $ = new VirtualWaitingRoom(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualWaitingRoom build() {
            return $;
        }
    }
