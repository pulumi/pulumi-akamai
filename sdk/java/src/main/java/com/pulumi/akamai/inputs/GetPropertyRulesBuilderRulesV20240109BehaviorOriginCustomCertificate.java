...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateSubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateSubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateSubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate(GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificateSubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorOriginCustomCertificate build() {
            return $;
        }
    }
