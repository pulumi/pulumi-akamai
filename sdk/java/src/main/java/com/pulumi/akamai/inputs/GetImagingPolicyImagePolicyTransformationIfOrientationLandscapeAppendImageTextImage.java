...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImage build() {
            return $;
        }
    }
