...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanTrimArgs build() {
            return $;
        }
    }
