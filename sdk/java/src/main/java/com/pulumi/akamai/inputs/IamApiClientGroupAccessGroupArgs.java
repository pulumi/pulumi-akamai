...
import com.pulumi.akamai.inputs.IamApiClientGroupAccessGroupSubGroupArgs;
...
public final class IamApiClientGroupAccessGroupArgs extends com.pulumi.resources.ResourceArgs {

    public static final IamApiClientGroupAccessGroupArgs Empty = new IamApiClientGroupAccessGroupArgs();
    ...
    private IamApiClientGroupAccessGroupArgs() {}

    private IamApiClientGroupAccessGroupArgs(IamApiClientGroupAccessGroupArgs $) {
    ...
    public static Builder builder(IamApiClientGroupAccessGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IamApiClientGroupAccessGroupArgs();
        }

        public Builder(IamApiClientGroupAccessGroupArgs defaults) {
            $ = new IamApiClientGroupAccessGroupArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IamApiClientGroupAccessGroupArgs build() {
            if ($.groupId == null) {
                throw new MissingRequiredPropertyException("IamApiClientGroupAccessGroupArgs", "groupId");
            }
            if ($.roleId == null) {
                throw new MissingRequiredPropertyException("IamApiClientGroupAccessGroupArgs", "roleId");
            }
            return $;
        }
    }
