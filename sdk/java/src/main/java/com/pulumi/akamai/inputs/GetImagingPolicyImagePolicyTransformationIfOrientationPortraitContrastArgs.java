...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitContrastArgs build() {
            return $;
        }
    }
