...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppendImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppendImage image;

    public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppendImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppendImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationAppend build() {
