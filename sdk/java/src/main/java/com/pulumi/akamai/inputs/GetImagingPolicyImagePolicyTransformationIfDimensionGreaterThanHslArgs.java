...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHslArgs build() {
            return $;
        }
    }
