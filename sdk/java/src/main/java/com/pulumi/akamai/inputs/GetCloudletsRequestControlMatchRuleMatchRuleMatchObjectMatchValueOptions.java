...
public final class GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions Empty = new GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions();
    ...
    private GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions(GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions();
        }

        public Builder(GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions defaults) {
            $ = new GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValueOptions(Objects.requireNonNull(defaults));
        }
