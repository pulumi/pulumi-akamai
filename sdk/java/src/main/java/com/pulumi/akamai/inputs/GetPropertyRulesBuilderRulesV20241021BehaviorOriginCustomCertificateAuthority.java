...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthorityIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthoritySubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthorityIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthoritySubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority(GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorOriginCustomCertificateAuthority build() {
            return $;
        }
    }
