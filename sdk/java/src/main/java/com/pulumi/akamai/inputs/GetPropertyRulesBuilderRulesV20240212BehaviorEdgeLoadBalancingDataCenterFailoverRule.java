...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule();
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRule(Objects.requireNonNull(defaults));
        }
