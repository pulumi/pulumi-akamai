...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCropArgs build() {
            return $;
        }
    }
