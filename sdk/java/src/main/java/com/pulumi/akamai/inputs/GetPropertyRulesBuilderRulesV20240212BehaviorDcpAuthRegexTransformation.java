...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation(GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorDcpAuthRegexTransformation build() {
            return $;
        }
    }
