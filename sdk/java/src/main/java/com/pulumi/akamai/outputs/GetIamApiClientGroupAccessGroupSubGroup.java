...
@CustomType
public final class GetIamApiClientGroupAccessGroupSubGroup {
    /**
    ...
    private GetIamApiClientGroupAccessGroupSubGroup() {}
    /**
     * @return Unique identifier for each group.
     * 
     */
    ...
    public static Builder builder(GetIamApiClientGroupAccessGroupSubGroup defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetIamApiClientGroupAccessGroupSubGroup> subGroups;
        public Builder() {}
        public Builder(GetIamApiClientGroupAccessGroupSubGroup defaults) {
        ...
        public Builder groupId(Integer groupId) {
            if (groupId == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "groupId");
            }
        ...
        public Builder groupName(String groupName) {
            if (groupName == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "groupName");
            }
        ...
        public Builder isBlocked(Boolean isBlocked) {
            if (isBlocked == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "isBlocked");
            }
        ...
        public Builder parentGroupId(Integer parentGroupId) {
            if (parentGroupId == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "parentGroupId");
            }
        ...
        public Builder roleDescription(String roleDescription) {
            if (roleDescription == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "roleDescription");
            }
        ...
        public Builder roleId(Integer roleId) {
            if (roleId == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "roleId");
            }
            this.roleId = roleId;
            return this;
        }
        ...
        public Builder roleName(String roleName) {
            if (roleName == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "roleName");
            }
        ...
        public Builder subGroups(List<GetIamApiClientGroupAccessGroupSubGroup> subGroups) {
            if (subGroups == null) {
              throw new MissingRequiredPropertyException("GetIamApiClientGroupAccessGroupSubGroup", "subGroups");
            }
        ...
        public GetIamApiClientGroupAccessGroupSubGroup build() {
            final var _resultValue = new GetIamApiClientGroupAccessGroupSubGroup();
