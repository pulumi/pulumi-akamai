...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualResizeArgs build() {
            return $;
        }
    }
