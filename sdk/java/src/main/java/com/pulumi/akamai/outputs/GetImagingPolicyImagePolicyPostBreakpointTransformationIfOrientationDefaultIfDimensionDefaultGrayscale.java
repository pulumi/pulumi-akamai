...
@CustomType
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationDefaultIfDimensionDefaultGrayscale {
    ...
    public static final class Builder {
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationDefaultIfDimensionDefaultGrayscale build() {
            final var o = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationDefaultIfDimensionDefaultGrayscale();
            o.type = type;
            o.typeVar = typeVar;
            return o;
        }
