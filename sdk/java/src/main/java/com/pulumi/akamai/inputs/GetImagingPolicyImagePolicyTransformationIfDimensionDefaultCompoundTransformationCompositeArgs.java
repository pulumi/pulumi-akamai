...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationCompositeArgs build() {
