...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImage build() {
            return $;
        }
    }
