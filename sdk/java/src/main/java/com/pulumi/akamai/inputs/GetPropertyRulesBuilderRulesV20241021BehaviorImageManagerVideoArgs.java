...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginalArgs>> cpCodeOriginal() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginalArgs cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed) {
         ...
         * 
         */
        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoArgs build() {
            return $;
        }
    }
