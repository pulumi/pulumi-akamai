...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorEdgeRedirectorArgs build() {
            return $;
        }
    }
