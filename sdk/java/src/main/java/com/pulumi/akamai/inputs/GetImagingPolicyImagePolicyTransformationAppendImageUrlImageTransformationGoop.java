...
public final class GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop Empty = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoop build() {
            return $;
        }
    }
