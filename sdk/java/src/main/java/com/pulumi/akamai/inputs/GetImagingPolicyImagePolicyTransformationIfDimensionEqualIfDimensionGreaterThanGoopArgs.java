...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanGoopArgs build() {
            return $;
        }
    }
