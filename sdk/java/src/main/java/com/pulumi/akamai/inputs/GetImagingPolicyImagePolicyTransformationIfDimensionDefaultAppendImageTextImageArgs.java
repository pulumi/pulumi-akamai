...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageArgs build() {
            return $;
        }
    }
