...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoop build() {
            return $;
        }
    }
