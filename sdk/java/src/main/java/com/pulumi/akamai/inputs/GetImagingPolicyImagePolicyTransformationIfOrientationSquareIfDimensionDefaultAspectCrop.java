...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultAspectCrop build() {
            return $;
        }
    }
