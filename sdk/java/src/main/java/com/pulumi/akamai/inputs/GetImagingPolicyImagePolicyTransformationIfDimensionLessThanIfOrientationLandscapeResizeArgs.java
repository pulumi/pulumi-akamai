...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeResizeArgs build() {
            return $;
        }
    }
