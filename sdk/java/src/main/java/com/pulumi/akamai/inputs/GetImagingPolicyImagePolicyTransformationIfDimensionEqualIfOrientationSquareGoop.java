...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareGoop build() {
            return $;
        }
    }
