...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationUnsharpMaskArgs build() {
            return $;
        }
    }
