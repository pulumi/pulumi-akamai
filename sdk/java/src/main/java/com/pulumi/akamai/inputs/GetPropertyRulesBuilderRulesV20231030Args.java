...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030CriterionArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030CustomOverrideArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030VariableArgs;
...
public final class GetPropertyRulesBuilderRulesV20231030Args extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20231030Args Empty = new GetPropertyRulesBuilderRulesV20231030Args();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20231030BehaviorArgs>> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20231030BehaviorArgs>>> behaviors() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20231030CriterionArgs>> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20231030CriterionArgs>>> criterions() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20231030CustomOverrideArgs> customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20231030CustomOverrideArgs>> customOverride() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20231030VariableArgs>> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20231030VariableArgs>>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20231030Args() {}

    private GetPropertyRulesBuilderRulesV20231030Args(GetPropertyRulesBuilderRulesV20231030Args $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030Args();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030Args defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable Output<List<GetPropertyRulesBuilderRulesV20231030BehaviorArgs>> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(List<GetPropertyRulesBuilderRulesV20231030BehaviorArgs> behaviors) {
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20231030BehaviorArgs... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable Output<List<GetPropertyRulesBuilderRulesV20231030CriterionArgs>> criterions) {
         ...
         * 
         */
        public Builder criterions(List<GetPropertyRulesBuilderRulesV20231030CriterionArgs> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20231030CriterionArgs... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable Output<GetPropertyRulesBuilderRulesV20231030CustomOverrideArgs> customOverride) {
         ...
         * 
         */
        public Builder customOverride(GetPropertyRulesBuilderRulesV20231030CustomOverrideArgs customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable Output<List<GetPropertyRulesBuilderRulesV20231030VariableArgs>> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(List<GetPropertyRulesBuilderRulesV20231030VariableArgs> variables) {
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20231030VariableArgs... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20231030Args build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20231030Args", "name");
            }
            return $;
        }
    }
