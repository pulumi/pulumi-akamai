...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationGoopArgs build() {
            return $;
        }
    }
