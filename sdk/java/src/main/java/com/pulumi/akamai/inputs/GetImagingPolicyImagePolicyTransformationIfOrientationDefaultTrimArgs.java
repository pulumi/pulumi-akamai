...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultTrimArgs build() {
            return $;
        }
    }
