...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerVideo build() {
            return $;
        }
    }
