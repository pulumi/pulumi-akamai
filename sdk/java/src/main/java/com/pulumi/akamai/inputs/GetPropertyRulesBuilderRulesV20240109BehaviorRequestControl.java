...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorage netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorage> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorRequestControlNetStorage netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorRequestControl build() {
            return $;
        }
    }
