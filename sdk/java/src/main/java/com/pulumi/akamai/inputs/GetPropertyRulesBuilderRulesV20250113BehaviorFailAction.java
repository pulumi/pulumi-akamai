...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorFailActionCpCode;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorFailActionNetStorageHostname;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorFailAction extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorFailAction Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorFailAction();
     ...
     */
    @Import(name="cpCode")
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFailActionCpCode cpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorFailActionCpCode> cpCode() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFailActionNetStorageHostname netStorageHostname;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorFailActionNetStorageHostname> netStorageHostname() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorFailAction() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorFailAction(GetPropertyRulesBuilderRulesV20250113BehaviorFailAction $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorFailAction defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorFailAction();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorFailAction defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorFailAction(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCode(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFailActionCpCode cpCode) {
            $.cpCode = cpCode;
            return this;
        }
         ...
         * 
         */
        public Builder netStorageHostname(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFailActionNetStorageHostname netStorageHostname) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorFailAction build() {
            return $;
        }
    }
