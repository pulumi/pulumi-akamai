...
public final class SubCustomerArgs extends com.pulumi.resources.ResourceArgs {

    public static final SubCustomerArgs Empty = new SubCustomerArgs();
    ...
    private SubCustomerArgs() {}

    private SubCustomerArgs(SubCustomerArgs $) {
    ...
    public static Builder builder(SubCustomerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SubCustomerArgs defaults) {
            $ = new SubCustomerArgs(Objects.requireNonNull(defaults));
        }
