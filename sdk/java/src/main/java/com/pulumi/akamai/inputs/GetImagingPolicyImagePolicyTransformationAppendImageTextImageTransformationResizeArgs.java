...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationResizeArgs build() {
            return $;
        }
    }
