...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(List<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterArgs build() {
            return $;
        }
    }
