...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualRelativeCropArgs build() {
            return $;
        }
    }
