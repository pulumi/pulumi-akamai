...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop(GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationRelativeCrop build() {
            return $;
        }
    }
