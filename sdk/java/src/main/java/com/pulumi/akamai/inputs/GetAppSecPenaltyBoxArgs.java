...
public final class GetAppSecPenaltyBoxArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppSecPenaltyBoxArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("GetAppSecPenaltyBoxArgs", "configId");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("GetAppSecPenaltyBoxArgs", "securityPolicyId");
            }
            return $;
        }
    }
