...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCropArgs build() {
            return $;
        }
    }
