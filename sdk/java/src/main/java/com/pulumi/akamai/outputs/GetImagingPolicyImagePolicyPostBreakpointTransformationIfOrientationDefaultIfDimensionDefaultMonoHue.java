...
@CustomType
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationDefaultIfDimensionDefaultMonoHue {
    ...
    public static final class Builder {
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationDefaultIfDimensionDefaultMonoHue build() {
            final var o = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationDefaultIfDimensionDefaultMonoHue();
            o.hue = hue;
            o.hueVar = hueVar;
            return o;
        }
