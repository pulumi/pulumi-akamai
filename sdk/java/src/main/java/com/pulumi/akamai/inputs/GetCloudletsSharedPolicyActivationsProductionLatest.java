...
public final class GetCloudletsSharedPolicyActivationsProductionLatest extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsSharedPolicyActivationsProductionLatest Empty = new GetCloudletsSharedPolicyActivationsProductionLatest();
    ...
    private GetCloudletsSharedPolicyActivationsProductionLatest() {}

    private GetCloudletsSharedPolicyActivationsProductionLatest(GetCloudletsSharedPolicyActivationsProductionLatest $) {
    ...
    public static Builder builder(GetCloudletsSharedPolicyActivationsProductionLatest defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsSharedPolicyActivationsProductionLatest();
        }

        public Builder(GetCloudletsSharedPolicyActivationsProductionLatest defaults) {
            $ = new GetCloudletsSharedPolicyActivationsProductionLatest(Objects.requireNonNull(defaults));
        }
        ...
        public GetCloudletsSharedPolicyActivationsProductionLatest build() {
            if ($.activationId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "activationId");
            }
            if ($.createdBy == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "createdBy");
            }
            if ($.createdDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "createdDate");
            }
            if ($.finishDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "finishDate");
            }
            if ($.network == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "network");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "operation");
            }
            if ($.policyId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "policyId");
            }
            if ($.policyVersion == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "policyVersion");
            }
            if ($.policyVersionDeleted == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "policyVersionDeleted");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatest", "status");
            }
            return $;
        }
    }
