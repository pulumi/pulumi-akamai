...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationChromaKeyArgs build() {
            return $;
        }
    }
