...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs();
     ...
     * 
     */
    @Import(name="enableTokenInQueryString")
    private @Nullable Output<Boolean> enableTokenInQueryString;

    /**
     * @return When enabled, in the DASH media encryption variant, passes tokens in query strings, as an alternative to cookies.
     * 
     */
    public Optional<Output<Boolean>> enableTokenInQueryString() {
     ...
     * 
     */
    @Import(name="tokenAuthDashTitle")
    private @Nullable Output<String> tokenAuthDashTitle;

    /**
     * @return This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
     * 
     */
    public Optional<Output<String>> tokenAuthDashTitle() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs(GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs $) {
        this.acl = $.acl;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param enableTokenInQueryString When enabled, in the DASH media encryption variant, passes tokens in query strings, as an alternative to cookies.
         * 
         * @return builder
         * 
         */
        public Builder enableTokenInQueryString(@Nullable Output<Boolean> enableTokenInQueryString) {
            $.enableTokenInQueryString = enableTokenInQueryString;
            return this;
        }
         ...
         * 
         */
        public Builder enableTokenInQueryString(Boolean enableTokenInQueryString) {
            return enableTokenInQueryString(Output.of(enableTokenInQueryString));
        }
        ...
        /**
         * @param tokenAuthDashTitle This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
         * 
         * @return builder
         * 
         */
        public Builder tokenAuthDashTitle(@Nullable Output<String> tokenAuthDashTitle) {
            $.tokenAuthDashTitle = tokenAuthDashTitle;
            return this;
        }
         ...
         * 
         */
        public Builder tokenAuthDashTitle(String tokenAuthDashTitle) {
            return tokenAuthDashTitle(Output.of(tokenAuthDashTitle));
        }
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorSegmentedContentProtectionArgs build() {
            return $;
        }
    }
