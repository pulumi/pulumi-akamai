...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationAppendArgs build() {
