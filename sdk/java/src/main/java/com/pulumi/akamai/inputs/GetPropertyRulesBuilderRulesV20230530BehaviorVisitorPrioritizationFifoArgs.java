...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs(GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationFifoArgs build() {
            return $;
        }
    }
