...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualHslArgs build() {
            return $;
        }
    }
