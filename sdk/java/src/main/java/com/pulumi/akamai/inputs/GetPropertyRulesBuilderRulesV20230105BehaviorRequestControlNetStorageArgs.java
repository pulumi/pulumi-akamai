...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs(GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorRequestControlNetStorageArgs build() {
            return $;
        }
    }
