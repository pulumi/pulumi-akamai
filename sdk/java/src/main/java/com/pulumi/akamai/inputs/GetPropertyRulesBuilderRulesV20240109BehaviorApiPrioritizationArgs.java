...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorageArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCodeArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorageArgs> netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorageArgs>> netStorage() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCodeArgs>> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorageArgs netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode) {
         ...
         * 
         */
        public Builder throttledCpCode(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCodeArgs throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationArgs build() {
            return $;
        }
    }
