...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginalArgs>> cpCodeOriginal() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginalArgs cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed) {
         ...
         * 
         */
        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerArgs build() {
            return $;
        }
    }
