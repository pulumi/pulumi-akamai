...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationRemoveColorArgs build() {
            return $;
        }
    }
