...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanRelativeCropArgs build() {
            return $;
        }
    }
