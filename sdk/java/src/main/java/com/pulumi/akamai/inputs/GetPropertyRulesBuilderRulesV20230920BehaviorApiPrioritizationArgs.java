...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationNetStorageArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationThrottledCpCodeArgs;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationNetStorageArgs> netStorage;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationNetStorageArgs>> netStorage() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationThrottledCpCodeArgs>> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs(GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy) {
            $.cloudletPolicy = cloudletPolicy;
            return this;
        }

        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationCloudletPolicyArgs cloudletPolicy) {
        ...
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationNetStorageArgs> netStorage) {
            $.netStorage = netStorage;
            return this;
        }

        public Builder netStorage(GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationNetStorageArgs netStorage) {
        ...
        public Builder throttledCpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode) {
            $.throttledCpCode = throttledCpCode;
            return this;
        }

        public Builder throttledCpCode(GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationThrottledCpCodeArgs throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorApiPrioritizationArgs build() {
            return $;
        }
    }
