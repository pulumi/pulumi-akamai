...
public final class GetGtmDomainResourceResourceInstance extends com.pulumi.resources.InvokeArgs {

    public static final GetGtmDomainResourceResourceInstance Empty = new GetGtmDomainResourceResourceInstance();
    ...
    private GetGtmDomainResourceResourceInstance() {}

    private GetGtmDomainResourceResourceInstance(GetGtmDomainResourceResourceInstance $) {
    ...
    public static Builder builder(GetGtmDomainResourceResourceInstance defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGtmDomainResourceResourceInstance();
        }

        public Builder(GetGtmDomainResourceResourceInstance defaults) {
            $ = new GetGtmDomainResourceResourceInstance(Objects.requireNonNull(defaults));
        }
        ...
        public GetGtmDomainResourceResourceInstance build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstance", "datacenterId");
            }
            if ($.loadObject == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstance", "loadObject");
            }
            if ($.loadObjectPort == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstance", "loadObjectPort");
            }
            if ($.loadServers == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstance", "loadServers");
            }
            if ($.useDefaultLoadObject == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstance", "useDefaultLoadObject");
            }
            return $;
        }
    }
