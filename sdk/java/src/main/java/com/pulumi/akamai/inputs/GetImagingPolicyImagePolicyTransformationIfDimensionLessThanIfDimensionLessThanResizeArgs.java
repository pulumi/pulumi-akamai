...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanResizeArgs build() {
            return $;
        }
    }
