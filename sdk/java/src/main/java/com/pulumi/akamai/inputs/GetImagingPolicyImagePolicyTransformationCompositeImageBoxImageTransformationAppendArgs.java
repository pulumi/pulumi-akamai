...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationAppendArgs build() {
