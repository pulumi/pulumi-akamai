...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultGoop build() {
            return $;
        }
    }
