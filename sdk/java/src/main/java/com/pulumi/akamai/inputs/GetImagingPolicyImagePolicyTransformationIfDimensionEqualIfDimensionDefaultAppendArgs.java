...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultAppendArgs build() {
