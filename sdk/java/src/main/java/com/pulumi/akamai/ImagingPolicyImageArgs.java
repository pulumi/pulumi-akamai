...
public final class ImagingPolicyImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final ImagingPolicyImageArgs Empty = new ImagingPolicyImageArgs();
    ...
    private ImagingPolicyImageArgs() {}

    private ImagingPolicyImageArgs(ImagingPolicyImageArgs $) {
    ...
    public static Builder builder(ImagingPolicyImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ImagingPolicyImageArgs defaults) {
            $ = new ImagingPolicyImageArgs(Objects.requireNonNull(defaults));
        }
