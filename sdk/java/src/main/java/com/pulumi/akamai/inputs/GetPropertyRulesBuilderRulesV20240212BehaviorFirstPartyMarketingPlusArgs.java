...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingPlusArgs build() {
            return $;
        }
    }
