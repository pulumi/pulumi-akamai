...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusArgs build() {
            return $;
        }
    }
