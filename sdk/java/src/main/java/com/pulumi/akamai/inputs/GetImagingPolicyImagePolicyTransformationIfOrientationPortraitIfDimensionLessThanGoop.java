...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionLessThanGoop build() {
            return $;
        }
    }
