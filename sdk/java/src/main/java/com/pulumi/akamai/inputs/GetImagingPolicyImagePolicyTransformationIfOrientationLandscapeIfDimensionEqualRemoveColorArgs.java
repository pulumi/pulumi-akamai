...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionEqualRemoveColorArgs build() {
            return $;
        }
    }
