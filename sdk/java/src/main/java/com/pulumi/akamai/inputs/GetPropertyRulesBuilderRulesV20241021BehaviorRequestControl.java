...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlNetStorage netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlNetStorage> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl(GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorRequestControlNetStorage netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorRequestControl build() {
            return $;
        }
    }
