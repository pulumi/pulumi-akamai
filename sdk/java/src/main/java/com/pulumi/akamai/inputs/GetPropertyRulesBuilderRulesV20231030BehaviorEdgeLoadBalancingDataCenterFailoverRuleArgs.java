...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs();
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs build() {
            return $;
        }
    }
