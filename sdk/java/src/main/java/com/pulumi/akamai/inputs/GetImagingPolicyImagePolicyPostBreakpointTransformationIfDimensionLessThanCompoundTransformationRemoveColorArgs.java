...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompoundTransformationRemoveColorArgs build() {
            return $;
        }
    }
