...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompositeImageTextImage build() {
            return $;
        }
    }
