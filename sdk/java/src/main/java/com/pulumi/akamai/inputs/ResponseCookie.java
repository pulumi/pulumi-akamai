...
public final class ResponseCookie extends com.pulumi.resources.InvokeArgs {

    public static final ResponseCookie Empty = new ResponseCookie();
    ...
    public static Builder builder(ResponseCookie defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ResponseCookie defaults) {
            $ = new ResponseCookie(Objects.requireNonNull(defaults));
        }
