...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationSquareRelativeCrop build() {
            return $;
        }
    }
