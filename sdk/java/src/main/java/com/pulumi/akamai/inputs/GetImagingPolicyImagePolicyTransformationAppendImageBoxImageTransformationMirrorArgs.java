...
public final class GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationMirrorArgs build() {
            return $;
        }
    }
