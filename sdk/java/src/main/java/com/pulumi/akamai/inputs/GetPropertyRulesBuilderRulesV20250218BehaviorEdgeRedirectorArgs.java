...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs(GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorArgs build() {
            return $;
        }
    }
