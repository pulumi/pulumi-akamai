...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCropArgs build() {
            return $;
        }
    }
