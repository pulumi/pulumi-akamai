...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationPortraitResizeArgs build() {
            return $;
        }
    }
