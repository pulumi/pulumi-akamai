...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationHsl build() {
            return $;
        }
    }
