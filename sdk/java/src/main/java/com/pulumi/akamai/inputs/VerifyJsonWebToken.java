...
public final class VerifyJsonWebToken extends com.pulumi.resources.InvokeArgs {

    public static final VerifyJsonWebToken Empty = new VerifyJsonWebToken();
    ...
    private VerifyJsonWebToken() {}

    private VerifyJsonWebToken(VerifyJsonWebToken $) {
    ...
    public static Builder builder(VerifyJsonWebToken defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VerifyJsonWebToken();
        }

        public Builder(VerifyJsonWebToken defaults) {
            $ = new VerifyJsonWebToken(Objects.requireNonNull(defaults));
        }
        ...
        public VerifyJsonWebToken build() {
            return $;
        }
    }
