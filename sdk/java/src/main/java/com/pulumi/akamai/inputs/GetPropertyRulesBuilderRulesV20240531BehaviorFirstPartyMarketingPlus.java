...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingPlus build() {
            return $;
        }
    }
