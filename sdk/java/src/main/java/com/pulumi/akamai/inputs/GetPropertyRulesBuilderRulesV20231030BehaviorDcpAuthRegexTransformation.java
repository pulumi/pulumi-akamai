...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation(GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthRegexTransformation build() {
            return $;
        }
    }
