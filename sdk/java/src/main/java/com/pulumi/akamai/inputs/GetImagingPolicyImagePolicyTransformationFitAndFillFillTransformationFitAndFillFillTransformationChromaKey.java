...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationFitAndFillFillTransformationChromaKey build() {
            return $;
        }
    }
