...
public final class MediaOriginFailoverArgs extends com.pulumi.resources.ResourceArgs {

    public static final MediaOriginFailoverArgs Empty = new MediaOriginFailoverArgs();
    ...
    private MediaOriginFailoverArgs() {}

    private MediaOriginFailoverArgs(MediaOriginFailoverArgs $) {
    ...
    public static Builder builder(MediaOriginFailoverArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MediaOriginFailoverArgs();
        }

        public Builder(MediaOriginFailoverArgs defaults) {
            $ = new MediaOriginFailoverArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MediaOriginFailoverArgs build() {
            return $;
        }
    }
