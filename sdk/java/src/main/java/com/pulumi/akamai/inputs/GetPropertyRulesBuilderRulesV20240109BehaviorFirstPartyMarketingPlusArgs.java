...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingPlusArgs build() {
            return $;
        }
    }
