...
public final class UidConfiguration extends com.pulumi.resources.InvokeArgs {

    public static final UidConfiguration Empty = new UidConfiguration();
    ...
    public static Builder builder(UidConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UidConfiguration();
        }

        public Builder(UidConfiguration defaults) {
            $ = new UidConfiguration(Objects.requireNonNull(defaults));
        }
