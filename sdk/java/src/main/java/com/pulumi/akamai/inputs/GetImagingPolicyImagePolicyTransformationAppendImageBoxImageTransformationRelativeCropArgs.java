...
public final class GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationRelativeCropArgs build() {
            return $;
        }
    }
