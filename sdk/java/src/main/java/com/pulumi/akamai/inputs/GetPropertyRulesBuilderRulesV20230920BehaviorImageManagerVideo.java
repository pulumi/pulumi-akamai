...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal;

    public Optional<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeOriginal> cpCodeOriginal() {
        return Optional.ofNullable(this.cpCodeOriginal);
    }

    @Import(name="cpCodeTransformed")
    private @Nullable GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed;

    public Optional<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo() {}

    private GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal) {
            $.cpCodeOriginal = cpCodeOriginal;
            return this;
        }

        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerVideo build() {
            return $;
        }
    }
