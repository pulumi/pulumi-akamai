...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanCompositeArgs build() {
