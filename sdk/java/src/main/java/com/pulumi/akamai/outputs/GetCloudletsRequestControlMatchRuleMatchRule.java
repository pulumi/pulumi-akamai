...
public final class GetCloudletsRequestControlMatchRuleMatchRule {
     ...
     * 
     */
    private final String allowDeny;
    /**
     ...
     * 
     */
    private final @Nullable List<GetCloudletsRequestControlMatchRuleMatchRuleMatch> matches;
    /**
    ...
    private GetCloudletsRequestControlMatchRuleMatchRule(
        @CustomType.Parameter("allowDeny") String allowDeny,
        @CustomType.Parameter("disabled") @Nullable Boolean disabled,
        @CustomType.Parameter("end") @Nullable Integer end,
        @CustomType.Parameter("matches") @Nullable List<GetCloudletsRequestControlMatchRuleMatchRuleMatch> matches,
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            ...
            return new GetCloudletsRequestControlMatchRuleMatchRule(allowDeny, disabled, end, matches, matchesAlways, name, start, type);
        }
    }
}
