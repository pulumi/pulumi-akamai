...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanChromaKey build() {
            return $;
        }
    }
