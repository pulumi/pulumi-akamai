...
public final class GetPropertyRulesTemplateVariableArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesTemplateVariableArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesTemplateVariableArgs", "name");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesTemplateVariableArgs", "value");
            }
            return $;
        }
    }
