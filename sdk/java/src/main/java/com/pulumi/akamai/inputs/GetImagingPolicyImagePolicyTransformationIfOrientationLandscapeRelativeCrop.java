...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeRelativeCrop build() {
            return $;
        }
    }
