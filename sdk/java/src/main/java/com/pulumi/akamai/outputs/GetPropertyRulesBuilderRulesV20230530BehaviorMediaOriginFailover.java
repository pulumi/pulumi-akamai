...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorMediaOriginFailover {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorMediaOriginFailover build() {
            final var o = new GetPropertyRulesBuilderRulesV20230530BehaviorMediaOriginFailover();
            o.cacheErrorResponse = cacheErrorResponse;
            o.cacheWindow = cacheWindow;
            o.clientResponseCode = clientResponseCode;
            o.detectObjectUnavailable = detectObjectUnavailable;
            o.detectObjectUnavailableTitle = detectObjectUnavailableTitle;
            o.detectOriginUnavailable = detectOriginUnavailable;
            o.detectOriginUnavailableTitle = detectOriginUnavailableTitle;
            o.detectOriginUnresponsive = detectOriginUnresponsive;
            o.detectOriginUnresponsiveTitle = detectOriginUnresponsiveTitle;
            o.locked = locked;
            o.objectUnavailableAlternateHost = objectUnavailableAlternateHost;
            o.objectUnavailableBackupHost = objectUnavailableBackupHost;
            o.objectUnavailableBlacklistOriginIp = objectUnavailableBlacklistOriginIp;
            o.objectUnavailableBlacklistWindow = objectUnavailableBlacklistWindow;
            o.objectUnavailableChangeProtocol = objectUnavailableChangeProtocol;
            o.objectUnavailableDetectionLevel = objectUnavailableDetectionLevel;
            o.objectUnavailableIncludeQueryString = objectUnavailableIncludeQueryString;
            o.objectUnavailableModifiedPath = objectUnavailableModifiedPath;
            o.objectUnavailableModifyRequestPath = objectUnavailableModifyRequestPath;
            o.objectUnavailableProtocol = objectUnavailableProtocol;
            o.objectUnavailableRecovery = objectUnavailableRecovery;
            o.objectUnavailableRedirectMethod = objectUnavailableRedirectMethod;
            o.objectUnavailableResponseCodes = objectUnavailableResponseCodes;
            o.objectUnavailableRetryLimit = objectUnavailableRetryLimit;
            o.originUnavailableAlternateHost = originUnavailableAlternateHost;
            o.originUnavailableBackupHost = originUnavailableBackupHost;
            o.originUnavailableBlacklistOriginIp = originUnavailableBlacklistOriginIp;
            o.originUnavailableBlacklistWindow = originUnavailableBlacklistWindow;
            o.originUnavailableChangeProtocol = originUnavailableChangeProtocol;
            o.originUnavailableDetectionLevel = originUnavailableDetectionLevel;
            o.originUnavailableIncludeQueryString = originUnavailableIncludeQueryString;
            o.originUnavailableModifiedPath = originUnavailableModifiedPath;
            o.originUnavailableModifyRequestPath = originUnavailableModifyRequestPath;
            o.originUnavailableProtocol = originUnavailableProtocol;
            o.originUnavailableRecovery = originUnavailableRecovery;
            o.originUnavailableRedirectMethod = originUnavailableRedirectMethod;
            o.originUnavailableResponseCodes = originUnavailableResponseCodes;
            o.originUnavailableRetryLimit = originUnavailableRetryLimit;
            o.originUnresponsiveAlternateHost = originUnresponsiveAlternateHost;
            o.originUnresponsiveBackupHost = originUnresponsiveBackupHost;
            o.originUnresponsiveBlacklistOriginIp = originUnresponsiveBlacklistOriginIp;
            o.originUnresponsiveBlacklistWindow = originUnresponsiveBlacklistWindow;
            o.originUnresponsiveChangeProtocol = originUnresponsiveChangeProtocol;
            o.originUnresponsiveDetectionLevel = originUnresponsiveDetectionLevel;
            o.originUnresponsiveIncludeQueryString = originUnresponsiveIncludeQueryString;
            o.originUnresponsiveModifiedPath = originUnresponsiveModifiedPath;
            o.originUnresponsiveModifyRequestPath = originUnresponsiveModifyRequestPath;
            o.originUnresponsiveProtocol = originUnresponsiveProtocol;
            o.originUnresponsiveRecovery = originUnresponsiveRecovery;
            o.originUnresponsiveRedirectMethod = originUnresponsiveRedirectMethod;
            o.originUnresponsiveRetryLimit = originUnresponsiveRetryLimit;
