...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingArgs build() {
            return $;
        }
    }
