...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultGoop build() {
            return $;
        }
    }
