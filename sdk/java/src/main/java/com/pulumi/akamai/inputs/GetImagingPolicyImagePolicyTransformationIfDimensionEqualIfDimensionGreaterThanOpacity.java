...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionGreaterThanOpacity(Objects.requireNonNull(defaults));
        }
