...
public final class RandomSeekArgs extends com.pulumi.resources.ResourceArgs {

    public static final RandomSeekArgs Empty = new RandomSeekArgs();
    ...
    private RandomSeekArgs() {}

    private RandomSeekArgs(RandomSeekArgs $) {
        this.flv = $.flv;
        this.locked = $.locked;
    ...
    public static Builder builder(RandomSeekArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RandomSeekArgs defaults) {
            $ = new RandomSeekArgs(Objects.requireNonNull(defaults));
        }
