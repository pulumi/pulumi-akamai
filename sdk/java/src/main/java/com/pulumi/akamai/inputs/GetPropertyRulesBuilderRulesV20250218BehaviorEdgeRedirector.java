...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector(GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorEdgeRedirector build() {
            return $;
        }
    }
