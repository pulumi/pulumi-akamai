...
public final class ProviderGtmArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProviderGtmArgs Empty = new ProviderGtmArgs();
    ...
    private ProviderGtmArgs() {}

    private ProviderGtmArgs(ProviderGtmArgs $) {
    ...
    public static Builder builder(ProviderGtmArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ProviderGtmArgs defaults) {
            $ = new ProviderGtmArgs(Objects.requireNonNull(defaults));
        }
