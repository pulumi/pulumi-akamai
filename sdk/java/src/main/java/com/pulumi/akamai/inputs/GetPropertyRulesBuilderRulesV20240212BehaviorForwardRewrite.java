...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewriteCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewriteCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewriteCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite(GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewriteCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorForwardRewrite build() {
            return $;
        }
    }
