...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationHslArgs build() {
            return $;
        }
    }
