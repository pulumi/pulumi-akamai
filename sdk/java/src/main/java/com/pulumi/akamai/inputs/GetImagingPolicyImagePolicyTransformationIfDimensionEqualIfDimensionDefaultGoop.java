...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultGoop build() {
            return $;
        }
    }
