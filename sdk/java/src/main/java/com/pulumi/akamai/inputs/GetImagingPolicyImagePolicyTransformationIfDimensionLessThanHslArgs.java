...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHslArgs build() {
            return $;
        }
    }
