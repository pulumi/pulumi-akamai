...
@CustomType
public final class PropertyActivationComplianceRecordNoncomplianceReasonEmergency {
    private @Nullable String ticketId;

    private PropertyActivationComplianceRecordNoncomplianceReasonEmergency() {}
    ...
    public static Builder builder(PropertyActivationComplianceRecordNoncomplianceReasonEmergency defaults) {
    ...
    public static final class Builder {
        private @Nullable String ticketId;
        public Builder() {}
        public Builder(PropertyActivationComplianceRecordNoncomplianceReasonEmergency defaults) {
