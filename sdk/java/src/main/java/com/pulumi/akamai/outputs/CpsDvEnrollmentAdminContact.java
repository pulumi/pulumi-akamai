...
public final class CpsDvEnrollmentAdminContact {
    ...
    public static final class Builder {
        ...
        public Builder title(@Nullable String title) {
            ...
            return new CpsDvEnrollmentAdminContact(addressLineOne, addressLineTwo, city, countryCode, email, firstName, lastName, organization, phone, postalCode, region, title);
        }
    }
}
