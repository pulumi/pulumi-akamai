...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorImageManager extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorImageManager Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorImageManager();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorImageManager() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorImageManager(GetPropertyRulesBuilderRulesV20240109BehaviorImageManager $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorImageManager defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorImageManager();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorImageManager defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorImageManager(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorImageManager build() {
            return $;
        }
    }
