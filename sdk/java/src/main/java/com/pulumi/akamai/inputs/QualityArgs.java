...
public final class QualityArgs extends com.pulumi.resources.ResourceArgs {

    public static final QualityArgs Empty = new QualityArgs();
    ...
    private QualityArgs(QualityArgs $) {
    ...
    public static Builder builder(QualityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(QualityArgs defaults) {
            $ = new QualityArgs(Objects.requireNonNull(defaults));
        }
