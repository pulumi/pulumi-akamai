...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCrop build() {
            return $;
        }
    }
