...
public final class VisitorPrioritizationFifo extends com.pulumi.resources.InvokeArgs {

    public static final VisitorPrioritizationFifo Empty = new VisitorPrioritizationFifo();
    ...
    private VisitorPrioritizationFifo() {}

    private VisitorPrioritizationFifo(VisitorPrioritizationFifo $) {
    ...
    public static Builder builder(VisitorPrioritizationFifo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisitorPrioritizationFifo();
        }

        public Builder(VisitorPrioritizationFifo defaults) {
            $ = new VisitorPrioritizationFifo(Objects.requireNonNull(defaults));
        }
        ...
        public VisitorPrioritizationFifo build() {
            return $;
        }
    }
