...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultResizeArgs build() {
            return $;
        }
    }
