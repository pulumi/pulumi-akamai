...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorOriginNetStorageArgs;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityArgs>> customCertificateAuthorities;
     ...
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityArgs>>> customCertificateAuthorities() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateArgs>> customCertificates;

    /**
     * @return Specifies an array of certification objects. See the `verification settings in the Origin Server behavior` or contact your Akamai representative for details on this object&#39;s requirements.
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateArgs>>> customCertificates() {
     ...
     * 
     */
    @Import(name="http2Title")
    private @Nullable Output<String> http2Title;

    /**
     * @return This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
     * 
     */
    public Optional<Output<String>> http2Title() {
        return Optional.ofNullable(this.http2Title);
    }
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorOriginNetStorageArgs> netStorage;

    /**
     * @return Specifies the details of the NetStorage server.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250218BehaviorOriginNetStorageArgs>> netStorage() {
     ...
     * 
     */
    @Import(name="tlsVersionTitle")
    private @Nullable Output<String> tlsVersionTitle;

    /**
     * @return This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
     * 
     */
    public Optional<Output<String>> tlsVersionTitle() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs(GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customCertificateAuthorities(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityArgs>> customCertificateAuthorities) {
         ...
         * 
         */
        public Builder customCertificateAuthorities(List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityArgs> customCertificateAuthorities) {
         ...
         * 
         */
        public Builder customCertificateAuthorities(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityArgs... customCertificateAuthorities) {
         ...
         * 
         */
        public Builder customCertificates(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateArgs>> customCertificates) {
         ...
         * 
         */
        public Builder customCertificates(List<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateArgs> customCertificates) {
         ...
         * 
         */
        public Builder customCertificates(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateArgs... customCertificates) {
        ...
        /**
         * @param http2Title This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
         * 
         * @return builder
         * 
         */
        public Builder http2Title(@Nullable Output<String> http2Title) {
            $.http2Title = http2Title;
            return this;
        }
         ...
         * 
         */
        public Builder http2Title(String http2Title) {
            return http2Title(Output.of(http2Title));
        }
        ...
        /**
         * @param maxTlsVersion Specifies the maximum TLS version to use for connections to your origin server. As best practice, use `DYNAMIC` to automatically apply the latest supported version.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param minTlsVersion Specifies the minimum TLS version to use for connections to your origin server.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorOriginNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20250218BehaviorOriginNetStorageArgs netStorage) {
        ...
        /**
         * @param tlsVersionTitle This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
         * 
         * @return builder
         * 
         */
        public Builder tlsVersionTitle(@Nullable Output<String> tlsVersionTitle) {
         ...
         * 
         */
        public Builder tlsVersionTitle(String tlsVersionTitle) {
            return tlsVersionTitle(Output.of(tlsVersionTitle));
        }
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorOriginArgs build() {
            return $;
        }
    }
