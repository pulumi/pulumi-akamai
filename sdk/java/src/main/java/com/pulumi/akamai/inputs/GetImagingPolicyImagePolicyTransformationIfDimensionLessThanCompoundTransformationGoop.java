...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanCompoundTransformationGoop build() {
            return $;
        }
    }
