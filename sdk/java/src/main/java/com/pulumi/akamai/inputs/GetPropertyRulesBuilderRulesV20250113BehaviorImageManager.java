...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorImageManager extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorImageManager Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorImageManager();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorImageManager() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorImageManager(GetPropertyRulesBuilderRulesV20250113BehaviorImageManager $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorImageManager defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorImageManager();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorImageManager defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorImageManager(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorImageManagerCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorImageManager build() {
            return $;
        }
    }
