...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlNetStorage netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlNetStorage> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl(GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorRequestControlNetStorage netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorRequestControl build() {
            return $;
        }
    }
