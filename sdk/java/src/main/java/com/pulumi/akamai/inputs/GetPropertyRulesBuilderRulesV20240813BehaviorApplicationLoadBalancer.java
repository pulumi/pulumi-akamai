...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerAllDownNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerFailoverOriginMap;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage;

    /**
     * @return Specifies a NetStorage account for a static maintenance page as a fallback when no origins are available.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerAllDownNetStorage> allDownNetStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps;

    /**
     * @return Specifies a fixed set of failover mapping rules.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerFailoverOriginMap>> failoverOriginMaps() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer(GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder allDownNetStorage(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage) {
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder failoverOriginMaps(@Nullable List<GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps) {
         ...
         * 
         */
        public Builder failoverOriginMaps(GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancerFailoverOriginMap... failoverOriginMaps) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorApplicationLoadBalancer build() {
            return $;
        }
    }
