...
public final class OriginCustomCertificateIssuerRdnsArgs extends com.pulumi.resources.ResourceArgs {

    public static final OriginCustomCertificateIssuerRdnsArgs Empty = new OriginCustomCertificateIssuerRdnsArgs();
    ...
    private OriginCustomCertificateIssuerRdnsArgs() {}

    private OriginCustomCertificateIssuerRdnsArgs(OriginCustomCertificateIssuerRdnsArgs $) {
        this.c = $.c;
        this.cn = $.cn;
        this.o = $.o;
        this.ou = $.ou;
    ...
    public static Builder builder(OriginCustomCertificateIssuerRdnsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginCustomCertificateIssuerRdnsArgs();
        }

        public Builder(OriginCustomCertificateIssuerRdnsArgs defaults) {
            $ = new OriginCustomCertificateIssuerRdnsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OriginCustomCertificateIssuerRdnsArgs build() {
            return $;
        }
    }
