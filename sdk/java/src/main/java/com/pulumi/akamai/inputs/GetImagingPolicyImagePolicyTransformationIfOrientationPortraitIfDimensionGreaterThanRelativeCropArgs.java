...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanRelativeCropArgs build() {
            return $;
        }
    }
