...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImage;
...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImage image;

    public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppend build() {
