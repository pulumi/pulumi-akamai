...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateSubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateSubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateSubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate() {}

    private GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate(GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateSubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificate build() {
            return $;
        }
    }
