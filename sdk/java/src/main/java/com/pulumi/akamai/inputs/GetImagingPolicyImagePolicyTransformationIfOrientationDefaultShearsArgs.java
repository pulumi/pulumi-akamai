...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs $) {
        this.xShear = $.xShear;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultShearsArgs build() {
            return $;
        }
    }
