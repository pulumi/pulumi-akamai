...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationResizeArgs build() {
            return $;
        }
    }
