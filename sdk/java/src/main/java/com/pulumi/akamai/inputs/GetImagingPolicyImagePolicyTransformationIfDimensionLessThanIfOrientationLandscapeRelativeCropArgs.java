...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeRelativeCropArgs build() {
            return $;
        }
    }
