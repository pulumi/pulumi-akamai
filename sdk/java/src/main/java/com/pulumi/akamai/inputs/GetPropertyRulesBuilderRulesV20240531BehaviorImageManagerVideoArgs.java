...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginalArgs>> cpCodeOriginal() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginalArgs cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed) {
         ...
         * 
         */
        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoArgs build() {
            return $;
        }
    }
