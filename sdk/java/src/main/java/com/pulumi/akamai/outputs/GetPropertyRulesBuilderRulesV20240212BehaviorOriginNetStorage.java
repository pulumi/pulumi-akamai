...
@CustomType
public final class GetPropertyRulesBuilderRulesV20240212BehaviorOriginNetStorage {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorOriginNetStorage build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20240212BehaviorOriginNetStorage();
