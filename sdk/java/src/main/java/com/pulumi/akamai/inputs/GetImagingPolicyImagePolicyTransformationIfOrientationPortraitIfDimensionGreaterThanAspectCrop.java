...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfDimensionGreaterThanAspectCrop build() {
            return $;
        }
    }
