...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationHslArgs build() {
            return $;
        }
    }
