...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanAspectCropArgs build() {
            return $;
        }
    }
