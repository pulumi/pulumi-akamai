...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationChromaKeyArgs build() {
            return $;
        }
    }
