...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsvArgs build() {
            return $;
        }
    }
