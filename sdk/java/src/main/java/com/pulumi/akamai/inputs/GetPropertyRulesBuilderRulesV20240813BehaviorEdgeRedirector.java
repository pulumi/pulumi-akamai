...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirector build() {
            return $;
        }
    }
