...
public final class SureRoute extends com.pulumi.resources.InvokeArgs {

    public static final SureRoute Empty = new SureRoute();
    ...
    public static Builder builder(SureRoute defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SureRoute defaults) {
            $ = new SureRoute(Objects.requireNonNull(defaults));
        }
