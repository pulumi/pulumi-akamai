...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeHsvArgs build() {
            return $;
        }
    }
