...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationAppendImageTextImageArgs build() {
            return $;
        }
    }
