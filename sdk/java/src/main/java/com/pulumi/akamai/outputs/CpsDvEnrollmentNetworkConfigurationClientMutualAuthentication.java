...
public final class CpsDvEnrollmentNetworkConfigurationClientMutualAuthentication {
    ...
    private CpsDvEnrollmentNetworkConfigurationClientMutualAuthentication(
        @CustomType.Parameter("ocspEnabled") @Nullable Boolean ocspEnabled,
        @CustomType.Parameter("sendCaListToClient") @Nullable Boolean sendCaListToClient,
        @CustomType.Parameter("setId") @Nullable String setId) {
    ...
    public static final class Builder {
        ...
        public Builder setId(@Nullable String setId) {
            ...
            return new CpsDvEnrollmentNetworkConfigurationClientMutualAuthentication(ocspEnabled, sendCaListToClient, setId);
        }
    }
}
