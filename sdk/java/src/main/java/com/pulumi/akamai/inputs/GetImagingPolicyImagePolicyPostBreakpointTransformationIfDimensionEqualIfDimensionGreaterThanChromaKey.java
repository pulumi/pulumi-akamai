...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualIfDimensionGreaterThanChromaKey build() {
            return $;
        }
    }
