...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanTrimArgs build() {
            return $;
        }
    }
