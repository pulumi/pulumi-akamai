...
public final class RequestControlNetStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final RequestControlNetStorageArgs Empty = new RequestControlNetStorageArgs();
    ...
    private RequestControlNetStorageArgs() {}

    private RequestControlNetStorageArgs(RequestControlNetStorageArgs $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(RequestControlNetStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RequestControlNetStorageArgs();
        }

        public Builder(RequestControlNetStorageArgs defaults) {
            $ = new RequestControlNetStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RequestControlNetStorageArgs build() {
            return $;
        }
    }
