...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationGoopArgs build() {
            return $;
        }
    }
