...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompositeArgs build() {
