...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationNetStorageArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationThrottledCpCodeArgs;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationNetStorageArgs> netStorage;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationNetStorageArgs>> netStorage() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationThrottledCpCodeArgs>> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs(GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy) {
            $.cloudletPolicy = cloudletPolicy;
            return this;
        }

        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationCloudletPolicyArgs cloudletPolicy) {
        ...
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationNetStorageArgs> netStorage) {
            $.netStorage = netStorage;
            return this;
        }

        public Builder netStorage(GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationNetStorageArgs netStorage) {
        ...
        public Builder throttledCpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode) {
            $.throttledCpCode = throttledCpCode;
            return this;
        }

        public Builder throttledCpCode(GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationThrottledCpCodeArgs throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorApiPrioritizationArgs build() {
            return $;
        }
    }
