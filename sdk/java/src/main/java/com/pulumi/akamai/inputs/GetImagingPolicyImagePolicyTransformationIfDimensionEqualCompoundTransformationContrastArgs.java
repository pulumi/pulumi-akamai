...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationContrastArgs build() {
            return $;
        }
    }
