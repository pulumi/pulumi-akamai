...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlusCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlusCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus(GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorFirstPartyMarketingPlus build() {
            return $;
        }
    }
