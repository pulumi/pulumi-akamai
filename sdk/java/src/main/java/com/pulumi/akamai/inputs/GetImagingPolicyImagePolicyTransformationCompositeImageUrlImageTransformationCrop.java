...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCrop build() {
            return $;
        }
    }
