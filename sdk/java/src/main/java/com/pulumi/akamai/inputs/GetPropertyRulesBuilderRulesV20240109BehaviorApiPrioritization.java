...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCode;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorage netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorage> netStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCode throttledCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCode> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationNetStorage netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritizationThrottledCpCode throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorApiPrioritization build() {
            return $;
        }
    }
