...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationHsvArgs build() {
            return $;
        }
    }
