...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs(GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorForwardRewriteArgs build() {
            return $;
        }
    }
