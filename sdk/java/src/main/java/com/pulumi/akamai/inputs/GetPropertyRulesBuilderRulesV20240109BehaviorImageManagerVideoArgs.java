...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeOriginalArgs>> cpCodeOriginal() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs(GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeOriginalArgs> cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeOriginalArgs cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeTransformedArgs> cpCodeTransformed) {
         ...
         * 
         */
        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorImageManagerVideoArgs build() {
            return $;
        }
    }
