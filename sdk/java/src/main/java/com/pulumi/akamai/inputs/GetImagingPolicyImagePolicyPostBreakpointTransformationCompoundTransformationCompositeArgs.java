...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationCompoundTransformationCompositeArgs build() {
