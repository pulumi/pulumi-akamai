...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualRemoveColor build() {
            return $;
        }
    }
