...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorArgs build() {
            return $;
        }
    }
