...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationCrop build() {
            return $;
        }
    }
