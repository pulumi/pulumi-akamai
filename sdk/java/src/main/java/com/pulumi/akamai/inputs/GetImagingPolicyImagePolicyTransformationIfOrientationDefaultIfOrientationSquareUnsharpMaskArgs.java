...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareUnsharpMaskArgs build() {
            return $;
        }
    }
