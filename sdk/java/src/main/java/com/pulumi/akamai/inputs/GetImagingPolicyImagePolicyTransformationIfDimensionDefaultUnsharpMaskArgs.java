...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultUnsharpMaskArgs build() {
            return $;
        }
    }
