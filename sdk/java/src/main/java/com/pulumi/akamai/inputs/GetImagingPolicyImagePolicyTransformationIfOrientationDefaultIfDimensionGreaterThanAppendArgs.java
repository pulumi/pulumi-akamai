...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendArgs build() {
