...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule();
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRule build() {
            return $;
        }
    }
