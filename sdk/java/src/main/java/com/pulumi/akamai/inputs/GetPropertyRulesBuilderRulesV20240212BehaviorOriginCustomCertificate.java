...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateSubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateSubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateSubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate(GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificateSubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorOriginCustomCertificate build() {
            return $;
        }
    }
