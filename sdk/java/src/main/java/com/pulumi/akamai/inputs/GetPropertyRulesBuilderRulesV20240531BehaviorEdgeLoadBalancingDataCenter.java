...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable List<GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenter build() {
            return $;
        }
    }
