...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoopArgs build() {
            return $;
        }
    }
