...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationMirrorArgs build() {
            return $;
        }
    }
