...
public final class ProviderPropertyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProviderPropertyArgs Empty = new ProviderPropertyArgs();
    ...
    private ProviderPropertyArgs() {}

    private ProviderPropertyArgs(ProviderPropertyArgs $) {
    ...
    public static Builder builder(ProviderPropertyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProviderPropertyArgs();
        }

        public Builder(ProviderPropertyArgs defaults) {
            $ = new ProviderPropertyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProviderPropertyArgs build() {
            return $;
        }
    }
