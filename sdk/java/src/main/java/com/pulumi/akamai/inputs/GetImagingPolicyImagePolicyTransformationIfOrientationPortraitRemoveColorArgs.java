...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRemoveColorArgs build() {
            return $;
        }
    }
