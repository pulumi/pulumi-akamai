...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlNetStorage netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlNetStorage> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl(GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorRequestControlNetStorage netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorRequestControl build() {
            return $;
        }
    }
