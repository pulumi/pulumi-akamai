...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationPortraitAppendArgs build() {
