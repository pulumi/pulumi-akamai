...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoop build() {
            return $;
        }
    }
