...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeGoop build() {
            return $;
        }
    }
