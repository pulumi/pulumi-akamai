...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs(GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteArgs build() {
            return $;
        }
    }
