...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationNetStorageArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationThrottledCpCodeArgs;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationNetStorageArgs> netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationNetStorageArgs>> netStorage() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationThrottledCpCodeArgs>> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs(GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationNetStorageArgs netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode) {
         ...
         * 
         */
        public Builder throttledCpCode(GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationThrottledCpCodeArgs throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorApiPrioritizationArgs build() {
            return $;
        }
    }
