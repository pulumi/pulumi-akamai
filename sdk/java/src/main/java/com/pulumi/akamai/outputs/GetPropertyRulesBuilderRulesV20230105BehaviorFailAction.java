...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorFailAction {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorFailAction build() {
            final var o = new GetPropertyRulesBuilderRulesV20230105BehaviorFailAction();
            o.actionType = actionType;
            o.allowFcmParentOverride = allowFcmParentOverride;
            o.cexCustomPath = cexCustomPath;
            o.cexHostname = cexHostname;
            o.cexPath = cexPath;
            o.contentCustomPath = contentCustomPath;
            o.contentHostname = contentHostname;
            o.contentPath = contentPath;
            o.cpCode = cpCode;
            o.dynamicCustomPath = dynamicCustomPath;
            o.dynamicMethod = dynamicMethod;
            o.dynamicPath = dynamicPath;
            o.enabled = enabled;
            o.locked = locked;
            o.modifyProtocol = modifyProtocol;
            o.netStorageHostname = netStorageHostname;
            o.netStoragePath = netStoragePath;
            o.preserveQueryString = preserveQueryString;
            o.protocol = protocol;
            o.redirectCustomPath = redirectCustomPath;
            o.redirectHostname = redirectHostname;
            o.redirectHostnameType = redirectHostnameType;
            o.redirectMethod = redirectMethod;
            o.redirectPath = redirectPath;
