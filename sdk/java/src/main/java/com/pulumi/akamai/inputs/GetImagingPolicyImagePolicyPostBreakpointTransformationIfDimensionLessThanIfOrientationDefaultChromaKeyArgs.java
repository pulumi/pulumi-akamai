...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanIfOrientationDefaultChromaKeyArgs build() {
            return $;
        }
    }
