...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationAspectCrop build() {
            return $;
        }
    }
