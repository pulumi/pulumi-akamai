...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs(GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteArgs build() {
            return $;
        }
    }
