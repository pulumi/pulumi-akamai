...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImage image;

    public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppendImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionGreaterThanAppend build() {
