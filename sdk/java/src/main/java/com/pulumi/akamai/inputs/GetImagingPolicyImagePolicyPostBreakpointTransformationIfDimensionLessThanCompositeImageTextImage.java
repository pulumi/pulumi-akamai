...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionLessThanCompositeImageTextImage build() {
            return $;
        }
    }
