...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAppendImageTextImageArgs build() {
            return $;
        }
    }
