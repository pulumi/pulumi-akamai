...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCropArgs build() {
            return $;
        }
    }
