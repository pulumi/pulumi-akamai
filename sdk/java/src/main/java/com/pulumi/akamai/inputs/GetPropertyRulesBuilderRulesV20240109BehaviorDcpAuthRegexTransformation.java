...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation(GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorDcpAuthRegexTransformation build() {
            return $;
        }
    }
