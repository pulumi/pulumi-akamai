...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanGoop build() {
            return $;
        }
    }
