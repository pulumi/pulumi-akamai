...
import com.pulumi.akamai.inputs.RequestControlCloudletPolicyArgs;
import com.pulumi.akamai.inputs.RequestControlNetStorageArgs;
...
public final class RequestControlArgs extends com.pulumi.resources.ResourceArgs {

    public static final RequestControlArgs Empty = new RequestControlArgs();
    ...
    private @Nullable Output<RequestControlCloudletPolicyArgs> cloudletPolicy;

    public Optional<Output<RequestControlCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<RequestControlNetStorageArgs> netStorage;

    public Optional<Output<RequestControlNetStorageArgs>> netStorage() {
    ...
    private RequestControlArgs() {}

    private RequestControlArgs(RequestControlArgs $) {
    ...
    public static Builder builder(RequestControlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RequestControlArgs();
        }

        public Builder(RequestControlArgs defaults) {
            $ = new RequestControlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cloudletPolicy(@Nullable Output<RequestControlCloudletPolicyArgs> cloudletPolicy) {
            $.cloudletPolicy = cloudletPolicy;
            return this;
        }

        public Builder cloudletPolicy(RequestControlCloudletPolicyArgs cloudletPolicy) {
        ...
        public Builder netStorage(@Nullable Output<RequestControlNetStorageArgs> netStorage) {
            $.netStorage = netStorage;
            return this;
        }

        public Builder netStorage(RequestControlNetStorageArgs netStorage) {
        ...
        public RequestControlArgs build() {
            return $;
        }
    }
