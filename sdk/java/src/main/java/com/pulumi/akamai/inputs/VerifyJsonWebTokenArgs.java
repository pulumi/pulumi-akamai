...
public final class VerifyJsonWebTokenArgs extends com.pulumi.resources.ResourceArgs {

    public static final VerifyJsonWebTokenArgs Empty = new VerifyJsonWebTokenArgs();
    ...
    private VerifyJsonWebTokenArgs() {}

    private VerifyJsonWebTokenArgs(VerifyJsonWebTokenArgs $) {
    ...
    public static Builder builder(VerifyJsonWebTokenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VerifyJsonWebTokenArgs();
        }

        public Builder(VerifyJsonWebTokenArgs defaults) {
            $ = new VerifyJsonWebTokenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VerifyJsonWebTokenArgs build() {
            return $;
        }
    }
