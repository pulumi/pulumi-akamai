...
public final class GetCloudletsSharedPolicyActivationsStagingEffective extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsSharedPolicyActivationsStagingEffective Empty = new GetCloudletsSharedPolicyActivationsStagingEffective();
    ...
    private GetCloudletsSharedPolicyActivationsStagingEffective() {}

    private GetCloudletsSharedPolicyActivationsStagingEffective(GetCloudletsSharedPolicyActivationsStagingEffective $) {
    ...
    public static Builder builder(GetCloudletsSharedPolicyActivationsStagingEffective defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsSharedPolicyActivationsStagingEffective();
        }

        public Builder(GetCloudletsSharedPolicyActivationsStagingEffective defaults) {
            $ = new GetCloudletsSharedPolicyActivationsStagingEffective(Objects.requireNonNull(defaults));
        }
        ...
        public GetCloudletsSharedPolicyActivationsStagingEffective build() {
            if ($.activationId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "activationId");
            }
            if ($.createdBy == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "createdBy");
            }
            if ($.createdDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "createdDate");
            }
            if ($.finishDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "finishDate");
            }
            if ($.network == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "network");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "operation");
            }
            if ($.policyId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "policyId");
            }
            if ($.policyVersion == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "policyVersion");
            }
            if ($.policyVersionDeleted == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "policyVersionDeleted");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffective", "status");
            }
            return $;
        }
    }
