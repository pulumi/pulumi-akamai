...
import com.pulumi.akamai.inputs.OriginCustomCertificateAuthorityIssuerRdnsArgs;
import com.pulumi.akamai.inputs.OriginCustomCertificateAuthoritySubjectRdnsArgs;
...
public final class OriginCustomCertificateAuthorityArgs extends com.pulumi.resources.ResourceArgs {

    public static final OriginCustomCertificateAuthorityArgs Empty = new OriginCustomCertificateAuthorityArgs();
    ...
    private @Nullable Output<OriginCustomCertificateAuthorityIssuerRdnsArgs> issuerRdns;

    public Optional<Output<OriginCustomCertificateAuthorityIssuerRdnsArgs>> issuerRdns() {
    ...
    private @Nullable Output<OriginCustomCertificateAuthoritySubjectRdnsArgs> subjectRdns;

    public Optional<Output<OriginCustomCertificateAuthoritySubjectRdnsArgs>> subjectRdns() {
    ...
    private OriginCustomCertificateAuthorityArgs() {}

    private OriginCustomCertificateAuthorityArgs(OriginCustomCertificateAuthorityArgs $) {
    ...
    public static Builder builder(OriginCustomCertificateAuthorityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginCustomCertificateAuthorityArgs();
        }

        public Builder(OriginCustomCertificateAuthorityArgs defaults) {
            $ = new OriginCustomCertificateAuthorityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable Output<OriginCustomCertificateAuthorityIssuerRdnsArgs> issuerRdns) {
            $.issuerRdns = issuerRdns;
            return this;
        }

        public Builder issuerRdns(OriginCustomCertificateAuthorityIssuerRdnsArgs issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable Output<OriginCustomCertificateAuthoritySubjectRdnsArgs> subjectRdns) {
            $.subjectRdns = subjectRdns;
            return this;
        }

        public Builder subjectRdns(OriginCustomCertificateAuthoritySubjectRdnsArgs subjectRdns) {
        ...
        public OriginCustomCertificateAuthorityArgs build() {
            return $;
        }
    }
