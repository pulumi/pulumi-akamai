...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs $) {
        this.xShear = $.xShear;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultShearsArgs build() {
            return $;
        }
    }
