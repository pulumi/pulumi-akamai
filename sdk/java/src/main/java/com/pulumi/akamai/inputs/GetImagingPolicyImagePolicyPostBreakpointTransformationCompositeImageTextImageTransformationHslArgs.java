...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageTextImageTransformationHslArgs build() {
            return $;
        }
    }
