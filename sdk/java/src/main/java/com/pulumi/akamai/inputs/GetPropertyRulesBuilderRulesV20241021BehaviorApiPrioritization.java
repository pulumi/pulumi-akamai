...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCode;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorage netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorage> netStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCode throttledCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCode> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorage netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCode throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritization build() {
            return $;
        }
    }
