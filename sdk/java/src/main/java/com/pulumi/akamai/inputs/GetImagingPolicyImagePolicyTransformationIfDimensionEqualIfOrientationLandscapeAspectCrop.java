...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeAspectCrop build() {
            return $;
        }
    }
