...
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginal;
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformed;
...
@CustomType
public final class GetPropertyRulesBuilderRulesV20250218BehaviorImageManager {
    /**
    ...
    public List<String> cloudWrapperUrlPaths() {
        return this.cloudWrapperUrlPaths == null ? List.of() : this.cloudWrapperUrlPaths;
    }
    /**
     * @return Assigns a CP code to track traffic and billing for original images that the Image and Video Manager has not modified. You only need to provide the initial `id`, stripping any `cpc_` prefix to pass the integer to the rule tree. Additional CP code details may reflect back in subsequent read-only data.
     * 
    ...
    public static final class Builder {
        ...
        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorImageManager defaults) {
    	      ...
    	      this.cloudWrapperEnabled = defaults.cloudWrapperEnabled;
    	      this.cloudWrapperRolloutStart = defaults.cloudWrapperRolloutStart;
    	      this.cloudWrapperUrlPaths = defaults.cloudWrapperUrlPaths;
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorImageManager build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20250218BehaviorImageManager();
            ...
            _resultValue.cloudWrapperEnabled = cloudWrapperEnabled;
            _resultValue.cloudWrapperRolloutStart = cloudWrapperRolloutStart;
            _resultValue.cloudWrapperUrlPaths = cloudWrapperUrlPaths;
