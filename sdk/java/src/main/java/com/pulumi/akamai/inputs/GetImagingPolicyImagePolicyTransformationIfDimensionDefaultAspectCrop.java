...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAspectCrop build() {
            return $;
        }
    }
