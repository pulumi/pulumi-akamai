...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop(GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationGoop build() {
            return $;
        }
    }
