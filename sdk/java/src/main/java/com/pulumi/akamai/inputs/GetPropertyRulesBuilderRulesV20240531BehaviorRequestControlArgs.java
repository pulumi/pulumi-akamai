...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorageArgs;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorageArgs> netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorageArgs>> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorageArgs netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlArgs build() {
            return $;
        }
    }
