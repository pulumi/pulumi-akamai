...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeTrimArgs build() {
            return $;
        }
    }
