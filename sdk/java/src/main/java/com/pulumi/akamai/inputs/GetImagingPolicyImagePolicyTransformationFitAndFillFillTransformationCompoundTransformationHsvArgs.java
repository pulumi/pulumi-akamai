...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationCompoundTransformationHsvArgs build() {
            return $;
        }
    }
