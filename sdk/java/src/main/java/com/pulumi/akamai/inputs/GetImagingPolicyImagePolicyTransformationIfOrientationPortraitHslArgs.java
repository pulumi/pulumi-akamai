...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHslArgs build() {
            return $;
        }
    }
