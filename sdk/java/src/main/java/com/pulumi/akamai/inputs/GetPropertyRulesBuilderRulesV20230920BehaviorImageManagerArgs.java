...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeOriginalArgs>> cpCodeOriginal() {
        return Optional.ofNullable(this.cpCodeOriginal);
    }

    @Import(name="cpCodeTransformed")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs() {}

    private GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal) {
            $.cpCodeOriginal = cpCodeOriginal;
            return this;
        }

        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeOriginalArgs cpCodeOriginal) {
            return cpCodeOriginal(Output.of(cpCodeOriginal));
        }

        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed) {
            $.cpCodeTransformed = cpCodeTransformed;
            return this;
        }

        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorImageManagerArgs build() {
            return $;
        }
    }
