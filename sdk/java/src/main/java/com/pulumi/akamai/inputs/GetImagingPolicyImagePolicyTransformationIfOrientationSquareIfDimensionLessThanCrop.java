...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanCrop build() {
            return $;
        }
    }
