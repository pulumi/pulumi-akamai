...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationDefaultGoop build() {
            return $;
        }
    }
