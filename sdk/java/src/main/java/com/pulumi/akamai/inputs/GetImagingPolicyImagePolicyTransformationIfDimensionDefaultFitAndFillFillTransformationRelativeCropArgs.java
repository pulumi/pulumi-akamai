...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationRelativeCropArgs build() {
            return $;
        }
    }
