...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorImageAndVideoManagerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageAndVideoManagerCpCodeOriginalArgs> cpCodeOriginal;

    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageAndVideoManagerCpCodeOriginalArgs>> cpCodeOriginal() {
        return Optional.ofNullable(this.cpCodeOriginal);
    }

    @Import(name="cpCodeTransformed")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageAndVideoManagerCpCodeTransformedArgs> cpCodeTransformed;

    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageAndVideoManagerCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    public static final class Builder {
        ...
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageAndVideoManagerCpCodeOriginalArgs> cpCodeOriginal) {
        ...
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorImageAndVideoManagerCpCodeTransformedArgs> cpCodeTransformed) {
