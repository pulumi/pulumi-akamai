...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAspectCrop build() {
            return $;
        }
    }
