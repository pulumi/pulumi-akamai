...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCompositeImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCompositeImage image;

    public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCompositeImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCompositeImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeComposite build() {
