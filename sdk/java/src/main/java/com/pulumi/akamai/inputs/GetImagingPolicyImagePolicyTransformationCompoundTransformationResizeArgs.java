...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationResizeArgs build() {
            return $;
        }
    }
