...
public final class GetBotmanBotCategoryExceptionPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetBotmanBotCategoryExceptionPlainArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("GetBotmanBotCategoryExceptionPlainArgs", "configId");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("GetBotmanBotCategoryExceptionPlainArgs", "securityPolicyId");
            }
            return $;
        }
    }
