...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomCpCode;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomCpCode> waitingRoomCpCode() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage;

    /**
     * @return Specifies the NetStorage domain for the waiting room page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomNetStorage> waitingRoomNetStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization(GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder waitingRoomCpCode(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode) {
         ...
         * 
         */
        public Builder waitingRoomNetStorage(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorVisitorPrioritization build() {
            return $;
        }
    }
