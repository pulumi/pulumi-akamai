...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketing build() {
            return $;
        }
    }
