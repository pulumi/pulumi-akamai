...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationCrop build() {
            return $;
        }
    }
