...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule();
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule build() {
            return $;
        }
    }
