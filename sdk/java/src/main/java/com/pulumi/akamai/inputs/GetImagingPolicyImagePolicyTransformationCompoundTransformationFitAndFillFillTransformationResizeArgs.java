...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationFitAndFillFillTransformationResizeArgs build() {
            return $;
        }
    }
