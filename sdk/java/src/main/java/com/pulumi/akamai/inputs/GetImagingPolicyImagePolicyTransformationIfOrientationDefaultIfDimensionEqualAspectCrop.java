...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionEqualAspectCrop build() {
            return $;
        }
    }
