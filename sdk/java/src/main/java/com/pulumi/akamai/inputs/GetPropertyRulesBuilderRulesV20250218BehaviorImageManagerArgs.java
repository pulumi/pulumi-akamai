...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs();
    ...
    @Import(name="cloudWrapperEnabled")
    private @Nullable Output<Boolean> cloudWrapperEnabled;

    public Optional<Output<Boolean>> cloudWrapperEnabled() {
        return Optional.ofNullable(this.cloudWrapperEnabled);
    }

    @Import(name="cloudWrapperRolloutStart")
    private @Nullable Output<Boolean> cloudWrapperRolloutStart;

    public Optional<Output<Boolean>> cloudWrapperRolloutStart() {
        return Optional.ofNullable(this.cloudWrapperRolloutStart);
    }

    @Import(name="cloudWrapperUrlPaths")
    private @Nullable Output<List<String>> cloudWrapperUrlPaths;

    public Optional<Output<List<String>>> cloudWrapperUrlPaths() {
        return Optional.ofNullable(this.cloudWrapperUrlPaths);
    }
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginalArgs>> cpCodeOriginal() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs(GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs $) {
        this.advanced = $.advanced;
        this.apiReferenceTitle = $.apiReferenceTitle;
        this.applyBestFileType = $.applyBestFileType;
        this.cloudWrapperEnabled = $.cloudWrapperEnabled;
        this.cloudWrapperRolloutStart = $.cloudWrapperRolloutStart;
        this.cloudWrapperUrlPaths = $.cloudWrapperUrlPaths;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cloudWrapperEnabled(@Nullable Output<Boolean> cloudWrapperEnabled) {
            $.cloudWrapperEnabled = cloudWrapperEnabled;
            return this;
        }

        public Builder cloudWrapperEnabled(Boolean cloudWrapperEnabled) {
            return cloudWrapperEnabled(Output.of(cloudWrapperEnabled));
        }

        public Builder cloudWrapperRolloutStart(@Nullable Output<Boolean> cloudWrapperRolloutStart) {
            $.cloudWrapperRolloutStart = cloudWrapperRolloutStart;
            return this;
        }

        public Builder cloudWrapperRolloutStart(Boolean cloudWrapperRolloutStart) {
            return cloudWrapperRolloutStart(Output.of(cloudWrapperRolloutStart));
        }

        public Builder cloudWrapperUrlPaths(@Nullable Output<List<String>> cloudWrapperUrlPaths) {
            $.cloudWrapperUrlPaths = cloudWrapperUrlPaths;
            return this;
        }

        public Builder cloudWrapperUrlPaths(List<String> cloudWrapperUrlPaths) {
            return cloudWrapperUrlPaths(Output.of(cloudWrapperUrlPaths));
        }

        public Builder cloudWrapperUrlPaths(String... cloudWrapperUrlPaths) {
            return cloudWrapperUrlPaths(List.of(cloudWrapperUrlPaths));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginalArgs cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed) {
         ...
         * 
         */
        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerArgs build() {
            return $;
        }
    }
