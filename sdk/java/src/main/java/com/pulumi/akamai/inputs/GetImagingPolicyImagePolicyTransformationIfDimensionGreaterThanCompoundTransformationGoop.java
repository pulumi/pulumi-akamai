...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationGoop build() {
            return $;
        }
    }
