...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanAspectCrop build() {
            return $;
        }
    }
