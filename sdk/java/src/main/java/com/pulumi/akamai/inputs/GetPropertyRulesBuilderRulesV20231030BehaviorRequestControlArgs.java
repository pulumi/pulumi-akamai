...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorageArgs;
...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy;

    public Optional<Output<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorageArgs> netStorage;

    public Optional<Output<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorageArgs>> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy) {
            $.cloudletPolicy = cloudletPolicy;
            return this;
        }

        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicyArgs cloudletPolicy) {
        ...
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorageArgs> netStorage) {
            $.netStorage = netStorage;
            return this;
        }

        public Builder netStorage(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorageArgs netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlArgs build() {
            return $;
        }
    }
