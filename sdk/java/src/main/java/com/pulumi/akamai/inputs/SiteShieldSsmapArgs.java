...
public final class SiteShieldSsmapArgs extends com.pulumi.resources.ResourceArgs {

    public static final SiteShieldSsmapArgs Empty = new SiteShieldSsmapArgs();
    ...
    private SiteShieldSsmapArgs() {}

    private SiteShieldSsmapArgs(SiteShieldSsmapArgs $) {
    ...
    public static Builder builder(SiteShieldSsmapArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SiteShieldSsmapArgs();
        }

        public Builder(SiteShieldSsmapArgs defaults) {
            $ = new SiteShieldSsmapArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SiteShieldSsmapArgs build() {
            return $;
        }
    }
