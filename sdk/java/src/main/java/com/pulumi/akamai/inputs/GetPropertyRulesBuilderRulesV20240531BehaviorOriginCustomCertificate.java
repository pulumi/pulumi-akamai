...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateSubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateSubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateSubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate(GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateSubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificate build() {
            return $;
        }
    }
