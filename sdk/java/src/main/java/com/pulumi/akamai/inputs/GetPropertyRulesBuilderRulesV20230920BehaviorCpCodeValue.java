...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValueCpCodeLimits;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValueCpCodeLimits cpCodeLimits;

    /**
     * @return This field is only intended for export compatibility purposes, and modifying it will not impact your use of the behavior.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValueCpCodeLimits> cpCodeLimits() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue(GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeLimits(@Nullable GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValueCpCodeLimits cpCodeLimits) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorCpCodeValue build() {
            return $;
        }
    }
