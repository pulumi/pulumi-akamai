...
public final class SubCustomer extends com.pulumi.resources.InvokeArgs {

    public static final SubCustomer Empty = new SubCustomer();
    ...
    public static Builder builder(SubCustomer defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SubCustomer defaults) {
            $ = new SubCustomer(Objects.requireNonNull(defaults));
        }
