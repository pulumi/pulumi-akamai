...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRule;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRule>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable List<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRule... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenter build() {
            return $;
        }
    }
