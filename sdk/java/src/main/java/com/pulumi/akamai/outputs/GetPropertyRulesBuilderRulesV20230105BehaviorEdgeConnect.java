...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorEdgeConnect {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorEdgeConnect build() {
            final var o = new GetPropertyRulesBuilderRulesV20230105BehaviorEdgeConnect();
            o.aggregateLines = aggregateLines;
            o.aggregateSize = aggregateSize;
            o.aggregateTime = aggregateTime;
            o.apiConnector = apiConnector;
            o.apiDataElements = apiDataElements;
            o.destinationHostname = destinationHostname;
            o.destinationPath = destinationPath;
            o.enabled = enabled;
            o.locked = locked;
            o.overrideAggregateSettings = overrideAggregateSettings;
