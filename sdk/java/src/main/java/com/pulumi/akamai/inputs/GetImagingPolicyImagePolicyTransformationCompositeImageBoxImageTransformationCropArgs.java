...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationCropArgs build() {
            return $;
        }
    }
