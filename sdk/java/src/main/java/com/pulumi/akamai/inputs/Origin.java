...
import com.pulumi.akamai.inputs.OriginCustomCertificate;
import com.pulumi.akamai.inputs.OriginCustomCertificateAuthority;
import com.pulumi.akamai.inputs.OriginNetStorage;
...
public final class Origin extends com.pulumi.resources.InvokeArgs {

    public static final Origin Empty = new Origin();
    ...
    private @Nullable List<OriginCustomCertificateAuthority> customCertificateAuthorities;

    public Optional<List<OriginCustomCertificateAuthority>> customCertificateAuthorities() {
        return Optional.ofNullable(this.customCertificateAuthorities);
    }

    @Import(name="customCertificates")
    private @Nullable List<OriginCustomCertificate> customCertificates;

    public Optional<List<OriginCustomCertificate>> customCertificates() {
    ...
    private @Nullable OriginNetStorage netStorage;

    public Optional<OriginNetStorage> netStorage() {
    ...
    public static Builder builder(Origin defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Origin defaults) {
            $ = new Origin(Objects.requireNonNull(defaults));
        }
        ...
        public Builder customCertificateAuthorities(@Nullable List<OriginCustomCertificateAuthority> customCertificateAuthorities) {
            $.customCertificateAuthorities = customCertificateAuthorities;
            return this;
        }

        public Builder customCertificateAuthorities(OriginCustomCertificateAuthority... customCertificateAuthorities) {
            return customCertificateAuthorities(List.of(customCertificateAuthorities));
        }

        public Builder customCertificates(@Nullable List<OriginCustomCertificate> customCertificates) {
            $.customCertificates = customCertificates;
            return this;
        }

        public Builder customCertificates(OriginCustomCertificate... customCertificates) {
        ...
        public Builder netStorage(@Nullable OriginNetStorage netStorage) {
