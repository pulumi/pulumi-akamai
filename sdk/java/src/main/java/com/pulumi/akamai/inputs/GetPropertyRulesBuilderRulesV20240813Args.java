...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813CriterionArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813CustomOverrideArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813VariableArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813Args extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813Args Empty = new GetPropertyRulesBuilderRulesV20240813Args();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240813BehaviorArgs>> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240813BehaviorArgs>>> behaviors() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240813CriterionArgs>> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240813CriterionArgs>>> criterions() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813CustomOverrideArgs> customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813CustomOverrideArgs>> customOverride() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240813VariableArgs>> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240813VariableArgs>>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20240813Args() {}

    private GetPropertyRulesBuilderRulesV20240813Args(GetPropertyRulesBuilderRulesV20240813Args $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813Args();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813Args defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240813BehaviorArgs>> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(List<GetPropertyRulesBuilderRulesV20240813BehaviorArgs> behaviors) {
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20240813BehaviorArgs... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240813CriterionArgs>> criterions) {
         ...
         * 
         */
        public Builder criterions(List<GetPropertyRulesBuilderRulesV20240813CriterionArgs> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20240813CriterionArgs... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable Output<GetPropertyRulesBuilderRulesV20240813CustomOverrideArgs> customOverride) {
         ...
         * 
         */
        public Builder customOverride(GetPropertyRulesBuilderRulesV20240813CustomOverrideArgs customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240813VariableArgs>> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(List<GetPropertyRulesBuilderRulesV20240813VariableArgs> variables) {
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20240813VariableArgs... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20240813Args build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20240813Args", "name");
            }
            return $;
        }
    }
