...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationAppendArgs build() {
