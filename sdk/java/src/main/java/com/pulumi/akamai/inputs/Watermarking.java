...
public final class Watermarking extends com.pulumi.resources.InvokeArgs {

    public static final Watermarking Empty = new Watermarking();
    ...
    public static Builder builder(Watermarking defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Watermarking defaults) {
            $ = new Watermarking(Objects.requireNonNull(defaults));
        }
