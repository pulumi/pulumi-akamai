...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultFitAndFillFillTransformationAspectCrop build() {
            return $;
        }
    }
