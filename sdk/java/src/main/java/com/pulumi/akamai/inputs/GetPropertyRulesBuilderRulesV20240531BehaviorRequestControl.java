...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorage netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorage> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorRequestControlNetStorage netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorRequestControl build() {
            return $;
        }
    }
