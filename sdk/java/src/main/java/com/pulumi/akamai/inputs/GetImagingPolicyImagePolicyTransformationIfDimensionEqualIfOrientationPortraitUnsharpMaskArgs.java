...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationPortraitUnsharpMaskArgs build() {
            return $;
        }
    }
