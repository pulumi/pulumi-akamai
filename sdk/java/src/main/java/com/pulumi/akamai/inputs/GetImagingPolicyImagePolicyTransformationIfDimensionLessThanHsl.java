...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanHsl build() {
            return $;
        }
    }
