...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite(GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewrite build() {
            return $;
        }
    }
