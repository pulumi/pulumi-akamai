...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109Behavior;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109Criterion;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109CustomOverride;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109Variable;
...
public final class GetPropertyRulesBuilderRulesV20240109 extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109 Empty = new GetPropertyRulesBuilderRulesV20240109();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240109Behavior> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240109Behavior>> behaviors() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240109Criterion> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240109Criterion>> criterions() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109CustomOverride customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109CustomOverride> customOverride() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240109Variable> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240109Variable>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20240109() {}

    private GetPropertyRulesBuilderRulesV20240109(GetPropertyRulesBuilderRulesV20240109 $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109 defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable List<GetPropertyRulesBuilderRulesV20240109Behavior> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20240109Behavior... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable List<GetPropertyRulesBuilderRulesV20240109Criterion> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20240109Criterion... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable GetPropertyRulesBuilderRulesV20240109CustomOverride customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable List<GetPropertyRulesBuilderRulesV20240109Variable> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20240109Variable... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20240109 build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20240109", "name");
            }
            return $;
        }
    }
