...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareHslArgs build() {
            return $;
        }
    }
