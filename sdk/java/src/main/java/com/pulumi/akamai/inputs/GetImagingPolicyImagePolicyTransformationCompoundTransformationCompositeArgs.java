...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeArgs build() {
