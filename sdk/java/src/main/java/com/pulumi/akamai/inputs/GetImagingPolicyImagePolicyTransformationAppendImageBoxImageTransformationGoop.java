...
public final class GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop Empty = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationGoop build() {
            return $;
        }
    }
