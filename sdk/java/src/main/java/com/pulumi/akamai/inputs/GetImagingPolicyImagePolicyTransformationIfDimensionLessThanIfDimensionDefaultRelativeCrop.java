...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRelativeCrop build() {
            return $;
        }
    }
