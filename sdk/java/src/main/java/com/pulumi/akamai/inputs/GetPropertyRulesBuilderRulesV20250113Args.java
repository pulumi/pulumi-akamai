...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113CriterionArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113CustomOverrideArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113VariableArgs;
...
public final class GetPropertyRulesBuilderRulesV20250113Args extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250113Args Empty = new GetPropertyRulesBuilderRulesV20250113Args();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250113BehaviorArgs>> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250113BehaviorArgs>>> behaviors() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250113CriterionArgs>> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250113CriterionArgs>>> criterions() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250113CustomOverrideArgs> customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250113CustomOverrideArgs>> customOverride() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250113VariableArgs>> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250113VariableArgs>>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20250113Args() {}

    private GetPropertyRulesBuilderRulesV20250113Args(GetPropertyRulesBuilderRulesV20250113Args $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113Args();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113Args defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250113BehaviorArgs>> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(List<GetPropertyRulesBuilderRulesV20250113BehaviorArgs> behaviors) {
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20250113BehaviorArgs... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250113CriterionArgs>> criterions) {
         ...
         * 
         */
        public Builder criterions(List<GetPropertyRulesBuilderRulesV20250113CriterionArgs> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20250113CriterionArgs... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable Output<GetPropertyRulesBuilderRulesV20250113CustomOverrideArgs> customOverride) {
         ...
         * 
         */
        public Builder customOverride(GetPropertyRulesBuilderRulesV20250113CustomOverrideArgs customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250113VariableArgs>> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(List<GetPropertyRulesBuilderRulesV20250113VariableArgs> variables) {
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20250113VariableArgs... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20250113Args build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20250113Args", "name");
            }
            return $;
        }
    }
