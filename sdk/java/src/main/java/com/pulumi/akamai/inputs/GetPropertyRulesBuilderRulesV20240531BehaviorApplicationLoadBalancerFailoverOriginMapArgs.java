...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs(GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorApplicationLoadBalancerFailoverOriginMapArgs build() {
            return $;
        }
    }
