...
public final class GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey Empty = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageBoxImageTransformationChromaKey build() {
            return $;
        }
    }
