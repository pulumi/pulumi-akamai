...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531Behavior;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531Criterion;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531CustomOverride;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531Variable;
...
public final class GetPropertyRulesBuilderRulesV20240531 extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531 Empty = new GetPropertyRulesBuilderRulesV20240531();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240531Behavior> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240531Behavior>> behaviors() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240531Criterion> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240531Criterion>> criterions() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531CustomOverride customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531CustomOverride> customOverride() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240531Variable> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240531Variable>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20240531() {}

    private GetPropertyRulesBuilderRulesV20240531(GetPropertyRulesBuilderRulesV20240531 $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531 defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable List<GetPropertyRulesBuilderRulesV20240531Behavior> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20240531Behavior... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable List<GetPropertyRulesBuilderRulesV20240531Criterion> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20240531Criterion... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable GetPropertyRulesBuilderRulesV20240531CustomOverride customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable List<GetPropertyRulesBuilderRulesV20240531Variable> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20240531Variable... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20240531 build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20240531", "name");
            }
            return $;
        }
    }
