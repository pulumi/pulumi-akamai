...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs(GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorForwardRewriteArgs build() {
            return $;
        }
    }
