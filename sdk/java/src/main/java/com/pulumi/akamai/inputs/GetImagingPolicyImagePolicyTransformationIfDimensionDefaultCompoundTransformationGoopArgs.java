...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationGoopArgs build() {
            return $;
        }
    }
