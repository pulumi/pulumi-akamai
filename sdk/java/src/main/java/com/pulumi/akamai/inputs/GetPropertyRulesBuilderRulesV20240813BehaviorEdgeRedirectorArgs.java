...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorEdgeRedirectorArgs build() {
            return $;
        }
    }
