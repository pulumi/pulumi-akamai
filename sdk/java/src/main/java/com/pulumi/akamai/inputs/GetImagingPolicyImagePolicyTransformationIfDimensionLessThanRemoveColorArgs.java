...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanRemoveColorArgs build() {
            return $;
        }
    }
