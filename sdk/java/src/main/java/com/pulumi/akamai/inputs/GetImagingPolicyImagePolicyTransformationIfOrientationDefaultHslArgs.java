...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHslArgs build() {
            return $;
        }
    }
