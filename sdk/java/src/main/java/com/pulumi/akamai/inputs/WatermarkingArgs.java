...
public final class WatermarkingArgs extends com.pulumi.resources.ResourceArgs {

    public static final WatermarkingArgs Empty = new WatermarkingArgs();
    ...
    private WatermarkingArgs() {}

    private WatermarkingArgs(WatermarkingArgs $) {
    ...
    public static Builder builder(WatermarkingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WatermarkingArgs();
        }

        public Builder(WatermarkingArgs defaults) {
            $ = new WatermarkingArgs(Objects.requireNonNull(defaults));
        }
