...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareUnsharpMaskArgs build() {
            return $;
        }
    }
