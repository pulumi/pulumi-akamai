...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeAspectCrop build() {
            return $;
        }
    }
