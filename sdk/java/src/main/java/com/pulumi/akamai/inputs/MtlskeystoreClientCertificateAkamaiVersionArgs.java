...
import com.pulumi.akamai.inputs.MtlskeystoreClientCertificateAkamaiVersionCertificateBlockArgs;
...
public final class MtlskeystoreClientCertificateAkamaiVersionArgs extends com.pulumi.resources.ResourceArgs {

    public static final MtlskeystoreClientCertificateAkamaiVersionArgs Empty = new MtlskeystoreClientCertificateAkamaiVersionArgs();
    ...
    private @Nullable Output<MtlskeystoreClientCertificateAkamaiVersionCertificateBlockArgs> certificateBlock;

    /**
     * @return Details of the certificate block for the client certificate version.
     * 
     */
    public Optional<Output<MtlskeystoreClientCertificateAkamaiVersionCertificateBlockArgs>> certificateBlock() {
    ...
    private MtlskeystoreClientCertificateAkamaiVersionArgs() {}

    private MtlskeystoreClientCertificateAkamaiVersionArgs(MtlskeystoreClientCertificateAkamaiVersionArgs $) {
    ...
    public static Builder builder(MtlskeystoreClientCertificateAkamaiVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MtlskeystoreClientCertificateAkamaiVersionArgs();
        }

        public Builder(MtlskeystoreClientCertificateAkamaiVersionArgs defaults) {
            $ = new MtlskeystoreClientCertificateAkamaiVersionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder certificateBlock(@Nullable Output<MtlskeystoreClientCertificateAkamaiVersionCertificateBlockArgs> certificateBlock) {
         ...
         * 
         */
        public Builder certificateBlock(MtlskeystoreClientCertificateAkamaiVersionCertificateBlockArgs certificateBlock) {
        ...
        /**
         * @param status The client certificate version status. Possible values: `DEPLOYMENT_PENDING`, `DEPLOYED`, or `DELETE_PENDING`.
         * 
         * @return builder
         * 
         */
        ...
        public MtlskeystoreClientCertificateAkamaiVersionArgs build() {
            return $;
        }
    }
