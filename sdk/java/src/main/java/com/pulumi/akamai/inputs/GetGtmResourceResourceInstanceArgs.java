...
public final class GetGtmResourceResourceInstanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGtmResourceResourceInstanceArgs Empty = new GetGtmResourceResourceInstanceArgs();
    ...
    private GetGtmResourceResourceInstanceArgs() {}

    private GetGtmResourceResourceInstanceArgs(GetGtmResourceResourceInstanceArgs $) {
    ...
    public static Builder builder(GetGtmResourceResourceInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGtmResourceResourceInstanceArgs();
        }

        public Builder(GetGtmResourceResourceInstanceArgs defaults) {
            $ = new GetGtmResourceResourceInstanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGtmResourceResourceInstanceArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("GetGtmResourceResourceInstanceArgs", "datacenterId");
            }
            if ($.loadObject == null) {
                throw new MissingRequiredPropertyException("GetGtmResourceResourceInstanceArgs", "loadObject");
            }
            if ($.loadObjectPort == null) {
                throw new MissingRequiredPropertyException("GetGtmResourceResourceInstanceArgs", "loadObjectPort");
            }
            if ($.loadServers == null) {
                throw new MissingRequiredPropertyException("GetGtmResourceResourceInstanceArgs", "loadServers");
            }
            if ($.useDefaultLoadObject == null) {
                throw new MissingRequiredPropertyException("GetGtmResourceResourceInstanceArgs", "useDefaultLoadObject");
            }
            return $;
        }
    }
