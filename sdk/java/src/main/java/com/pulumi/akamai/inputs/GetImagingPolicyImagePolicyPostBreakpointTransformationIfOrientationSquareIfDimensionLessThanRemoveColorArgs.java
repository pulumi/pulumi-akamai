...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs build() {
            return $;
        }
    }
