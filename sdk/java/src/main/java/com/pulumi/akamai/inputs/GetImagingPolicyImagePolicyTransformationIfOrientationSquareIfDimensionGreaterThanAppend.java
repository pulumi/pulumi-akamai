...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppendImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppendImage image;

    public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppendImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppendImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAppend build() {
