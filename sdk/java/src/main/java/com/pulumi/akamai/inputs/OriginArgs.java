...
import com.pulumi.akamai.inputs.OriginCustomCertificateArgs;
import com.pulumi.akamai.inputs.OriginCustomCertificateAuthorityArgs;
import com.pulumi.akamai.inputs.OriginNetStorageArgs;
...
public final class OriginArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<OriginCustomCertificateAuthorityArgs>> customCertificateAuthorities;

    public Optional<Output<List<OriginCustomCertificateAuthorityArgs>>> customCertificateAuthorities() {
        return Optional.ofNullable(this.customCertificateAuthorities);
    }

    @Import(name="customCertificates")
    private @Nullable Output<List<OriginCustomCertificateArgs>> customCertificates;

    public Optional<Output<List<OriginCustomCertificateArgs>>> customCertificates() {
    ...
    private @Nullable Output<OriginNetStorageArgs> netStorage;

    public Optional<Output<OriginNetStorageArgs>> netStorage() {
    ...
    public static final class Builder {
        ...
        public Builder customCertificateAuthorities(@Nullable Output<List<OriginCustomCertificateAuthorityArgs>> customCertificateAuthorities) {
            $.customCertificateAuthorities = customCertificateAuthorities;
            return this;
        }

        public Builder customCertificateAuthorities(List<OriginCustomCertificateAuthorityArgs> customCertificateAuthorities) {
            return customCertificateAuthorities(Output.of(customCertificateAuthorities));
        }

        public Builder customCertificateAuthorities(OriginCustomCertificateAuthorityArgs... customCertificateAuthorities) {
            return customCertificateAuthorities(List.of(customCertificateAuthorities));
        }

        public Builder customCertificates(@Nullable Output<List<OriginCustomCertificateArgs>> customCertificates) {
            $.customCertificates = customCertificates;
            return this;
        }

        public Builder customCertificates(List<OriginCustomCertificateArgs> customCertificates) {
            return customCertificates(Output.of(customCertificates));
        }

        public Builder customCertificates(OriginCustomCertificateArgs... customCertificates) {
        ...
        public Builder netStorage(@Nullable Output<OriginNetStorageArgs> netStorage) {
            $.netStorage = netStorage;
            return this;
        }

        public Builder netStorage(OriginNetStorageArgs netStorage) {
