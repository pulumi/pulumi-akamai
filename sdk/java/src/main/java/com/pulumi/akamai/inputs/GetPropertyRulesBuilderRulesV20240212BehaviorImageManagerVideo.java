...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo(GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorImageManagerVideo build() {
            return $;
        }
    }
