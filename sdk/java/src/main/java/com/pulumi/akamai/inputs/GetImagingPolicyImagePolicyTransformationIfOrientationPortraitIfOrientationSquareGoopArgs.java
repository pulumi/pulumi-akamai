...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitIfOrientationSquareGoopArgs build() {
            return $;
        }
    }
