...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationCrop build() {
            return $;
        }
    }
