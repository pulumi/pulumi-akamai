...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationHsl build() {
            return $;
        }
    }
