...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultRelativeCrop build() {
            return $;
        }
    }
