...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoopArgs build() {
            return $;
        }
    }
