...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs(GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorFirstPartyMarketingPlusArgs build() {
            return $;
        }
    }
