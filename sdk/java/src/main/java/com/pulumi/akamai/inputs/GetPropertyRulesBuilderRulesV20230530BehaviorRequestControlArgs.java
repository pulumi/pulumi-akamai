...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlNetStorageArgs;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlNetStorageArgs> netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlNetStorageArgs>> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs(GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlNetStorageArgs netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorRequestControlArgs build() {
            return $;
        }
    }
