...
public final class GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationGoopArgs build() {
            return $;
        }
    }
