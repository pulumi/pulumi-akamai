...
public final class GetCloudletsEdgeRedirectorMatchRuleResult {
    ...
    private final @Nullable List<GetCloudletsEdgeRedirectorMatchRuleMatchRule> matchRules;

    @CustomType.Constructor
    private GetCloudletsEdgeRedirectorMatchRuleResult(
        @CustomType.Parameter("id") String id,
        @CustomType.Parameter("json") String json,
        @CustomType.Parameter("matchRules") @Nullable List<GetCloudletsEdgeRedirectorMatchRuleMatchRule> matchRules) {
        this.id = id;
        this.json = json;
    ...
    public static final class Builder {
        ...
        public Builder matchRules(GetCloudletsEdgeRedirectorMatchRuleMatchRule... matchRules) {
            ...
            return new GetCloudletsEdgeRedirectorMatchRuleResult(id, json, matchRules);
        }
    }
}
