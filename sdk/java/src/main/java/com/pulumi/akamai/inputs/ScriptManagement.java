...
public final class ScriptManagement extends com.pulumi.resources.InvokeArgs {

    public static final ScriptManagement Empty = new ScriptManagement();
    ...
    public static Builder builder(ScriptManagement defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ScriptManagement();
        }

        public Builder(ScriptManagement defaults) {
            $ = new ScriptManagement(Objects.requireNonNull(defaults));
        }
