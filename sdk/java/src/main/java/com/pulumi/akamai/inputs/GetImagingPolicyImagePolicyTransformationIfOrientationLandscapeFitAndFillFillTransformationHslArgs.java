...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHslArgs build() {
            return $;
        }
    }
