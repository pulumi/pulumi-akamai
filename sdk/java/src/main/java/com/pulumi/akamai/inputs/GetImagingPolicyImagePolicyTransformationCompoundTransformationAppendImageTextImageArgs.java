...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationAppendImageTextImageArgs build() {
            return $;
        }
    }
