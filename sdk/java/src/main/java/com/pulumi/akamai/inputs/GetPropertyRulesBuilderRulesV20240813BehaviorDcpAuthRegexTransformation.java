...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation(GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorDcpAuthRegexTransformation build() {
            return $;
        }
    }
