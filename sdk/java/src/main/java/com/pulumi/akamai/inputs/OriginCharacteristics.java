...
public final class OriginCharacteristics extends com.pulumi.resources.InvokeArgs {

    public static final OriginCharacteristics Empty = new OriginCharacteristics();
    ...
    private OriginCharacteristics(OriginCharacteristics $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginCharacteristics();
        }

        public Builder(OriginCharacteristics defaults) {
            $ = new OriginCharacteristics(Objects.requireNonNull(defaults));
        }
