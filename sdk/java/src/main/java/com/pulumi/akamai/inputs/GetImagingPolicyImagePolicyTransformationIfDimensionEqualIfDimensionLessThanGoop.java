...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanGoop build() {
            return $;
        }
    }
