...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationCompositeImageTextImage build() {
            return $;
        }
    }
