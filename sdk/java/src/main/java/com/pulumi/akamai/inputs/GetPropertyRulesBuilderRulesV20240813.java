...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813Behavior;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813Criterion;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813CustomOverride;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813Variable;
...
public final class GetPropertyRulesBuilderRulesV20240813 extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813 Empty = new GetPropertyRulesBuilderRulesV20240813();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240813Behavior> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240813Behavior>> behaviors() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240813Criterion> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240813Criterion>> criterions() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813CustomOverride customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813CustomOverride> customOverride() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240813Variable> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240813Variable>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20240813() {}

    private GetPropertyRulesBuilderRulesV20240813(GetPropertyRulesBuilderRulesV20240813 $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813 defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable List<GetPropertyRulesBuilderRulesV20240813Behavior> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20240813Behavior... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable List<GetPropertyRulesBuilderRulesV20240813Criterion> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20240813Criterion... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable GetPropertyRulesBuilderRulesV20240813CustomOverride customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable List<GetPropertyRulesBuilderRulesV20240813Variable> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20240813Variable... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20240813 build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20240813", "name");
            }
            return $;
        }
    }
