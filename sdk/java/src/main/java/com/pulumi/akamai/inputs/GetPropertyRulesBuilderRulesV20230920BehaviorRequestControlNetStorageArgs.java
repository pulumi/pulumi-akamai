...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs(GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorRequestControlNetStorageArgs build() {
            return $;
        }
    }
