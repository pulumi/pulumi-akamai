...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCropArgs build() {
            return $;
        }
    }
