...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs();
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs(GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorLimitBitRateThresholdTableArgs build() {
            return $;
        }
    }
