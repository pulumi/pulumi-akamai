...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageTextImage build() {
            return $;
        }
    }
