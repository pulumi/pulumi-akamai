...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorResponseCookie extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorResponseCookie(GetPropertyRulesBuilderRulesV20230105BehaviorResponseCookie $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorResponseCookie defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorResponseCookie();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorResponseCookie defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorResponseCookie build() {
            return $;
        }
    }
