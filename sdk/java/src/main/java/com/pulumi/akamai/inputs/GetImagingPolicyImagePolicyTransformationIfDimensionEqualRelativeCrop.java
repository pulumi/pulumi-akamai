...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualRelativeCrop build() {
            return $;
        }
    }
