...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCrop build() {
            return $;
        }
    }
