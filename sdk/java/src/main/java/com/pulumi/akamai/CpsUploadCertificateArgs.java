...
public final class CpsUploadCertificateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CpsUploadCertificateArgs() {}

    private CpsUploadCertificateArgs(CpsUploadCertificateArgs $) {
    ...
    public static Builder builder(CpsUploadCertificateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CpsUploadCertificateArgs defaults) {
            $ = new CpsUploadCertificateArgs(Objects.requireNonNull(defaults));
        }
