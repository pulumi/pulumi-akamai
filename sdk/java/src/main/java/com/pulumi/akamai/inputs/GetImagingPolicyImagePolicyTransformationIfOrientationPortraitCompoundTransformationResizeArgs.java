...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationResizeArgs build() {
            return $;
        }
    }
