...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorRedirectplus extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorRedirectplus(GetPropertyRulesBuilderRulesV20230105BehaviorRedirectplus $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorRedirectplus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorRedirectplus();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorRedirectplus defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorRedirectplus build() {
            return $;
        }
    }
