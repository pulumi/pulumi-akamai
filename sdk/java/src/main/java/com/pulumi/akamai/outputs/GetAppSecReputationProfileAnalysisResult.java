...
public final class GetAppSecReputationProfileAnalysisResult {
    ...
    public static final class Builder {
        ...
        public Builder configId(Integer configId) {
            if (configId == null) {
              throw new MissingRequiredPropertyException("GetAppSecReputationProfileAnalysisResult", "configId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAppSecReputationProfileAnalysisResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder json(String json) {
            if (json == null) {
              throw new MissingRequiredPropertyException("GetAppSecReputationProfileAnalysisResult", "json");
            }
            this.json = json;
            return this;
        }
        ...
        public GetAppSecReputationProfileAnalysisResult build() {
            final var _resultValue = new GetAppSecReputationProfileAnalysisResult();
