...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareRelativeCrop build() {
            return $;
        }
    }
