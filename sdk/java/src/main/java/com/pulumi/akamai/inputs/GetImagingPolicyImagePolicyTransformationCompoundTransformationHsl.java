...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl(GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationHsl build() {
            return $;
        }
    }
