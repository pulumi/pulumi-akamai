...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirectorCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirectorCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorEdgeRedirector build() {
            return $;
        }
    }
