...
public final class SegmentedMediaOptimization extends com.pulumi.resources.InvokeArgs {

    public static final SegmentedMediaOptimization Empty = new SegmentedMediaOptimization();
    ...
    private SegmentedMediaOptimization() {}

    private SegmentedMediaOptimization(SegmentedMediaOptimization $) {
    ...
    public static Builder builder(SegmentedMediaOptimization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SegmentedMediaOptimization();
        }

        public Builder(SegmentedMediaOptimization defaults) {
            $ = new SegmentedMediaOptimization(Objects.requireNonNull(defaults));
        }
        ...
        public SegmentedMediaOptimization build() {
            return $;
        }
    }
