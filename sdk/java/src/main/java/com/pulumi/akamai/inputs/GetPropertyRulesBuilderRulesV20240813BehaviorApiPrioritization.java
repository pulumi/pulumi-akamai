...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationThrottledCpCode;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationNetStorage netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationNetStorage> netStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationThrottledCpCode throttledCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationThrottledCpCode> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization(GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationNetStorage netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritizationThrottledCpCode throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorApiPrioritization build() {
            return $;
        }
    }
