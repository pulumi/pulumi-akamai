...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationPortraitChromaKeyArgs build() {
            return $;
        }
    }
