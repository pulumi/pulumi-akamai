...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerVideo build() {
            return $;
        }
    }
