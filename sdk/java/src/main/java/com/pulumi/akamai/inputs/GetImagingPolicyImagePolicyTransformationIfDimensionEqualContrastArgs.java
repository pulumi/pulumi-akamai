...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualContrastArgs build() {
            return $;
        }
    }
