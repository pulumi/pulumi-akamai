...
public final class SiteShieldSsmap extends com.pulumi.resources.InvokeArgs {

    public static final SiteShieldSsmap Empty = new SiteShieldSsmap();
    ...
    private SiteShieldSsmap() {}

    private SiteShieldSsmap(SiteShieldSsmap $) {
    ...
    public static Builder builder(SiteShieldSsmap defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SiteShieldSsmap defaults) {
            $ = new SiteShieldSsmap(Objects.requireNonNull(defaults));
        }
