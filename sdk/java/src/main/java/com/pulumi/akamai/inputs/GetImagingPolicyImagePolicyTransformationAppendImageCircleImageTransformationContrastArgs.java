...
public final class GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationContrastArgs build() {
            return $;
        }
    }
