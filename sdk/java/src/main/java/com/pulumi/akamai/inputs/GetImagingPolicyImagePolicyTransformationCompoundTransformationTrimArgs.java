...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationTrimArgs build() {
            return $;
        }
    }
