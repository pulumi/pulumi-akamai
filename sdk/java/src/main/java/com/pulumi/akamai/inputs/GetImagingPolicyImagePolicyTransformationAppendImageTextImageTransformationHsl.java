...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationHsl build() {
            return $;
        }
    }
