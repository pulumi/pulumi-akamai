...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration();
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration(GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorWebApplicationFirewallFirewallConfiguration build() {
            return $;
        }
    }
