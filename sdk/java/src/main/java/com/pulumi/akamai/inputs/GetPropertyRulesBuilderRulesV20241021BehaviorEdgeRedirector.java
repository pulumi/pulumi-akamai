...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirectorCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirectorCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorEdgeRedirector build() {
            return $;
        }
    }
