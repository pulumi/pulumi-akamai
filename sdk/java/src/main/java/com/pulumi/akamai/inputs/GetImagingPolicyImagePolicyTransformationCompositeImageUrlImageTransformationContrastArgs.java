...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationContrastArgs build() {
            return $;
        }
    }
