...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionLessThanRelativeCrop build() {
            return $;
        }
    }
