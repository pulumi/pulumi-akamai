...
public class AppSecConfigurationRename extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return . Unique identifier of the security configurating being renamed.
     * 
     */
     ...
     */
    public AppSecConfigurationRename(String name) {
     ...
     */
    public static AppSecConfigurationRename get(String name, Output<String> id, @Nullable AppSecConfigurationRenameState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
