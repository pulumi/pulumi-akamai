...
public final class RewriteUrl extends com.pulumi.resources.InvokeArgs {

    public static final RewriteUrl Empty = new RewriteUrl();
    ...
    public static Builder builder(RewriteUrl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RewriteUrl defaults) {
            $ = new RewriteUrl(Objects.requireNonNull(defaults));
        }
