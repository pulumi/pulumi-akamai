...
public final class GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageUrlImageTransformationAspectCropArgs build() {
            return $;
        }
    }
