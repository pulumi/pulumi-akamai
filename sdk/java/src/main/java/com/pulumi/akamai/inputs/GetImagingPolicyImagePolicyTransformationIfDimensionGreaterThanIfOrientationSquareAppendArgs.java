...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareAppendArgs build() {
