...
public final class MediaOriginFailover extends com.pulumi.resources.InvokeArgs {

    public static final MediaOriginFailover Empty = new MediaOriginFailover();
    ...
    private MediaOriginFailover(MediaOriginFailover $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MediaOriginFailover();
        }

        public Builder(MediaOriginFailover defaults) {
            $ = new MediaOriginFailover(Objects.requireNonNull(defaults));
        }
