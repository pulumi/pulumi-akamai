...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationLandscapeGoop build() {
            return $;
        }
    }
