...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionGreaterThanIfOrientationPortraitCompositeArgs build() {
