...
public final class ProviderDnsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProviderDnsArgs Empty = new ProviderDnsArgs();
    ...
    private ProviderDnsArgs() {}

    private ProviderDnsArgs(ProviderDnsArgs $) {
    ...
    public static Builder builder(ProviderDnsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ProviderDnsArgs defaults) {
            $ = new ProviderDnsArgs(Objects.requireNonNull(defaults));
        }
