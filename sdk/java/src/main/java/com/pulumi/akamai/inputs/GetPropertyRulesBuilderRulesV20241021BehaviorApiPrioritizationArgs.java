...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorageArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCodeArgs;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorageArgs> netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorageArgs>> netStorage() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCodeArgs>> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationNetStorageArgs netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode) {
         ...
         * 
         */
        public Builder throttledCpCode(GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationThrottledCpCodeArgs throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorApiPrioritizationArgs build() {
            return $;
        }
    }
