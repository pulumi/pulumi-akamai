...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerAllDownNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerFailoverOriginMap;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage;

    /**
     * @return Specifies a NetStorage account for a static maintenance page as a fallback when no origins are available.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerAllDownNetStorage> allDownNetStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps;

    /**
     * @return Specifies a fixed set of failover mapping rules.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerFailoverOriginMap>> failoverOriginMaps() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer(GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder allDownNetStorage(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage) {
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder failoverOriginMaps(@Nullable List<GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps) {
         ...
         * 
         */
        public Builder failoverOriginMaps(GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancerFailoverOriginMap... failoverOriginMaps) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorApplicationLoadBalancer build() {
            return $;
        }
    }
