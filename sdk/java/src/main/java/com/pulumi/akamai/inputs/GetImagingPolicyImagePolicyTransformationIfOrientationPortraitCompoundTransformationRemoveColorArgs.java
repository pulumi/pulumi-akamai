...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompoundTransformationRemoveColorArgs build() {
            return $;
        }
    }
