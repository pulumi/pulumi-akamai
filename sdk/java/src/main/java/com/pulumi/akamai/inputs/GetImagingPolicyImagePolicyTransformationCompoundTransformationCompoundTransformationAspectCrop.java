...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationAspectCrop build() {
            return $;
        }
    }
