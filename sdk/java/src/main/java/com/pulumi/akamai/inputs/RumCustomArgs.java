...
public final class RumCustomArgs extends com.pulumi.resources.ResourceArgs {

    public static final RumCustomArgs Empty = new RumCustomArgs();
    ...
    private RumCustomArgs() {}

    private RumCustomArgs(RumCustomArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(RumCustomArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RumCustomArgs defaults) {
            $ = new RumCustomArgs(Objects.requireNonNull(defaults));
        }
