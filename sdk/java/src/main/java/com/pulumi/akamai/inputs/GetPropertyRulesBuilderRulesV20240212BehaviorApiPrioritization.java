...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCode;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorage netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorage> netStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCode throttledCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCode> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorage netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCode throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritization build() {
            return $;
        }
    }
