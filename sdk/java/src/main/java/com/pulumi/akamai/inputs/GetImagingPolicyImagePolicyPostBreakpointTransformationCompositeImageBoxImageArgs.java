...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageBoxImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageBoxImageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageBoxImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageBoxImageTransformationArgs>> transformation() {
    ...
    public static final class Builder {
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageBoxImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyPostBreakpointTransformationCompositeImageBoxImageTransformationArgs transformation) {
