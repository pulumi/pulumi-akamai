...
public final class QuicBetaArgs extends com.pulumi.resources.ResourceArgs {

    public static final QuicBetaArgs Empty = new QuicBetaArgs();
    ...
    private QuicBetaArgs() {}

    private QuicBetaArgs(QuicBetaArgs $) {
    ...
    public static Builder builder(QuicBetaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(QuicBetaArgs defaults) {
            $ = new QuicBetaArgs(Objects.requireNonNull(defaults));
        }
