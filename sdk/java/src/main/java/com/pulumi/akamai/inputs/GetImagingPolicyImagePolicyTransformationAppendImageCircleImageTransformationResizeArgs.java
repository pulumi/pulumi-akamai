...
public final class GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationResizeArgs build() {
            return $;
        }
    }
