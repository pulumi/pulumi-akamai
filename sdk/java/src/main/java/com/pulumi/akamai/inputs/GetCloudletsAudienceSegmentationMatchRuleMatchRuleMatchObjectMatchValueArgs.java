...
public final class GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchObjectMatchValueArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The array type, which can be one of the following: object or simple or range. Use the simple option when adding only an array of string-based values
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param type The array type, which can be one of the following: object or simple or range. Use the simple option when adding only an array of string-based values
         * 
         * @return builder
         * 
         */
