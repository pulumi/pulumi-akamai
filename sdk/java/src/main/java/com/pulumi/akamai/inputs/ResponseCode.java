...
public final class ResponseCode extends com.pulumi.resources.InvokeArgs {

    public static final ResponseCode Empty = new ResponseCode();
    ...
    public static Builder builder(ResponseCode defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ResponseCode defaults) {
            $ = new ResponseCode(Objects.requireNonNull(defaults));
        }
