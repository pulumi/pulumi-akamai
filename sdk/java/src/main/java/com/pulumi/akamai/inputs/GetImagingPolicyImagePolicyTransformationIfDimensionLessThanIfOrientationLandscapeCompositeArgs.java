...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationLandscapeCompositeArgs build() {
