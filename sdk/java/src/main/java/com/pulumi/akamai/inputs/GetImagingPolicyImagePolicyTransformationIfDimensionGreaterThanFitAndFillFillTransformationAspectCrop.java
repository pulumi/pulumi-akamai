...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationAspectCrop build() {
            return $;
        }
    }
