...
import com.pulumi.akamai.inputs.PhasedReleaseCloudletPolicy;
...
public final class PhasedRelease extends com.pulumi.resources.InvokeArgs {

    public static final PhasedRelease Empty = new PhasedRelease();

    @Import(name="cloudletPolicy")
    private @Nullable PhasedReleaseCloudletPolicy cloudletPolicy;

    public Optional<PhasedReleaseCloudletPolicy> cloudletPolicy() {
    ...
    private PhasedRelease() {}

    private PhasedRelease(PhasedRelease $) {
    ...
    public static Builder builder(PhasedRelease defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PhasedRelease defaults) {
            $ = new PhasedRelease(Objects.requireNonNull(defaults));
        }

        public Builder cloudletPolicy(@Nullable PhasedReleaseCloudletPolicy cloudletPolicy) {
