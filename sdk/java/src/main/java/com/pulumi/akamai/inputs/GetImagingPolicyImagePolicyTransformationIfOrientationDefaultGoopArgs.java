...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoopArgs build() {
            return $;
        }
    }
