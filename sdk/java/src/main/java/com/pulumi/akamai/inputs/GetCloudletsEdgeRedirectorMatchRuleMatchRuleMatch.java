...
import com.pulumi.akamai.inputs.GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchObjectMatchValue;
...
public final class GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch Empty = new GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch();
     ...
     * 
     */
    public Optional<List<GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchObjectMatchValue>> objectMatchValues() {
        return Optional.ofNullable(this.objectMatchValues);
    }

    private GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch() {}

    private GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch(GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch();
        }

        public Builder(GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch defaults) {
            $ = new GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatch(Objects.requireNonNull(defaults));
        }
