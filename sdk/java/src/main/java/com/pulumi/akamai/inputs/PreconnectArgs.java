...
public final class PreconnectArgs extends com.pulumi.resources.ResourceArgs {

    public static final PreconnectArgs Empty = new PreconnectArgs();
    ...
    private PreconnectArgs() {}

    private PreconnectArgs(PreconnectArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(PreconnectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PreconnectArgs defaults) {
            $ = new PreconnectArgs(Objects.requireNonNull(defaults));
        }
