...
public final class OriginFailureRecoveryPolicy extends com.pulumi.resources.InvokeArgs {

    public static final OriginFailureRecoveryPolicy Empty = new OriginFailureRecoveryPolicy();
    ...
    private OriginFailureRecoveryPolicy(OriginFailureRecoveryPolicy $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginFailureRecoveryPolicy();
        }

        public Builder(OriginFailureRecoveryPolicy defaults) {
            $ = new OriginFailureRecoveryPolicy(Objects.requireNonNull(defaults));
        }
