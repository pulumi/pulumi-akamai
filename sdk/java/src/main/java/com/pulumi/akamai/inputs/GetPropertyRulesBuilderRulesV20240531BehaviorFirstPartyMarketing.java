...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketing build() {
            return $;
        }
    }
