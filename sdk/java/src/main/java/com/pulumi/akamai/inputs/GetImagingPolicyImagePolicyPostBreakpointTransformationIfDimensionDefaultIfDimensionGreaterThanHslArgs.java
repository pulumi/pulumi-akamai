...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionDefaultIfDimensionGreaterThanHslArgs build() {
            return $;
        }
    }
