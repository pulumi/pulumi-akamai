...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanMirrorArgs build() {
            return $;
        }
    }
