...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultUnsharpMaskArgs build() {
            return $;
        }
    }
