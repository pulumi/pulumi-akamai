...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader(GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader $) {
        this.action = $.action;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingResponseHeader(Objects.requireNonNull(defaults));
        }
