...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationDefaultGoop build() {
            return $;
        }
    }
