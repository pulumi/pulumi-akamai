...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageArgs build() {
            return $;
        }
    }
