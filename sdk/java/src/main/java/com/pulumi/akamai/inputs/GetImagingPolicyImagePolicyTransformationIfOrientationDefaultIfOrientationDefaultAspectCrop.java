...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultAspectCrop build() {
            return $;
        }
    }
