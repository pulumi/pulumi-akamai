...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentationCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentationCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation(GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentationCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorAudienceSegmentation build() {
            return $;
        }
    }
