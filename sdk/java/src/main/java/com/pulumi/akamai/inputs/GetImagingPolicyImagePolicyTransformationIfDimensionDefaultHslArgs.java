...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHslArgs build() {
            return $;
        }
    }
