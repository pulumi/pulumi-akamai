...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideoCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerVideo build() {
            return $;
        }
    }
