...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCropArgs build() {
            return $;
        }
    }
