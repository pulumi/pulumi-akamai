...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanAppendArgs build() {
