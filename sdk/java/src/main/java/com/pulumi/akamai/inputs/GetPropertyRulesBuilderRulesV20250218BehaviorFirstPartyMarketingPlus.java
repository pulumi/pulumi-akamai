...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlusCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlusCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus(GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorFirstPartyMarketingPlus build() {
            return $;
        }
    }
