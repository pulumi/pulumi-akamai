...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareAppendImageTextImage build() {
            return $;
        }
    }
