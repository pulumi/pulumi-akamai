...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorFailActionCpCodeArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorFailActionNetStorageHostnameArgs;
...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs();
    ...
    @Import(name="cpCode")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorFailActionCpCodeArgs> cpCode;

    public Optional<Output<GetPropertyRulesBuilderRulesV20231030BehaviorFailActionCpCodeArgs>> cpCode() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorFailActionNetStorageHostnameArgs> netStorageHostname;

    public Optional<Output<GetPropertyRulesBuilderRulesV20231030BehaviorFailActionNetStorageHostnameArgs>> netStorageHostname() {
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs(GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorFailActionCpCodeArgs> cpCode) {
            $.cpCode = cpCode;
            return this;
        }

        public Builder cpCode(GetPropertyRulesBuilderRulesV20231030BehaviorFailActionCpCodeArgs cpCode) {
        ...
        public Builder netStorageHostname(@Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorFailActionNetStorageHostnameArgs> netStorageHostname) {
            $.netStorageHostname = netStorageHostname;
            return this;
        }

        public Builder netStorageHostname(GetPropertyRulesBuilderRulesV20231030BehaviorFailActionNetStorageHostnameArgs netStorageHostname) {
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorFailActionArgs build() {
            return $;
        }
    }
