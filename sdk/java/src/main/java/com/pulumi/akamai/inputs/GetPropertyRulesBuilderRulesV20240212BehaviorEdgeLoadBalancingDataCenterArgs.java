...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(List<GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorEdgeLoadBalancingDataCenterArgs build() {
            return $;
        }
    }
