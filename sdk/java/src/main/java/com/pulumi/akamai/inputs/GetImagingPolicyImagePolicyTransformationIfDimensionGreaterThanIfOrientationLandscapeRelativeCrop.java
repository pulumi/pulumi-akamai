...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop $) {
        this.east = $.east;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop();
        }
        ...
        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeRelativeCrop(Objects.requireNonNull(defaults));
        }
