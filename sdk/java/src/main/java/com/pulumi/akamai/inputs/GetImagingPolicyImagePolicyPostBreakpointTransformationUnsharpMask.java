...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask(GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMask build() {
            return $;
        }
    }
