...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppendImage;
...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppendImage image;

    public GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppendImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppendImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationIfOrientationDefaultAppend build() {
