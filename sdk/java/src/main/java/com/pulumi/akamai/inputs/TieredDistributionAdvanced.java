...
public final class TieredDistributionAdvanced extends com.pulumi.resources.InvokeArgs {

    public static final TieredDistributionAdvanced Empty = new TieredDistributionAdvanced();
    ...
    private TieredDistributionAdvanced() {}

    private TieredDistributionAdvanced(TieredDistributionAdvanced $) {
    ...
    public static Builder builder(TieredDistributionAdvanced defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TieredDistributionAdvanced();
        }

        public Builder(TieredDistributionAdvanced defaults) {
            $ = new TieredDistributionAdvanced(Objects.requireNonNull(defaults));
        }
        ...
        public TieredDistributionAdvanced build() {
            return $;
        }
    }
