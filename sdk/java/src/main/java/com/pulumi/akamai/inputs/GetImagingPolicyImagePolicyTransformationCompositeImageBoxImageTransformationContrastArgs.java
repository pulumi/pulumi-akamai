...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationContrastArgs build() {
            return $;
        }
    }
