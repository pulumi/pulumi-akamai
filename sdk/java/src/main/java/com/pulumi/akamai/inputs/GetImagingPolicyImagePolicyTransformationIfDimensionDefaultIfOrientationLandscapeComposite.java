...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeCompositeImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeCompositeImage image;

    public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeCompositeImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeCompositeImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfOrientationLandscapeComposite build() {
