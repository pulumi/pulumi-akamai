...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeHsl build() {
            return $;
        }
    }
