...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable Output<List<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(List<GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterArgs build() {
            return $;
        }
    }
