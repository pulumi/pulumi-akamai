...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfOrientationSquareIfOrientationPortraitChromaKey build() {
            return $;
        }
    }
