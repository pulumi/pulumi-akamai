...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthorityIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthoritySubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthorityIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthoritySubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority(GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorOriginCustomCertificateAuthority build() {
            return $;
        }
    }
