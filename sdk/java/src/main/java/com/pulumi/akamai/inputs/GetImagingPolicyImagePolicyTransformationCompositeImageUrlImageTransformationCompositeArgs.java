...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageUrlImageTransformationCompositeArgs build() {
