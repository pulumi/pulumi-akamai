...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAspectCropArgs build() {
            return $;
        }
    }
