...
public final class GetCloudletsSharedPolicyActivationsStagingEffectiveArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCloudletsSharedPolicyActivationsStagingEffectiveArgs Empty = new GetCloudletsSharedPolicyActivationsStagingEffectiveArgs();
    ...
    private GetCloudletsSharedPolicyActivationsStagingEffectiveArgs() {}

    private GetCloudletsSharedPolicyActivationsStagingEffectiveArgs(GetCloudletsSharedPolicyActivationsStagingEffectiveArgs $) {
    ...
    public static Builder builder(GetCloudletsSharedPolicyActivationsStagingEffectiveArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsSharedPolicyActivationsStagingEffectiveArgs();
        }

        public Builder(GetCloudletsSharedPolicyActivationsStagingEffectiveArgs defaults) {
            $ = new GetCloudletsSharedPolicyActivationsStagingEffectiveArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCloudletsSharedPolicyActivationsStagingEffectiveArgs build() {
            if ($.activationId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "activationId");
            }
            if ($.createdBy == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "createdBy");
            }
            if ($.createdDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "createdDate");
            }
            if ($.finishDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "finishDate");
            }
            if ($.network == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "network");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "operation");
            }
            if ($.policyId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "policyId");
            }
            if ($.policyVersion == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "policyVersion");
            }
            if ($.policyVersionDeleted == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "policyVersionDeleted");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingEffectiveArgs", "status");
            }
            return $;
        }
    }
