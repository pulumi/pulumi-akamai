...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlusCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlusCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus(GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlusCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingPlus build() {
            return $;
        }
    }
