...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanGoop build() {
            return $;
        }
    }
