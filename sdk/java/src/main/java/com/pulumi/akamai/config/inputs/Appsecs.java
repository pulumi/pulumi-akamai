...
public final class Appsecs {
    ...
    public static Builder builder(Appsecs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Appsecs defaults) {
        ...
        public Builder maxBody(@Nullable Integer maxBody) {
            this.maxBody = maxBody;
            return this;
        }        public Appsecs build() {
            return new Appsecs(accessToken, accountKey, clientSecret, clientToken, host, maxBody);
        }
    }
}
