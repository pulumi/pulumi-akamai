...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorImageManager extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorImageManager Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManager();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManager() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorImageManager(GetPropertyRulesBuilderRulesV20240813BehaviorImageManager $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManager defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManager();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorImageManager defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorImageManager(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorImageManagerCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorImageManager build() {
            return $;
        }
    }
