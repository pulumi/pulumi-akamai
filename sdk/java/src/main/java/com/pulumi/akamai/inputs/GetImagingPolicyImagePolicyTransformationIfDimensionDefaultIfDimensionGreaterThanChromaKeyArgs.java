...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionGreaterThanChromaKeyArgs build() {
            return $;
        }
    }
