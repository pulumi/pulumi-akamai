...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite(GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewriteCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorForwardRewrite build() {
            return $;
        }
    }
