...
public final class SaasDefinitions extends com.pulumi.resources.InvokeArgs {

    public static final SaasDefinitions Empty = new SaasDefinitions();
    ...
    private SaasDefinitions() {}

    private SaasDefinitions(SaasDefinitions $) {
    ...
    public static Builder builder(SaasDefinitions defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SaasDefinitions defaults) {
            $ = new SaasDefinitions(Objects.requireNonNull(defaults));
        }
