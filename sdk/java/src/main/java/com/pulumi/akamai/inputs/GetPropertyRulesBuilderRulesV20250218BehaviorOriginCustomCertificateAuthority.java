...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthoritySubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthoritySubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateAuthority build() {
            return $;
        }
    }
