...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualCompositeArgs build() {
