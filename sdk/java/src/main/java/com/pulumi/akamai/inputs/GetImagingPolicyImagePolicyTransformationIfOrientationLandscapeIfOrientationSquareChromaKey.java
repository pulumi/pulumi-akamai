...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationSquareChromaKey build() {
            return $;
        }
    }
