...
public final class GetGtmDomainResourceResourceInstanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetGtmDomainResourceResourceInstanceArgs Empty = new GetGtmDomainResourceResourceInstanceArgs();
    ...
    private GetGtmDomainResourceResourceInstanceArgs() {}

    private GetGtmDomainResourceResourceInstanceArgs(GetGtmDomainResourceResourceInstanceArgs $) {
    ...
    public static Builder builder(GetGtmDomainResourceResourceInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGtmDomainResourceResourceInstanceArgs();
        }

        public Builder(GetGtmDomainResourceResourceInstanceArgs defaults) {
            $ = new GetGtmDomainResourceResourceInstanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGtmDomainResourceResourceInstanceArgs build() {
            if ($.datacenterId == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstanceArgs", "datacenterId");
            }
            if ($.loadObject == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstanceArgs", "loadObject");
            }
            if ($.loadObjectPort == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstanceArgs", "loadObjectPort");
            }
            if ($.loadServers == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstanceArgs", "loadServers");
            }
            if ($.useDefaultLoadObject == null) {
                throw new MissingRequiredPropertyException("GetGtmDomainResourceResourceInstanceArgs", "useDefaultLoadObject");
            }
            return $;
        }
    }
