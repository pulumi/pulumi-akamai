...
public final class SetVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final SetVariableArgs Empty = new SetVariableArgs();
    ...
    private SetVariableArgs() {}

    private SetVariableArgs(SetVariableArgs $) {
    ...
    public static Builder builder(SetVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SetVariableArgs defaults) {
            $ = new SetVariableArgs(Objects.requireNonNull(defaults));
        }
