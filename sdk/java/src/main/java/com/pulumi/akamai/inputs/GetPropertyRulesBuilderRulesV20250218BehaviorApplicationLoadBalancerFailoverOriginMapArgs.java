...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs(GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorApplicationLoadBalancerFailoverOriginMapArgs build() {
            return $;
        }
    }
