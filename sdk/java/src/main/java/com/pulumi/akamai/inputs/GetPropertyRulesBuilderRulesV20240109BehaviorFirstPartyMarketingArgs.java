...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingArgs build() {
            return $;
        }
    }
