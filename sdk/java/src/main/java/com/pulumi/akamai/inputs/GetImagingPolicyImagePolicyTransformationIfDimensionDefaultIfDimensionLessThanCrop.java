...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultIfDimensionLessThanCrop build() {
            return $;
        }
    }
