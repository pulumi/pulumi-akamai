...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageArgs build() {
            return $;
        }
    }
