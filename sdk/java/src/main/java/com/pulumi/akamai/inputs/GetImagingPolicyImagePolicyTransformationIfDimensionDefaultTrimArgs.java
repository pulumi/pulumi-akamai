...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultTrimArgs build() {
            return $;
        }
    }
