...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationHsvArgs build() {
            return $;
        }
    }
