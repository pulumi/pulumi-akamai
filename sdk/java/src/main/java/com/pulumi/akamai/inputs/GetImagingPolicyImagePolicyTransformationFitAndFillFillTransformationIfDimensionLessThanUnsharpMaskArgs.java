...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionLessThanUnsharpMaskArgs build() {
            return $;
        }
    }
