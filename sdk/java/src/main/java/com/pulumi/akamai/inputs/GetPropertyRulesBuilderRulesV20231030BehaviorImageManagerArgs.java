...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal;

    public Optional<Output<GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeOriginalArgs>> cpCodeOriginal() {
        return Optional.ofNullable(this.cpCodeOriginal);
    }

    @Import(name="cpCodeTransformed")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed;

    public Optional<Output<GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs(GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal) {
            $.cpCodeOriginal = cpCodeOriginal;
            return this;
        }

        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeOriginalArgs cpCodeOriginal) {
            return cpCodeOriginal(Output.of(cpCodeOriginal));
        }

        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed) {
            $.cpCodeTransformed = cpCodeTransformed;
            return this;
        }

        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorImageManagerArgs build() {
            return $;
        }
    }
