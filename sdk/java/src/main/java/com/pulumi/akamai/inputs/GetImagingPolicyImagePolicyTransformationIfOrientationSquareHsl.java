...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsl build() {
            return $;
        }
    }
