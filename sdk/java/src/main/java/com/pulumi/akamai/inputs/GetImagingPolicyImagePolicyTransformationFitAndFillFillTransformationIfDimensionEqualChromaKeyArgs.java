...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionEqualChromaKeyArgs build() {
            return $;
        }
    }
