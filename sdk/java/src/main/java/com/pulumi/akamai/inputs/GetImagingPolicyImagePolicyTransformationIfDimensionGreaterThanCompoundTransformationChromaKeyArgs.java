...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompoundTransformationChromaKeyArgs build() {
            return $;
        }
    }
