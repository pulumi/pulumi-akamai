...
public final class Networks {
    ...
    public static Builder builder(Networks defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Networks defaults) {
        ...
        public Builder maxBody(@Nullable Integer maxBody) {
            ...
            return new Networks(accessToken, accountKey, clientSecret, clientToken, host, maxBody);
        }
    }
}
