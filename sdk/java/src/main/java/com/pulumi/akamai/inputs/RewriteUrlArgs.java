...
public final class RewriteUrlArgs extends com.pulumi.resources.ResourceArgs {

    public static final RewriteUrlArgs Empty = new RewriteUrlArgs();
    ...
    private RewriteUrlArgs() {}

    private RewriteUrlArgs(RewriteUrlArgs $) {
    ...
    public static Builder builder(RewriteUrlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RewriteUrlArgs defaults) {
            $ = new RewriteUrlArgs(Objects.requireNonNull(defaults));
        }
