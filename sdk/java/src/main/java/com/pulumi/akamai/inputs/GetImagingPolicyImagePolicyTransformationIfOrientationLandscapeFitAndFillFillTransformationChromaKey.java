...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeFitAndFillFillTransformationChromaKey build() {
            return $;
        }
    }
