...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitAspectCrop build() {
            return $;
        }
    }
