...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualAppendArgs build() {
