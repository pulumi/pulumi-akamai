...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualMirrorArgs build() {
            return $;
        }
    }
