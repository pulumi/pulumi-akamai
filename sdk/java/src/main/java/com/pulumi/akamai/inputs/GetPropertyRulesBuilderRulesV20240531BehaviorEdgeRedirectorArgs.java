...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorArgs build() {
            return $;
        }
    }
