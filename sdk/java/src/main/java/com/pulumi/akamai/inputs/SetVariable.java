...
public final class SetVariable extends com.pulumi.resources.InvokeArgs {

    public static final SetVariable Empty = new SetVariable();
    ...
    public static Builder builder(SetVariable defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SetVariable defaults) {
            $ = new SetVariable(Objects.requireNonNull(defaults));
        }
