...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs $) {
        this.xShear = $.xShear;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeShearsArgs build() {
            return $;
        }
    }
