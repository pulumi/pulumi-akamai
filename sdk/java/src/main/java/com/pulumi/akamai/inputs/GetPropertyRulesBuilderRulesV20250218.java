...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218Behavior;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218Criterion;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218CustomOverride;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218Variable;
...
public final class GetPropertyRulesBuilderRulesV20250218 extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218 Empty = new GetPropertyRulesBuilderRulesV20250218();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250218Behavior> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250218Behavior>> behaviors() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250218Criterion> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250218Criterion>> criterions() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218CustomOverride customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218CustomOverride> customOverride() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250218Variable> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250218Variable>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20250218() {}

    private GetPropertyRulesBuilderRulesV20250218(GetPropertyRulesBuilderRulesV20250218 $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218 defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable List<GetPropertyRulesBuilderRulesV20250218Behavior> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20250218Behavior... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable List<GetPropertyRulesBuilderRulesV20250218Criterion> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20250218Criterion... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable GetPropertyRulesBuilderRulesV20250218CustomOverride customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable List<GetPropertyRulesBuilderRulesV20250218Variable> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20250218Variable... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20250218 build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20250218", "name");
            }
            return $;
        }
    }
