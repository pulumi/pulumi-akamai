...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationRelativeCrop build() {
            return $;
        }
    }
