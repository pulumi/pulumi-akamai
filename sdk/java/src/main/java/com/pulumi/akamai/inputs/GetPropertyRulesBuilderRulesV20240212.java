...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212Behavior;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212Criterion;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212CustomOverride;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212Variable;
...
public final class GetPropertyRulesBuilderRulesV20240212 extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212 Empty = new GetPropertyRulesBuilderRulesV20240212();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240212Behavior> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240212Behavior>> behaviors() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240212Criterion> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240212Criterion>> criterions() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212CustomOverride customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212CustomOverride> customOverride() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240212Variable> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240212Variable>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20240212() {}

    private GetPropertyRulesBuilderRulesV20240212(GetPropertyRulesBuilderRulesV20240212 $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212 defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable List<GetPropertyRulesBuilderRulesV20240212Behavior> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20240212Behavior... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable List<GetPropertyRulesBuilderRulesV20240212Criterion> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20240212Criterion... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable GetPropertyRulesBuilderRulesV20240212CustomOverride customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable List<GetPropertyRulesBuilderRulesV20240212Variable> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20240212Variable... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20240212 build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20240212", "name");
            }
            return $;
        }
    }
