...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs();
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs build() {
            return $;
        }
    }
