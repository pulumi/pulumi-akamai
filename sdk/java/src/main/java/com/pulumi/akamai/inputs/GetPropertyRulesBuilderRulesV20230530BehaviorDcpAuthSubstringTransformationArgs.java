...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs(GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorDcpAuthSubstringTransformationArgs build() {
            return $;
        }
    }
