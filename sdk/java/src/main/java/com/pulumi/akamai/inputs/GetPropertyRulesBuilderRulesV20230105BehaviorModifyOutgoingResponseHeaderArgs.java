...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs();
    ...
    /**
     * @return Either `ADD` or `DELETE` outgoing HTTP response headers, `MODIFY` their fixed values, or specify a `REGEX` pattern to transform them.
     * 
     */
    ...
    /**
     * @return When enabled with the `action` set to `MODIFY`, prevents creation of more than one instance of a header. The last header clobbers others with the same name. This option affects the entire set of outgoing headers, and is not confined to the subset of regular expression matches.
     * 
     */
    ...
    /**
     * @return Specifies the existing value of the header to match.
     * 
     */
    ...
    /**
     * @return Specifies the new HTTP header replacement value.
     * 
     */
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs(GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param action Either `ADD` or `DELETE` outgoing HTTP response headers, `MODIFY` their fixed values, or specify a `REGEX` pattern to transform them.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param avoidDuplicateHeaders When enabled with the `action` set to `MODIFY`, prevents creation of more than one instance of a header. The last header clobbers others with the same name. This option affects the entire set of outgoing headers, and is not confined to the subset of regular expression matches.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param headerValue Specifies the existing value of the header to match.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param newHeaderValue Specifies the new HTTP header replacement value.
         * 
         * @return builder
         * 
         */
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeaderArgs build() {
            return $;
        }
    }
