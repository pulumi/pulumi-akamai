...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs $) {
        this.xShear = $.xShear;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareShearsArgs build() {
            return $;
        }
    }
