...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsl build() {
            return $;
        }
    }
