...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218CriterionArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218CustomOverrideArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218VariableArgs;
...
public final class GetPropertyRulesBuilderRulesV20250218Args extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20250218Args Empty = new GetPropertyRulesBuilderRulesV20250218Args();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorArgs>> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorArgs>>> behaviors() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250218CriterionArgs>> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250218CriterionArgs>>> criterions() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20250218CustomOverrideArgs> customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20250218CustomOverrideArgs>> customOverride() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20250218VariableArgs>> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20250218VariableArgs>>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20250218Args() {}

    private GetPropertyRulesBuilderRulesV20250218Args(GetPropertyRulesBuilderRulesV20250218Args $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218Args();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218Args defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250218BehaviorArgs>> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(List<GetPropertyRulesBuilderRulesV20250218BehaviorArgs> behaviors) {
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20250218BehaviorArgs... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250218CriterionArgs>> criterions) {
         ...
         * 
         */
        public Builder criterions(List<GetPropertyRulesBuilderRulesV20250218CriterionArgs> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20250218CriterionArgs... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable Output<GetPropertyRulesBuilderRulesV20250218CustomOverrideArgs> customOverride) {
         ...
         * 
         */
        public Builder customOverride(GetPropertyRulesBuilderRulesV20250218CustomOverrideArgs customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable Output<List<GetPropertyRulesBuilderRulesV20250218VariableArgs>> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(List<GetPropertyRulesBuilderRulesV20250218VariableArgs> variables) {
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20250218VariableArgs... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20250218Args build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20250218Args", "name");
            }
            return $;
        }
    }
