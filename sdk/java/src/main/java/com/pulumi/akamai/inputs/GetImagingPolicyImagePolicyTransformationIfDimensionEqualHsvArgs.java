...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsvArgs build() {
            return $;
        }
    }
