...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionEqualAppendArgs build() {
