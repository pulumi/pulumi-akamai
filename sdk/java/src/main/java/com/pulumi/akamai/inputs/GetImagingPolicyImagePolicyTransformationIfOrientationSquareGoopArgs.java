...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareGoopArgs build() {
            return $;
        }
    }
