...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthorityIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthoritySubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthorityIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthoritySubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority(GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorOriginCustomCertificateAuthority build() {
            return $;
        }
    }
