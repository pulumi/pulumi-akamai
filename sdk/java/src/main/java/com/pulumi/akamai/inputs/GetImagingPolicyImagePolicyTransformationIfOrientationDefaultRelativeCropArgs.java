...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultRelativeCropArgs build() {
            return $;
        }
    }
