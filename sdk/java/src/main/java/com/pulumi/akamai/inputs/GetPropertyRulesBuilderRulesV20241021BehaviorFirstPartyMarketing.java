...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketing build() {
            return $;
        }
    }
