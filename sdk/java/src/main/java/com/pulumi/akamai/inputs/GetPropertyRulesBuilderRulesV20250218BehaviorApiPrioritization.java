...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationThrottledCpCode;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationNetStorage netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationNetStorage> netStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationThrottledCpCode throttledCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationThrottledCpCode> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization(GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationNetStorage netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritizationThrottledCpCode throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorApiPrioritization build() {
            return $;
        }
    }
