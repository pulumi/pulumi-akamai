...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorFirstPartyMarketing build() {
            return $;
        }
    }
