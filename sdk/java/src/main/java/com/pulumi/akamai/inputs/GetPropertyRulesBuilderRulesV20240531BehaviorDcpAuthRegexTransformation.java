...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation(GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorDcpAuthRegexTransformation build() {
            return $;
        }
    }
