...
public final class Redirect extends com.pulumi.resources.InvokeArgs {

    public static final Redirect Empty = new Redirect();
    ...
    public static final class Builder {
        ...
        public Builder(Redirect defaults) {
            $ = new Redirect(Objects.requireNonNull(defaults));
        }
