...
public final class StandardTlsMigrationArgs extends com.pulumi.resources.ResourceArgs {

    public static final StandardTlsMigrationArgs Empty = new StandardTlsMigrationArgs();
    ...
    private StandardTlsMigrationArgs() {}

    private StandardTlsMigrationArgs(StandardTlsMigrationArgs $) {
    ...
    public static Builder builder(StandardTlsMigrationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StandardTlsMigrationArgs();
        }

        public Builder(StandardTlsMigrationArgs defaults) {
            $ = new StandardTlsMigrationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StandardTlsMigrationArgs build() {
            return $;
        }
    }
