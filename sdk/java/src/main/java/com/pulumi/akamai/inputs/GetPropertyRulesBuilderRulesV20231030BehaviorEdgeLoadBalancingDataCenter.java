...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule;
...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable List<GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenterFailoverRule... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorEdgeLoadBalancingDataCenter build() {
            return $;
        }
    }
