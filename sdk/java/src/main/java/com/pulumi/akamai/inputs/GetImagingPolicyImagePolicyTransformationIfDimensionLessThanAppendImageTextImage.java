...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanAppendImageTextImage build() {
            return $;
        }
    }
