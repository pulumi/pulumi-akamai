...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionDefaultResizeArgs build() {
            return $;
        }
    }
