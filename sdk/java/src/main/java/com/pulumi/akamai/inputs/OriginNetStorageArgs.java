...
public final class OriginNetStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final OriginNetStorageArgs Empty = new OriginNetStorageArgs();
    ...
    private OriginNetStorageArgs() {}

    private OriginNetStorageArgs(OriginNetStorageArgs $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(OriginNetStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginNetStorageArgs();
        }

        public Builder(OriginNetStorageArgs defaults) {
            $ = new OriginNetStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OriginNetStorageArgs build() {
            return $;
        }
    }
