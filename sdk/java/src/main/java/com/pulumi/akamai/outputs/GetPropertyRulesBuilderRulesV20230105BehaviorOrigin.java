...
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificate;
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthority;
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorOrigin {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorOrigin build() {
            final var o = new GetPropertyRulesBuilderRulesV20230105BehaviorOrigin();
            o.cacheKeyHostname = cacheKeyHostname;
            o.compress = compress;
            o.customCertificateAuthorities = customCertificateAuthorities;
            o.customCertificates = customCertificates;
            o.customForwardHostHeader = customForwardHostHeader;
            o.customValidCnValues = customValidCnValues;
            o.enableTrueClientIp = enableTrueClientIp;
            o.forwardHostHeader = forwardHostHeader;
            o.hostname = hostname;
            o.httpPort = httpPort;
            o.httpsPort = httpsPort;
            o.ipVersion = ipVersion;
            o.locked = locked;
            o.mslorigin = mslorigin;
            o.netStorage = netStorage;
            o.originCertificate = originCertificate;
            o.originCertsToHonor = originCertsToHonor;
            o.originId = originId;
            o.originSni = originSni;
            o.originType = originType;
            o.ports = ports;
            o.saasCnameEnabled = saasCnameEnabled;
            o.saasCnameLevel = saasCnameLevel;
            o.saasCookie = saasCookie;
            o.saasQueryString = saasQueryString;
            o.saasRegex = saasRegex;
            o.saasReplace = saasReplace;
            o.saasSuffix = saasSuffix;
            o.saasType = saasType;
            o.secondHostname = secondHostname;
            o.secondHostnameEnabled = secondHostnameEnabled;
            o.standardCertificateAuthorities = standardCertificateAuthorities;
            o.templateUuid = templateUuid;
            o.trueClientIpClientSetting = trueClientIpClientSetting;
            o.trueClientIpHeader = trueClientIpHeader;
            o.useUniqueCacheKey = useUniqueCacheKey;
            o.uuid = uuid;
            o.verificationMode = verificationMode;
            return o;
        }
    }
}
