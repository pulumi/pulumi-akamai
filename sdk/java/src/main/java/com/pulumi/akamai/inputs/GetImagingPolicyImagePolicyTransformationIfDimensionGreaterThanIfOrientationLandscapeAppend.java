...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppendImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppendImage image;

    public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppendImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppendImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationLandscapeAppend build() {
