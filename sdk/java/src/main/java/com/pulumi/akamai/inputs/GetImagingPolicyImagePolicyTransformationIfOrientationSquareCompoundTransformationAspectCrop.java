...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationAspectCrop build() {
            return $;
        }
    }
