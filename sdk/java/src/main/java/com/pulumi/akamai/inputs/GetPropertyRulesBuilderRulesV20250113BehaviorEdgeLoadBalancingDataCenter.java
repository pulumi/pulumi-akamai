...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable List<GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenter build() {
            return $;
        }
    }
