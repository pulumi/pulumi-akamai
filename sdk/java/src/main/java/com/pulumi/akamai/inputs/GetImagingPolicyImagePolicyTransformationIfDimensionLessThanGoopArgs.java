...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoopArgs build() {
            return $;
        }
    }
