...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorFirstPartyMarketingArgs build() {
            return $;
        }
    }
