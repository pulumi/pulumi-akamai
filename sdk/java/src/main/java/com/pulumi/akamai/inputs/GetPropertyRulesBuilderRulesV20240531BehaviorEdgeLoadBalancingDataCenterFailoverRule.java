...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule();
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorEdgeLoadBalancingDataCenterFailoverRule build() {
            return $;
        }
    }
