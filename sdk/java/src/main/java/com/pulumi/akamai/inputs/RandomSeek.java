...
public final class RandomSeek extends com.pulumi.resources.InvokeArgs {

    public static final RandomSeek Empty = new RandomSeek();
    ...
    public static Builder builder(RandomSeek defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RandomSeek defaults) {
            $ = new RandomSeek(Objects.requireNonNull(defaults));
        }
