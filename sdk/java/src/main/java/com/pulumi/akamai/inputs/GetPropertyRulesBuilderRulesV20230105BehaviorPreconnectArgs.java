...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs(GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorPreconnectArgs build() {
            return $;
        }
    }
