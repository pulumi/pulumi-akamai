...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs(GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingArgs build() {
            return $;
        }
    }
