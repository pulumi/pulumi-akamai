...
public final class GetCloudletsSharedPolicyActivationsProductionEffective extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsSharedPolicyActivationsProductionEffective Empty = new GetCloudletsSharedPolicyActivationsProductionEffective();
    ...
    private GetCloudletsSharedPolicyActivationsProductionEffective(GetCloudletsSharedPolicyActivationsProductionEffective $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsSharedPolicyActivationsProductionEffective();
        }

        public Builder(GetCloudletsSharedPolicyActivationsProductionEffective defaults) {
            $ = new GetCloudletsSharedPolicyActivationsProductionEffective(Objects.requireNonNull(defaults));
        }
