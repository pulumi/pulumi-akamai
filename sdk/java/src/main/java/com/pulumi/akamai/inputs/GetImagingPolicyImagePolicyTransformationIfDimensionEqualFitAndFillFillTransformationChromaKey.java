...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey(GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualFitAndFillFillTransformationChromaKey build() {
            return $;
        }
    }
