...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanContrastArgs build() {
            return $;
        }
    }
