...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewriteCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewriteCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewriteCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite(GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewriteCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorForwardRewrite build() {
            return $;
        }
    }
