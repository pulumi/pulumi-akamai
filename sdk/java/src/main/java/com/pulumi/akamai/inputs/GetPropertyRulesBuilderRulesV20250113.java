...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113Behavior;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113Criterion;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113CustomOverride;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113Variable;
...
public final class GetPropertyRulesBuilderRulesV20250113 extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113 Empty = new GetPropertyRulesBuilderRulesV20250113();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250113Behavior> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250113Behavior>> behaviors() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250113Criterion> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250113Criterion>> criterions() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113CustomOverride customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113CustomOverride> customOverride() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250113Variable> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250113Variable>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20250113() {}

    private GetPropertyRulesBuilderRulesV20250113(GetPropertyRulesBuilderRulesV20250113 $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113 defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable List<GetPropertyRulesBuilderRulesV20250113Behavior> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20250113Behavior... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable List<GetPropertyRulesBuilderRulesV20250113Criterion> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20250113Criterion... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable GetPropertyRulesBuilderRulesV20250113CustomOverride customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable List<GetPropertyRulesBuilderRulesV20250113Variable> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20250113Variable... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20250113 build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20250113", "name");
            }
            return $;
        }
    }
