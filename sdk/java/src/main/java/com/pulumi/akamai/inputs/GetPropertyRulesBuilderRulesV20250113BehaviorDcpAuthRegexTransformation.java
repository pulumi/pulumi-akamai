...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation(GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorDcpAuthRegexTransformation build() {
            return $;
        }
    }
