...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationCompoundTransformationHslArgs build() {
            return $;
        }
    }
