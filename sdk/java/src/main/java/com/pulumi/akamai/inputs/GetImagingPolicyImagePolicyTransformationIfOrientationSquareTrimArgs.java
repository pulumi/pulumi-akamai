...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareTrimArgs build() {
            return $;
        }
    }
