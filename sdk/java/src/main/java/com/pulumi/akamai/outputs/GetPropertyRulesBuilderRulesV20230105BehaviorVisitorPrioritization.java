...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritization {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritization build() {
            final var o = new GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritization();
            o.allowedUserCookieAdvanced = allowedUserCookieAdvanced;
            o.allowedUserCookieAutomaticSalt = allowedUserCookieAutomaticSalt;
            o.allowedUserCookieDomain = allowedUserCookieDomain;
            o.allowedUserCookieDomainType = allowedUserCookieDomainType;
            o.allowedUserCookieDuration = allowedUserCookieDuration;
            o.allowedUserCookieEnabled = allowedUserCookieEnabled;
            o.allowedUserCookieHttpOnly = allowedUserCookieHttpOnly;
            o.allowedUserCookieLabel = allowedUserCookieLabel;
            o.allowedUserCookieManagementTitle = allowedUserCookieManagementTitle;
            o.allowedUserCookieRefresh = allowedUserCookieRefresh;
            o.allowedUserCookieSalt = allowedUserCookieSalt;
            ...
            o.uuid = uuid;
            o.waitingRoomCacheTtl = waitingRoomCacheTtl;
            o.waitingRoomCookieAdvanced = waitingRoomCookieAdvanced;
            o.waitingRoomCookieAutomaticSalt = waitingRoomCookieAutomaticSalt;
            o.waitingRoomCookieDomain = waitingRoomCookieDomain;
            o.waitingRoomCookieDomainType = waitingRoomCookieDomainType;
            o.waitingRoomCookieDuration = waitingRoomCookieDuration;
            o.waitingRoomCookieEnabled = waitingRoomCookieEnabled;
            o.waitingRoomCookieHttpOnly = waitingRoomCookieHttpOnly;
            o.waitingRoomCookieLabel = waitingRoomCookieLabel;
            o.waitingRoomCookieManagementTitle = waitingRoomCookieManagementTitle;
            o.waitingRoomCookieSalt = waitingRoomCookieSalt;
            o.waitingRoomCookieShareLabel = waitingRoomCookieShareLabel;
            o.waitingRoomCpCode = waitingRoomCpCode;
            o.waitingRoomDirectory = waitingRoomDirectory;
            o.waitingRoomManagementTitle = waitingRoomManagementTitle;
            o.waitingRoomNetStorage = waitingRoomNetStorage;
            o.waitingRoomStatusCode = waitingRoomStatusCode;
            o.waitingRoomUseCpCode = waitingRoomUseCpCode;
            return o;
        }
    }
}
