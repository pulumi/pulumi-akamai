...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationLandscapeCompositeArgs build() {
