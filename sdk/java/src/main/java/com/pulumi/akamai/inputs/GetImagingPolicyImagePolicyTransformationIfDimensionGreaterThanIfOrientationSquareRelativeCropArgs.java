...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfOrientationSquareRelativeCropArgs build() {
            return $;
        }
    }
