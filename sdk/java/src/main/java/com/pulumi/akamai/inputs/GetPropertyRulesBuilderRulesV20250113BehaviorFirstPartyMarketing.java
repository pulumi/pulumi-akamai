...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing(GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketingCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorFirstPartyMarketing build() {
            return $;
        }
    }
