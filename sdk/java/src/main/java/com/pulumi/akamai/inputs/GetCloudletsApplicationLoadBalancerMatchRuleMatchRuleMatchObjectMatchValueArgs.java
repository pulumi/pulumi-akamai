...
import com.pulumi.akamai.inputs.GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptionsArgs;
...
public final class GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs Empty = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs();
     ...
     */
    @Import(name="options")
    private @Nullable Output<GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptionsArgs> options;

    /**
     * @return If using the object type, use this set to list the values to match on (use only with the object type)
     * 
     */
    public Optional<Output<GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptionsArgs>> options() {
    ...
    private GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs() {}

    private GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs();
        }

        public Builder(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs defaults) {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder options(@Nullable Output<GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptionsArgs> options) {
            $.options = options;
            return this;
        }
         ...
         * 
         */
        public Builder options(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptionsArgs options) {
            return options(Output.of(options));
        }

        /**
         * @param type The array type, which can be one of the following: object, range, or simple. Use the simple option when adding only an array of string-based values
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param values The value attributes in the incoming request to match on (use only with simple or range type)
         * 
         * @return builder
         * 
         */
        ...
        public GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueArgs", "type");
            }
            return $;
        }
    }
