...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorFirstPartyMarketingPlusArgs build() {
            return $;
        }
    }
