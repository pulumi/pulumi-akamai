...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultResizeArgs build() {
            return $;
        }
    }
