...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerAllDownNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMap;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage;

    /**
     * @return Specifies a NetStorage account for a static maintenance page as a fallback when no origins are available.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerAllDownNetStorage> allDownNetStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps;

    /**
     * @return Specifies a fixed set of failover mapping rules.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMap>> failoverOriginMaps() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer(GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder allDownNetStorage(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage) {
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder failoverOriginMaps(@Nullable List<GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps) {
         ...
         * 
         */
        public Builder failoverOriginMaps(GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMap... failoverOriginMaps) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancer build() {
            return $;
        }
    }
