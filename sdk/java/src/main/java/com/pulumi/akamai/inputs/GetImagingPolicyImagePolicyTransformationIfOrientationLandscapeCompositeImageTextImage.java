...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeCompositeImageTextImage build() {
            return $;
        }
    }
