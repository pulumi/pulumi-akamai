...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareAspectCrop build() {
            return $;
        }
    }
