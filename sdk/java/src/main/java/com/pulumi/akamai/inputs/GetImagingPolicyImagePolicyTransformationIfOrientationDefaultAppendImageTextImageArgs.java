...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultAppendImageTextImageArgs build() {
            return $;
        }
    }
