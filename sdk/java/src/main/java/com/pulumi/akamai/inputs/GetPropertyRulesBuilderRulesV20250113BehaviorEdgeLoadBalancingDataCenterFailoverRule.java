...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule();
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorEdgeLoadBalancingDataCenterFailoverRule build() {
            return $;
        }
    }
