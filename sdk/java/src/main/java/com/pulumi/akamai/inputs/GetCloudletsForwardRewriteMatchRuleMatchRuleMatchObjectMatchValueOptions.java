...
public final class GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions Empty = new GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions();
    ...
    private GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions(GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions();
        }

        public Builder(GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions defaults) {
            $ = new GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValueOptions(Objects.requireNonNull(defaults));
        }
