...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitTrimArgs build() {
            return $;
        }
    }
