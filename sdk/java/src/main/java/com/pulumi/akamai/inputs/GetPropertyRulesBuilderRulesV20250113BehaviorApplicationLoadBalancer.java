...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerFailoverOriginMap;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage;

    /**
     * @return Specifies a NetStorage account for a static maintenance page as a fallback when no origins are available.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage> allDownNetStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps;

    /**
     * @return Specifies a fixed set of failover mapping rules.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerFailoverOriginMap>> failoverOriginMaps() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer(GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder allDownNetStorage(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage) {
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder failoverOriginMaps(@Nullable List<GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps) {
         ...
         * 
         */
        public Builder failoverOriginMaps(GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancerFailoverOriginMap... failoverOriginMaps) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorApplicationLoadBalancer build() {
            return $;
        }
    }
