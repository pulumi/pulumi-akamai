...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropRegionOfInterestArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropRegionOfInterestArgs> regionOfInterest;

    public Output<GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropRegionOfInterestArgs> regionOfInterest() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder regionOfInterest(Output<GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropRegionOfInterestArgs> regionOfInterest) {
            $.regionOfInterest = regionOfInterest;
            return this;
        }

        public Builder regionOfInterest(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropRegionOfInterestArgs regionOfInterest) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRegionOfInterestCropArgs build() {
