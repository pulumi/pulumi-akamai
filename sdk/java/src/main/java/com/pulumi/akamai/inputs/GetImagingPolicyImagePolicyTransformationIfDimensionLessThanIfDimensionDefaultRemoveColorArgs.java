...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfDimensionDefaultRemoveColorArgs build() {
            return $;
        }
    }
