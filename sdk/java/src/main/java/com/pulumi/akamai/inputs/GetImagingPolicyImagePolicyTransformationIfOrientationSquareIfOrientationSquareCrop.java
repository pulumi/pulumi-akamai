...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationSquareCrop build() {
            return $;
        }
    }
