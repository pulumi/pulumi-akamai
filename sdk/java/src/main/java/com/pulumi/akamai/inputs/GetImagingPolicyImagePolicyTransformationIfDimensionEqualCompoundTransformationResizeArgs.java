...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationResizeArgs build() {
            return $;
        }
    }
