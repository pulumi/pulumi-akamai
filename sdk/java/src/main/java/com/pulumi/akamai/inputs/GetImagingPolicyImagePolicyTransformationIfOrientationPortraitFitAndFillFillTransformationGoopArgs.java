...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitFitAndFillFillTransformationGoopArgs build() {
            return $;
        }
    }
