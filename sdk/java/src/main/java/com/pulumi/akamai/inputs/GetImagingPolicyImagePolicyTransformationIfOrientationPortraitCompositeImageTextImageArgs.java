...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitCompositeImageTextImageArgs build() {
            return $;
        }
    }
