...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeChromaKey build() {
            return $;
        }
    }
