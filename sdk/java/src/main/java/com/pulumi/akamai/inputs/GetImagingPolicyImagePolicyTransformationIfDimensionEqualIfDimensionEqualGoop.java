...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionEqualGoop build() {
            return $;
        }
    }
