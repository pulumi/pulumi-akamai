...
public final class Report extends com.pulumi.resources.InvokeArgs {
    ...
    public static Builder builder(Report defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Report defaults) {
            $ = new Report(Objects.requireNonNull(defaults));
        }
