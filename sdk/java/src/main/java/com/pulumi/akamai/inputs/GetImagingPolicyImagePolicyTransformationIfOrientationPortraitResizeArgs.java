...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitResizeArgs build() {
            return $;
        }
    }
