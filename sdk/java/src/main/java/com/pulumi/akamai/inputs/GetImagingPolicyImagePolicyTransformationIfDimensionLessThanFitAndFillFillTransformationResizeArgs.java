...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationResizeArgs build() {
            return $;
        }
    }
