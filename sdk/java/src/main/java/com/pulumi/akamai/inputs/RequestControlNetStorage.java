...
public final class RequestControlNetStorage extends com.pulumi.resources.InvokeArgs {

    public static final RequestControlNetStorage Empty = new RequestControlNetStorage();
    ...
    private RequestControlNetStorage() {}

    private RequestControlNetStorage(RequestControlNetStorage $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(RequestControlNetStorage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RequestControlNetStorage();
        }

        public Builder(RequestControlNetStorage defaults) {
            $ = new RequestControlNetStorage(Objects.requireNonNull(defaults));
        }
        ...
        public RequestControlNetStorage build() {
            return $;
        }
    }
