...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageTextImageTransformationCrop build() {
            return $;
        }
    }
