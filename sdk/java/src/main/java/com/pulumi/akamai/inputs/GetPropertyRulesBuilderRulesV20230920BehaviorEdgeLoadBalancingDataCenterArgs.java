...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable Output<List<GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(List<GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterArgs build() {
            return $;
        }
    }
