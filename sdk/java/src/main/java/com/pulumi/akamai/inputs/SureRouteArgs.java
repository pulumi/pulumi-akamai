...
public final class SureRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final SureRouteArgs Empty = new SureRouteArgs();
    ...
    private SureRouteArgs() {}

    private SureRouteArgs(SureRouteArgs $) {
    ...
    public static Builder builder(SureRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SureRouteArgs defaults) {
            $ = new SureRouteArgs(Objects.requireNonNull(defaults));
        }
