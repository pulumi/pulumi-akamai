...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerAllDownNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerFailoverOriginMap;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage;

    /**
     * @return Specifies a NetStorage account for a static maintenance page as a fallback when no origins are available.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerAllDownNetStorage> allDownNetStorage() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps;

    /**
     * @return Specifies a fixed set of failover mapping rules.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerFailoverOriginMap>> failoverOriginMaps() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer(GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder allDownNetStorage(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerAllDownNetStorage allDownNetStorage) {
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder failoverOriginMaps(@Nullable List<GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerFailoverOriginMap> failoverOriginMaps) {
         ...
         * 
         */
        public Builder failoverOriginMaps(GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancerFailoverOriginMap... failoverOriginMaps) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorApplicationLoadBalancer build() {
            return $;
        }
    }
