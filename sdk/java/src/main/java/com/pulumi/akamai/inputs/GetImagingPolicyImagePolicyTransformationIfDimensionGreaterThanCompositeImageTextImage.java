...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanCompositeImageTextImage build() {
            return $;
        }
    }
