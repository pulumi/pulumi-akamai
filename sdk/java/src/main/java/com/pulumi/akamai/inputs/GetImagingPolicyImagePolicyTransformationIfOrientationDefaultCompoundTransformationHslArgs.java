...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultCompoundTransformationHslArgs build() {
            return $;
        }
    }
