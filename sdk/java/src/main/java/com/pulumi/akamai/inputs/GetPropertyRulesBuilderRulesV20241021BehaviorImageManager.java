...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorImageManager extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorImageManager Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManager();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManager() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManager(GetPropertyRulesBuilderRulesV20241021BehaviorImageManager $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManager defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManager();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManager defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManager(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorImageManager build() {
            return $;
        }
    }
