...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorPhasedReleaseCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorPhasedReleaseCloudletPolicy cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorPhasedReleaseCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease(GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorPhasedReleaseCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorPhasedRelease build() {
            return $;
        }
    }
