...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfDimensionLessThanCrop build() {
            return $;
        }
    }
