...
public final class RealTimeReporting extends com.pulumi.resources.InvokeArgs {

    public static final RealTimeReporting Empty = new RealTimeReporting();
    ...
    private RealTimeReporting(RealTimeReporting $) {
    ...
    public static Builder builder(RealTimeReporting defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RealTimeReporting();
        }

        public Builder(RealTimeReporting defaults) {
            $ = new RealTimeReporting(Objects.requireNonNull(defaults));
        }
        ...
        public RealTimeReporting build() {
            return $;
        }
    }
