...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitHsl build() {
            return $;
        }
    }
