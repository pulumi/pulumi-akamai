...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration();
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration(GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorWebApplicationFirewallFirewallConfiguration build() {
            return $;
        }
    }
