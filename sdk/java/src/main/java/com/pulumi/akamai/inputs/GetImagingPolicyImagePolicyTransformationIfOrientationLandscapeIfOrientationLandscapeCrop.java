...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfOrientationLandscapeCrop build() {
            return $;
        }
    }
