...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanGoop build() {
            return $;
        }
    }
