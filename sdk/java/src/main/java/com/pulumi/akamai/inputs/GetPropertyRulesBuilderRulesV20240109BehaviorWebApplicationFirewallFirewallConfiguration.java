...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration();
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration(GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorWebApplicationFirewallFirewallConfiguration build() {
            return $;
        }
    }
