...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorSetVariable {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorSetVariable build() {
            final var o = new GetPropertyRulesBuilderRulesV20230530BehaviorSetVariable();
            o.algorithm = algorithm;
            o.caseSensitive = caseSensitive;
            o.certificateFieldName = certificateFieldName;
            o.cookieName = cookieName;
            o.deviceProfile = deviceProfile;
            o.encryptionKey = encryptionKey;
            o.encryptionMode = encryptionMode;
            o.endIndex = endIndex;
            o.exceptChars = exceptChars;
            o.extractLocation = extractLocation;
            o.forceChars = forceChars;
            o.formatString = formatString;
            o.generator = generator;
            o.globalSubstitution = globalSubstitution;
            o.headerName = headerName;
            o.hmacAlgorithm = hmacAlgorithm;
            o.hmacKey = hmacKey;
            o.initializationVector = initializationVector;
            o.ipVersion = ipVersion;
            o.ipv4Prefix = ipv4Prefix;
            o.ipv6Prefix = ipv6Prefix;
            o.locationId = locationId;
            o.locked = locked;
            o.max = max;
            o.maxRandomNumber = maxRandomNumber;
            o.min = min;
            o.minRandomNumber = minRandomNumber;
            o.nonce = nonce;
            o.numberOfBytes = numberOfBytes;
            o.operandOne = operandOne;
            o.paramName = paramName;
            o.pathComponentOffset = pathComponentOffset;
            o.prependBytes = prependBytes;
            o.queryParameterName = queryParameterName;
            o.regex = regex;
            o.replacement = replacement;
            o.responseHeaderName = responseHeaderName;
            o.separator = separator;
            o.setCookieName = setCookieName;
