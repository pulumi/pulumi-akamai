...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorImageManager extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorImageManager Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorImageManager();
    ...
    private @Nullable Boolean cloudWrapperEnabled;

    public Optional<Boolean> cloudWrapperEnabled() {
        return Optional.ofNullable(this.cloudWrapperEnabled);
    }

    @Import(name="cloudWrapperRolloutStart")
    private @Nullable Boolean cloudWrapperRolloutStart;

    public Optional<Boolean> cloudWrapperRolloutStart() {
        return Optional.ofNullable(this.cloudWrapperRolloutStart);
    }

    @Import(name="cloudWrapperUrlPaths")
    private @Nullable List<String> cloudWrapperUrlPaths;

    public Optional<List<String>> cloudWrapperUrlPaths() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorImageManager() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorImageManager(GetPropertyRulesBuilderRulesV20250218BehaviorImageManager $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorImageManager defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorImageManager();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorImageManager defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorImageManager(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cloudWrapperEnabled(@Nullable Boolean cloudWrapperEnabled) {
            $.cloudWrapperEnabled = cloudWrapperEnabled;
            return this;
        }

        public Builder cloudWrapperRolloutStart(@Nullable Boolean cloudWrapperRolloutStart) {
            $.cloudWrapperRolloutStart = cloudWrapperRolloutStart;
            return this;
        }

        public Builder cloudWrapperUrlPaths(@Nullable List<String> cloudWrapperUrlPaths) {
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorImageManagerCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorImageManager build() {
            return $;
        }
    }
