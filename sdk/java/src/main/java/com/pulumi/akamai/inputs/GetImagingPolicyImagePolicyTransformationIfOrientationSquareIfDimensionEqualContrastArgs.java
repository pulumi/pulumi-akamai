...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualContrastArgs build() {
            return $;
        }
    }
