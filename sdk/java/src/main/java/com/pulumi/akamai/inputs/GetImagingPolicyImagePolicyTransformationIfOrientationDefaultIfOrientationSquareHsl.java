...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareHsl(Objects.requireNonNull(defaults));
        }
