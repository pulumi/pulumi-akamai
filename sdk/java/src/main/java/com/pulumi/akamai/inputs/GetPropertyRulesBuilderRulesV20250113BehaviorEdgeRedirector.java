...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorEdgeRedirector build() {
            return $;
        }
    }
