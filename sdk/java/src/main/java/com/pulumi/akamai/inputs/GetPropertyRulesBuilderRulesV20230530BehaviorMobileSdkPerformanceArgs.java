...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs(GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorMobileSdkPerformanceArgs build() {
            return $;
        }
    }
