...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021Behavior;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021Criterion;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021CustomOverride;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021Variable;
...
public final class GetPropertyRulesBuilderRulesV20241021 extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021 Empty = new GetPropertyRulesBuilderRulesV20241021();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20241021Behavior> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20241021Behavior>> behaviors() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20241021Criterion> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20241021Criterion>> criterions() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20241021CustomOverride customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20241021CustomOverride> customOverride() {
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20241021Variable> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20241021Variable>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20241021() {}

    private GetPropertyRulesBuilderRulesV20241021(GetPropertyRulesBuilderRulesV20241021 $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021 defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable List<GetPropertyRulesBuilderRulesV20241021Behavior> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20241021Behavior... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable List<GetPropertyRulesBuilderRulesV20241021Criterion> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20241021Criterion... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable GetPropertyRulesBuilderRulesV20241021CustomOverride customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable List<GetPropertyRulesBuilderRulesV20241021Variable> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20241021Variable... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20241021 build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20241021", "name");
            }
            return $;
        }
    }
