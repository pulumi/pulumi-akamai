...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareHsvArgs build() {
            return $;
        }
    }
