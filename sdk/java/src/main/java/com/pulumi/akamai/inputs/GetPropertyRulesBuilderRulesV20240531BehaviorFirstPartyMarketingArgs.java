...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorFirstPartyMarketingArgs build() {
            return $;
        }
    }
