...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthorityIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthoritySubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthorityIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthoritySubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority(GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorOriginCustomCertificateAuthority build() {
            return $;
        }
    }
