...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitRelativeCrop build() {
            return $;
        }
    }
