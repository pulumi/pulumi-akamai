...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualHsl build() {
            return $;
        }
    }
