...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageTextImageTransformationAppendArgs build() {
