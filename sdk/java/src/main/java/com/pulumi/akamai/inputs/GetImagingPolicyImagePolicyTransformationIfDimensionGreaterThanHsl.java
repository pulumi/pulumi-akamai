...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanHsl build() {
            return $;
        }
    }
