...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsvArgs build() {
            return $;
        }
    }
