...
public final class RealTimeReportingArgs extends com.pulumi.resources.ResourceArgs {

    public static final RealTimeReportingArgs Empty = new RealTimeReportingArgs();
    ...
    private RealTimeReportingArgs() {}

    private RealTimeReportingArgs(RealTimeReportingArgs $) {
    ...
    public static Builder builder(RealTimeReportingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RealTimeReportingArgs();
        }

        public Builder(RealTimeReportingArgs defaults) {
            $ = new RealTimeReportingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RealTimeReportingArgs build() {
            return $;
        }
    }
