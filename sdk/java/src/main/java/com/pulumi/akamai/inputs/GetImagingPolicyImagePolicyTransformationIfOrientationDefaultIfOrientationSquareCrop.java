...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationSquareCrop build() {
            return $;
        }
    }
