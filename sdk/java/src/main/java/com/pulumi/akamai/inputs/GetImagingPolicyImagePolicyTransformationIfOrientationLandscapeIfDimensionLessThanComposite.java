...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanCompositeImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanCompositeImage image;

    public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanCompositeImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanCompositeImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionLessThanComposite build() {
