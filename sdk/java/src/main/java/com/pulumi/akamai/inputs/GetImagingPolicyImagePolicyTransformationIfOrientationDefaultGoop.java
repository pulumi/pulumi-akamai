...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultGoop build() {
            return $;
        }
    }
