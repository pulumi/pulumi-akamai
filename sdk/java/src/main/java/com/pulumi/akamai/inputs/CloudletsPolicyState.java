...
public final class CloudletsPolicyState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The two- or three- character code for the type of Cloudlet, either `ALB` for Application Load Balancer or `ER` for Edge Redirector.
     * 
     */
    ...
    /**
     * @return A unique identifier that corresponds to a Cloudlets policy type, either `0` for Edge Redirector or `9` for Application Load Balancer.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param cloudletCode The two- or three- character code for the type of Cloudlet, either `ALB` for Application Load Balancer or `ER` for Edge Redirector.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param cloudletId A unique identifier that corresponds to a Cloudlets policy type, either `0` for Edge Redirector or `9` for Application Load Balancer.
         * 
         * @return builder
         * 
         */
