...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationGoopArgs build() {
            return $;
        }
    }
