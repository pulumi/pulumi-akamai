...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultMirrorArgs build() {
            return $;
        }
    }
