...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateIssuerRdns;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateSubjectRdns;
...
public final class GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate Empty = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateIssuerRdns issuerRdns;

    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateIssuerRdns> issuerRdns() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateSubjectRdns subjectRdns;

    public Optional<GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateSubjectRdns> subjectRdns() {
    ...
    private GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate() {}

    private GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate(Objects.requireNonNull(defaults));
        }
        ...
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateIssuerRdns issuerRdns) {
        ...
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificateSubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20250218BehaviorOriginCustomCertificate build() {
            return $;
        }
    }
