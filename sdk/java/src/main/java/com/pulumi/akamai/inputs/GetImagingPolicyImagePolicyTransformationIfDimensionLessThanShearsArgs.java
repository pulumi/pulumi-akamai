...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs $) {
        this.xShear = $.xShear;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanShearsArgs build() {
            return $;
        }
    }
