...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultHsvArgs build() {
            return $;
        }
    }
