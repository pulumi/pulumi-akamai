...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109CriterionArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109CustomOverrideArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109VariableArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109Args extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109Args Empty = new GetPropertyRulesBuilderRulesV20240109Args();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240109BehaviorArgs>> behaviors;

    /**
     * @return The list of behaviors for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240109BehaviorArgs>>> behaviors() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240109CriterionArgs>> criterions;

    /**
     * @return The list of criteria for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240109CriterionArgs>>> criterions() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240109CustomOverrideArgs> customOverride;

    /**
     * @return XML metadata of the rule
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240109CustomOverrideArgs>> customOverride() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240109VariableArgs>> variables;

    /**
     * @return A list of variables for a rule
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240109VariableArgs>>> variables() {
        return Optional.ofNullable(this.variables);
    }

    private GetPropertyRulesBuilderRulesV20240109Args() {}

    private GetPropertyRulesBuilderRulesV20240109Args(GetPropertyRulesBuilderRulesV20240109Args $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109Args();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109Args defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder behaviors(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240109BehaviorArgs>> behaviors) {
            $.behaviors = behaviors;
            return this;
        }
         ...
         * 
         */
        public Builder behaviors(List<GetPropertyRulesBuilderRulesV20240109BehaviorArgs> behaviors) {
         ...
         * 
         */
        public Builder behaviors(GetPropertyRulesBuilderRulesV20240109BehaviorArgs... behaviors) {
         ...
         * 
         */
        public Builder criterions(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240109CriterionArgs>> criterions) {
         ...
         * 
         */
        public Builder criterions(List<GetPropertyRulesBuilderRulesV20240109CriterionArgs> criterions) {
         ...
         * 
         */
        public Builder criterions(GetPropertyRulesBuilderRulesV20240109CriterionArgs... criterions) {
         ...
         * 
         */
        public Builder customOverride(@Nullable Output<GetPropertyRulesBuilderRulesV20240109CustomOverrideArgs> customOverride) {
         ...
         * 
         */
        public Builder customOverride(GetPropertyRulesBuilderRulesV20240109CustomOverrideArgs customOverride) {
         ...
         * 
         */
        public Builder variables(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240109VariableArgs>> variables) {
            $.variables = variables;
            return this;
        }
         ...
         * 
         */
        public Builder variables(List<GetPropertyRulesBuilderRulesV20240109VariableArgs> variables) {
         ...
         * 
         */
        public Builder variables(GetPropertyRulesBuilderRulesV20240109VariableArgs... variables) {
            return variables(List.of(variables));
        }

        public GetPropertyRulesBuilderRulesV20240109Args build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPropertyRulesBuilderRulesV20240109Args", "name");
            }
            return $;
        }
    }
