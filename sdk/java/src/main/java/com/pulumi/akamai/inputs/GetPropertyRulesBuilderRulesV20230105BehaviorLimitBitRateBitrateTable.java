...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorLimitBitRateBitrateTable extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorLimitBitRateBitrateTable(GetPropertyRulesBuilderRulesV20230105BehaviorLimitBitRateBitrateTable $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorLimitBitRateBitrateTable();
        }
