...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanAppendImageTextImage build() {
            return $;
        }
    }
