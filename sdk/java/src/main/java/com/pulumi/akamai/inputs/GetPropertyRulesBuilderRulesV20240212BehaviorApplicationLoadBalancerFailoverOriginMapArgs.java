...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs(GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorApplicationLoadBalancerFailoverOriginMapArgs build() {
            return $;
        }
    }
