...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeOriginal;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeTransformed;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorImageManager extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorImageManager Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManager();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeOriginal cpCodeOriginal;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeOriginal> cpCodeOriginal() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeTransformed cpCodeTransformed;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeTransformed> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorImageManager() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorImageManager(GetPropertyRulesBuilderRulesV20240531BehaviorImageManager $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorImageManager defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManager();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorImageManager defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorImageManager(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeOriginal cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorImageManagerCpCodeTransformed cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorImageManager build() {
            return $;
        }
    }
