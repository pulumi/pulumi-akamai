...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompositeImageTextImage build() {
            return $;
        }
    }
