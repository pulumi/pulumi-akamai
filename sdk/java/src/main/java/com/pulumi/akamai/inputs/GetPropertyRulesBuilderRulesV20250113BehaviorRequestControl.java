...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlNetStorage netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlNetStorage> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl(GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorRequestControlNetStorage netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorRequestControl build() {
            return $;
        }
    }
