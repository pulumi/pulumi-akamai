...
public final class GetPropertyRulesBuilderRulesV20230530Criterion {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230530Criterion build() {
            final var o = new GetPropertyRulesBuilderRulesV20230530Criterion();
            o.advancedImMatch = advancedImMatch;
            o.bucket = bucket;
            o.cacheability = cacheability;
            o.chinaCdnRegion = chinaCdnRegion;
            o.clientCertificate = clientCertificate;
            o.clientIp = clientIp;
            o.clientIpVersion = clientIpVersion;
            o.cloudletsOrigin = cloudletsOrigin;
            o.contentDeliveryNetwork = contentDeliveryNetwork;
            o.contentType = contentType;
            o.deviceCharacteristic = deviceCharacteristic;
            o.ecmdAuthGroups = ecmdAuthGroups;
            o.ecmdAuthScheme = ecmdAuthScheme;
            o.ecmdIsAuthenticated = ecmdIsAuthenticated;
            o.ecmdUsername = ecmdUsername;
            o.edgeWorkersFailure = edgeWorkersFailure;
            o.fileExtension = fileExtension;
            o.filename = filename;
            o.hostname = hostname;
            o.matchAdvanced = matchAdvanced;
            o.matchCpCode = matchCpCode;
            o.matchResponseCode = matchResponseCode;
            o.matchVariable = matchVariable;
            o.metadataStage = metadataStage;
            o.originTimeout = originTimeout;
            o.path = path;
            o.queryStringParameter = queryStringParameter;
            o.random = random;
            o.recoveryConfig = recoveryConfig;
            o.regularExpression = regularExpression;
            o.requestCookie = requestCookie;
            ...
            o.userNetwork = userNetwork;
            o.variableError = variableError;
            o.virtualWaitingRoomRequest = virtualWaitingRoomRequest;
            o.visitorPrioritizationRequest = visitorPrioritizationRequest;
            return o;
        }
    }
}
