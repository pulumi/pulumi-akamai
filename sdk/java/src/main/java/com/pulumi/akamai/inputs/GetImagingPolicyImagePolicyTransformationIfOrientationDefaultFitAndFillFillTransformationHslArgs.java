...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultFitAndFillFillTransformationHslArgs build() {
            return $;
        }
    }
