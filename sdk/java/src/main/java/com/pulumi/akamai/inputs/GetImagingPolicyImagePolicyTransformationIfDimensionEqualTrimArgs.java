...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs $) {
        this.fuzz = $.fuzz;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualTrimArgs build() {
            return $;
        }
    }
