...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation(GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation $) {
        this.locked = $.locked;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorDcpAuthSubstringTransformation(Objects.requireNonNull(defaults));
        }
