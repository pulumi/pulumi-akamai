...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformationArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs();
    ...
    private @Nullable Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformationArgs> transformation;

    public Optional<Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformationArgs>> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable Output<GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformationArgs> transformation) {
            $.transformation = transformation;
            return this;
        }

        public Builder transformation(GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformationArgs transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageArgs build() {
            return $;
        }
    }
