...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationRelativeCrop build() {
            return $;
        }
    }
