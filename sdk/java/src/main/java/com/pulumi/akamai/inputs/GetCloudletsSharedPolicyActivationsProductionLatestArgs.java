...
public final class GetCloudletsSharedPolicyActivationsProductionLatestArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCloudletsSharedPolicyActivationsProductionLatestArgs Empty = new GetCloudletsSharedPolicyActivationsProductionLatestArgs();
    ...
    private GetCloudletsSharedPolicyActivationsProductionLatestArgs() {}

    private GetCloudletsSharedPolicyActivationsProductionLatestArgs(GetCloudletsSharedPolicyActivationsProductionLatestArgs $) {
    ...
    public static Builder builder(GetCloudletsSharedPolicyActivationsProductionLatestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsSharedPolicyActivationsProductionLatestArgs();
        }

        public Builder(GetCloudletsSharedPolicyActivationsProductionLatestArgs defaults) {
            $ = new GetCloudletsSharedPolicyActivationsProductionLatestArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCloudletsSharedPolicyActivationsProductionLatestArgs build() {
            if ($.activationId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "activationId");
            }
            if ($.createdBy == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "createdBy");
            }
            if ($.createdDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "createdDate");
            }
            if ($.finishDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "finishDate");
            }
            if ($.network == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "network");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "operation");
            }
            if ($.policyId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "policyId");
            }
            if ($.policyVersion == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "policyVersion");
            }
            if ($.policyVersionDeleted == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "policyVersionDeleted");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsProductionLatestArgs", "status");
            }
            return $;
        }
    }
