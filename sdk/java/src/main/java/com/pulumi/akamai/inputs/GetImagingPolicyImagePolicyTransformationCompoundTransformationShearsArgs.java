...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs $) {
        this.xShear = $.xShear;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationShearsArgs build() {
            return $;
        }
    }
