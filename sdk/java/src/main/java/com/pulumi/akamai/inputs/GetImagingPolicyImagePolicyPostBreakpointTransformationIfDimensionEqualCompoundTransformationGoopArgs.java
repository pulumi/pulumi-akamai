...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompoundTransformationGoopArgs build() {
            return $;
        }
    }
