...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionLessThanRemoveColorArgs build() {
            return $;
        }
    }
