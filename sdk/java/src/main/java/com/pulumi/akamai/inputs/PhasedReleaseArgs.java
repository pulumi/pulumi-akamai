...
import com.pulumi.akamai.inputs.PhasedReleaseCloudletPolicyArgs;
...
public final class PhasedReleaseArgs extends com.pulumi.resources.ResourceArgs {

    public static final PhasedReleaseArgs Empty = new PhasedReleaseArgs();

    @Import(name="cloudletPolicy")
    private @Nullable Output<PhasedReleaseCloudletPolicyArgs> cloudletPolicy;

    public Optional<Output<PhasedReleaseCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private PhasedReleaseArgs() {}

    private PhasedReleaseArgs(PhasedReleaseArgs $) {
    ...
    public static Builder builder(PhasedReleaseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PhasedReleaseArgs();
        }

        public Builder(PhasedReleaseArgs defaults) {
            $ = new PhasedReleaseArgs(Objects.requireNonNull(defaults));
        }

        public Builder cloudletPolicy(@Nullable Output<PhasedReleaseCloudletPolicyArgs> cloudletPolicy) {
            $.cloudletPolicy = cloudletPolicy;
            return this;
        }

        public Builder cloudletPolicy(PhasedReleaseCloudletPolicyArgs cloudletPolicy) {
        ...
        public PhasedReleaseArgs build() {
            return $;
        }
    }
