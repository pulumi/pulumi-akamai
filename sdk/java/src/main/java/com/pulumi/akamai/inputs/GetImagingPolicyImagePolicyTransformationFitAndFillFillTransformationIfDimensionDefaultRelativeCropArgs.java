...
public final class GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationFitAndFillFillTransformationIfDimensionDefaultRelativeCropArgs build() {
            return $;
        }
    }
