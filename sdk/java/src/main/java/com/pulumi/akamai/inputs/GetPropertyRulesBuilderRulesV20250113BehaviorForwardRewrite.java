...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite Empty = new GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite() {}

    private GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite(GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite();
        }

        public Builder(GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite defaults) {
            $ = new GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewriteCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20250113BehaviorForwardRewrite build() {
            return $;
        }
    }
