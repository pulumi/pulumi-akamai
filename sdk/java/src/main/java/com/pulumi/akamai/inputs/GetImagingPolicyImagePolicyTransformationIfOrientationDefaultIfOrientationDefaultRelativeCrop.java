...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultRelativeCrop build() {
            return $;
        }
    }
