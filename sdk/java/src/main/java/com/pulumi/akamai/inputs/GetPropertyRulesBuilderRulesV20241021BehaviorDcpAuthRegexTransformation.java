...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation();
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation(GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorDcpAuthRegexTransformation build() {
            return $;
        }
    }
