...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultGoopArgs build() {
            return $;
        }
    }
