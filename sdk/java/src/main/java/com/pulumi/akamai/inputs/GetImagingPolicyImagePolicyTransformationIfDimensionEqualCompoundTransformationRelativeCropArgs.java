...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationRelativeCropArgs build() {
            return $;
        }
    }
