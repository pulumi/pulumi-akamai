...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanFitAndFillFillTransformationUnsharpMaskArgs build() {
            return $;
        }
    }
