...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppendImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppendImage image;

    public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppendImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppendImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationLandscapeIfDimensionDefaultAppend build() {
