...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionEqualRelativeCropArgs build() {
            return $;
        }
    }
