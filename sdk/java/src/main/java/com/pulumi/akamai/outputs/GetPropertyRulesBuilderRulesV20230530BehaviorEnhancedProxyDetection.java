...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorEnhancedProxyDetection {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorEnhancedProxyDetection build() {
            final var o = new GetPropertyRulesBuilderRulesV20230530BehaviorEnhancedProxyDetection();
            o.anonymousVpn = anonymousVpn;
            o.bestPracticeAction = bestPracticeAction;
            o.bestPracticeRedirecturl = bestPracticeRedirecturl;
            o.detectAnonymousVpn = detectAnonymousVpn;
            o.detectAnonymousVpnAction = detectAnonymousVpnAction;
            o.detectAnonymousVpnRedirecturl = detectAnonymousVpnRedirecturl;
            o.detectHostingProvider = detectHostingProvider;
            o.detectHostingProviderAction = detectHostingProviderAction;
            o.detectHostingProviderRedirecturl = detectHostingProviderRedirecturl;
            o.detectPublicProxy = detectPublicProxy;
            o.detectPublicProxyAction = detectPublicProxyAction;
            o.detectPublicProxyRedirecturl = detectPublicProxyRedirecturl;
            o.detectResidentialProxy = detectResidentialProxy;
            o.detectResidentialProxyAction = detectResidentialProxyAction;
            o.detectResidentialProxyRedirecturl = detectResidentialProxyRedirecturl;
            o.detectSmartDnsProxy = detectSmartDnsProxy;
            o.detectSmartDnsProxyAction = detectSmartDnsProxyAction;
            o.detectSmartDnsProxyRedirecturl = detectSmartDnsProxyRedirecturl;
            o.detectTorExitNode = detectTorExitNode;
            o.detectTorExitNodeAction = detectTorExitNodeAction;
            o.detectTorExitNodeRedirecturl = detectTorExitNodeRedirecturl;
            o.detectVpnDataCenter = detectVpnDataCenter;
            o.detectVpnDataCenterAction = detectVpnDataCenterAction;
            o.detectVpnDataCenterRedirecturl = detectVpnDataCenterRedirecturl;
            o.enableConfigurationMode = enableConfigurationMode;
            o.enabled = enabled;
            o.forwardHeaderEnrichment = forwardHeaderEnrichment;
            o.hostingProvider = hostingProvider;
            o.locked = locked;
            o.publicProxy = publicProxy;
            o.residentialProxy = residentialProxy;
            o.smartDnsProxy = smartDnsProxy;
            o.templateUuid = templateUuid;
            o.torExitNode = torExitNode;
            o.uuid = uuid;
            o.vpnDataCenter = vpnDataCenter;
            return o;
        }
    }
}
