...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl Empty = new GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicy cloudletPolicy;

    public Optional<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorage netStorage;

    public Optional<GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorage> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl() {}

    private GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl();
        }

        public Builder(GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl defaults) {
            $ = new GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlCloudletPolicy cloudletPolicy) {
        ...
        public Builder netStorage(@Nullable GetPropertyRulesBuilderRulesV20231030BehaviorRequestControlNetStorage netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorRequestControl build() {
            return $;
        }
    }
