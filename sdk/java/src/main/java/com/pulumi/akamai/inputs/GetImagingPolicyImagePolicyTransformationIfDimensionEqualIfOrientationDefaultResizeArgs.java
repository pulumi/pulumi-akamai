...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualIfOrientationDefaultResizeArgs build() {
            return $;
        }
    }
