...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanFitAndFillFillTransformationResizeArgs build() {
            return $;
        }
    }
