...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareMirrorArgs build() {
            return $;
        }
    }
