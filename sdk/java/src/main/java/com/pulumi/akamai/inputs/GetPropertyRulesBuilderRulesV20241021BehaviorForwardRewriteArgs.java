...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs(GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorForwardRewriteArgs build() {
            return $;
        }
    }
