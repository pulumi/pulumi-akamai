...
public final class GetAppSecRuleUpgradeDetailsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppSecRuleUpgradeDetailsPlainArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("GetAppSecRuleUpgradeDetailsPlainArgs", "configId");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("GetAppSecRuleUpgradeDetailsPlainArgs", "securityPolicyId");
            }
            return $;
        }
    }
