...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanAspectCrop build() {
            return $;
        }
    }
