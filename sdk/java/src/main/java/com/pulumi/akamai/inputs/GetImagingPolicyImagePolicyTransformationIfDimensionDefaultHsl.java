...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultHsl build() {
            return $;
        }
    }
