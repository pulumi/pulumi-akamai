...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionGreaterThanGoop build() {
            return $;
        }
    }
