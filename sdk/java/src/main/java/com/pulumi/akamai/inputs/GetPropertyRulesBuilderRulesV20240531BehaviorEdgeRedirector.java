...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy;

    /**
     * @return Specifies the Cloudlet policy as an object.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicy> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirectorCloudletPolicy cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorEdgeRedirector build() {
            return $;
        }
    }
