...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfOrientationDefaultContrastArgs build() {
            return $;
        }
    }
