...
public final class GetCloudletsSharedPolicyActivationsStagingLatestArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCloudletsSharedPolicyActivationsStagingLatestArgs Empty = new GetCloudletsSharedPolicyActivationsStagingLatestArgs();
    ...
    private GetCloudletsSharedPolicyActivationsStagingLatestArgs() {}

    private GetCloudletsSharedPolicyActivationsStagingLatestArgs(GetCloudletsSharedPolicyActivationsStagingLatestArgs $) {
    ...
    public static Builder builder(GetCloudletsSharedPolicyActivationsStagingLatestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsSharedPolicyActivationsStagingLatestArgs();
        }

        public Builder(GetCloudletsSharedPolicyActivationsStagingLatestArgs defaults) {
            $ = new GetCloudletsSharedPolicyActivationsStagingLatestArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCloudletsSharedPolicyActivationsStagingLatestArgs build() {
            if ($.activationId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "activationId");
            }
            if ($.createdBy == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "createdBy");
            }
            if ($.createdDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "createdDate");
            }
            if ($.finishDate == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "finishDate");
            }
            if ($.network == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "network");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "operation");
            }
            if ($.policyId == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "policyId");
            }
            if ($.policyVersion == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "policyVersion");
            }
            if ($.policyVersionDeleted == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "policyVersionDeleted");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("GetCloudletsSharedPolicyActivationsStagingLatestArgs", "status");
            }
            return $;
        }
    }
