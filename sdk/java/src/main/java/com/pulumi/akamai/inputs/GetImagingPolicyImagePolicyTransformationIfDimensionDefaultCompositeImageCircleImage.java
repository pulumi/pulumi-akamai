...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage $) {
        this.color = $.color;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompositeImageCircleImage(Objects.requireNonNull(defaults));
        }
