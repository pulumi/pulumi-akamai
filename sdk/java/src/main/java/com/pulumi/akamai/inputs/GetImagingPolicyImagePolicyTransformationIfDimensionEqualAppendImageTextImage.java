...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage(GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualAppendImageTextImage build() {
            return $;
        }
    }
