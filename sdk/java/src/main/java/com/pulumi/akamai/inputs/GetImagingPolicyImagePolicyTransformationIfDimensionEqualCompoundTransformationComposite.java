...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCompositeImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCompositeImage image;

    public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCompositeImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationCompositeImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualCompoundTransformationComposite build() {
