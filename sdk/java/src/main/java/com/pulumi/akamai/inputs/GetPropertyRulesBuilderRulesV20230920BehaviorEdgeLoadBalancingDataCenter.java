...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRule;
...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter();
    ...
    private @Nullable List<GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<List<GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRule>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable List<GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRule> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenterFailoverRule... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorEdgeLoadBalancingDataCenter build() {
            return $;
        }
    }
