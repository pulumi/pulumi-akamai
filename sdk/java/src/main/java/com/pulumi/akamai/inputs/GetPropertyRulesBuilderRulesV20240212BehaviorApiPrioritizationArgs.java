...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorageArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCodeArgs;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorageArgs> netStorage;

    /**
     * @return Specify the NetStorage domain that contains the alternate response.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorageArgs>> netStorage() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCodeArgs>> throttledCpCode() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationNetStorageArgs netStorage) {
         ...
         * 
         */
        public Builder throttledCpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCodeArgs> throttledCpCode) {
         ...
         * 
         */
        public Builder throttledCpCode(GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationThrottledCpCodeArgs throttledCpCode) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorApiPrioritizationArgs build() {
            return $;
        }
    }
