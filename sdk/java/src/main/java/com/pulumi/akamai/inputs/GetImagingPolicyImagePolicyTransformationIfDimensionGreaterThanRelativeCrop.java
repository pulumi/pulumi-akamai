...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanRelativeCrop build() {
            return $;
        }
    }
