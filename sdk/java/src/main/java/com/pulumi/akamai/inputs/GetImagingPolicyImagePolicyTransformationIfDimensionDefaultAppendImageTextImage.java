...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultAppendImageTextImage build() {
            return $;
        }
    }
