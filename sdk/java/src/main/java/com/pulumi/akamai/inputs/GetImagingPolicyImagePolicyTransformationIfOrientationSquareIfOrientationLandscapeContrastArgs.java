...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationLandscapeContrastArgs build() {
            return $;
        }
    }
