...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop(GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualGoop build() {
            return $;
        }
    }
