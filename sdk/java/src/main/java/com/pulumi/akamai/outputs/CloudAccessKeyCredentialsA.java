...
@CustomType
public final class CloudAccessKeyCredentialsA {
    /**
    ...
    public static Builder builder(CloudAccessKeyCredentialsA defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String versionGuid;
        public Builder() {}
        public Builder(CloudAccessKeyCredentialsA defaults) {
        ...
        public Builder cloudSecretAccessKey(String cloudSecretAccessKey) {
            if (cloudSecretAccessKey == null) {
              throw new MissingRequiredPropertyException("CloudAccessKeyCredentialsA", "cloudSecretAccessKey");
            }
        ...
        public Builder primaryKey(Boolean primaryKey) {
            if (primaryKey == null) {
              throw new MissingRequiredPropertyException("CloudAccessKeyCredentialsA", "primaryKey");
            }
        ...
        public CloudAccessKeyCredentialsA build() {
            final var _resultValue = new CloudAccessKeyCredentialsA();
