...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationPortraitGoop build() {
            return $;
        }
    }
