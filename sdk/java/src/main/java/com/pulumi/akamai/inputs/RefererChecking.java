...
public final class RefererChecking extends com.pulumi.resources.InvokeArgs {

    public static final RefererChecking Empty = new RefererChecking();
    ...
    private RefererChecking() {}

    private RefererChecking(RefererChecking $) {
    ...
    public static Builder builder(RefererChecking defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RefererChecking defaults) {
            $ = new RefererChecking(Objects.requireNonNull(defaults));
        }
