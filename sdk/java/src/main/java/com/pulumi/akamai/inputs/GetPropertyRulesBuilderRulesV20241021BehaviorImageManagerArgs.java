...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginalArgs>> cpCodeOriginal() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed;
     ...
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeOriginalArgs cpCodeOriginal) {
         ...
         * 
         */
        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed) {
         ...
         * 
         */
        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorImageManagerArgs build() {
            return $;
        }
    }
