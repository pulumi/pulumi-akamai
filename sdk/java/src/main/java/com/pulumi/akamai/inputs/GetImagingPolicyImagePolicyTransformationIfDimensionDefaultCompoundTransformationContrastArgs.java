...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultCompoundTransformationContrastArgs build() {
            return $;
        }
    }
