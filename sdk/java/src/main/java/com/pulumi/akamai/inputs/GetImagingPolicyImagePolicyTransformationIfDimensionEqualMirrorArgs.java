...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs(GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionEqualMirrorArgs build() {
            return $;
        }
    }
