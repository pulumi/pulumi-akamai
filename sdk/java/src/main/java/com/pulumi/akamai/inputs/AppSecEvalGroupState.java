...
public final class AppSecEvalGroupState extends com.pulumi.resources.ResourceArgs {
    ...
    private AppSecEvalGroupState() {}

    private AppSecEvalGroupState(AppSecEvalGroupState $) {
    ...
    public static Builder builder(AppSecEvalGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSecEvalGroupState();
        }

        public Builder(AppSecEvalGroupState defaults) {
            $ = new AppSecEvalGroupState(Objects.requireNonNull(defaults));
        }
        ...
        public AppSecEvalGroupState build() {
            return $;
        }
    }
