...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs $) {
        this.hue = $.hue;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanChromaKeyArgs build() {
            return $;
        }
    }
