...
public final class ModifyIncomingRequestHeader extends com.pulumi.resources.InvokeArgs {

    public static final ModifyIncomingRequestHeader Empty = new ModifyIncomingRequestHeader();
    ...
    private ModifyIncomingRequestHeader() {}

    private ModifyIncomingRequestHeader(ModifyIncomingRequestHeader $) {
        this.action = $.action;
    ...
    public static Builder builder(ModifyIncomingRequestHeader defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModifyIncomingRequestHeader();
        }

        public Builder(ModifyIncomingRequestHeader defaults) {
            $ = new ModifyIncomingRequestHeader(Objects.requireNonNull(defaults));
        }
        ...
        public ModifyIncomingRequestHeader build() {
            return $;
        }
    }
