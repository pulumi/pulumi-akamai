...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionLessThanIfOrientationSquareContrastArgs build() {
            return $;
        }
    }
