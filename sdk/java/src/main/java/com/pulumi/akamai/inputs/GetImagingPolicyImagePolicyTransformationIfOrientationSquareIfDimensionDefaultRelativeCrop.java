...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop $) {
        this.east = $.east;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfDimensionDefaultRelativeCrop build() {
            return $;
        }
    }
