...
public final class GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop Empty = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageCircleImageTransformationGoop build() {
            return $;
        }
    }
