...
public final class Quality extends com.pulumi.resources.InvokeArgs {

    public static final Quality Empty = new Quality();
    ...
    public static Builder builder(Quality defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Quality defaults) {
            $ = new Quality(Objects.requireNonNull(defaults));
        }
