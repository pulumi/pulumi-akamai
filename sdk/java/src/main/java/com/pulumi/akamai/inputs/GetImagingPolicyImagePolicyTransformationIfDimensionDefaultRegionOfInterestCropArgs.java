...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropRegionOfInterestArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropRegionOfInterestArgs> regionOfInterest;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropRegionOfInterestArgs> regionOfInterest() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder regionOfInterest(Output<GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropRegionOfInterestArgs> regionOfInterest) {
            $.regionOfInterest = regionOfInterest;
            return this;
        }

        public Builder regionOfInterest(GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropRegionOfInterestArgs regionOfInterest) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionDefaultRegionOfInterestCropArgs build() {
