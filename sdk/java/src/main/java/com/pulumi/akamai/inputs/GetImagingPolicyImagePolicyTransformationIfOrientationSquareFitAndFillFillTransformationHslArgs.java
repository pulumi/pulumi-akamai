...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareFitAndFillFillTransformationHslArgs build() {
            return $;
        }
    }
