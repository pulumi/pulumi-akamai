...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImageTransformation;
...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage();
    ...
    private @Nullable GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImageTransformation transformation;

    public Optional<GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImageTransformation> transformation() {
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage $) {
        this.fill = $.fill;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage(Objects.requireNonNull(defaults));
        }
        ...
        public Builder transformation(@Nullable GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImageTransformation transformation) {
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationIfDimensionEqualCompositeImageTextImage build() {
            return $;
        }
    }
