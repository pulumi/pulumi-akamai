...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs;
...
public final class GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs Empty = new GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules;

    /**
     * @return Provides up to four failover rules to apply in the specified order.
     * 
     */
    public Optional<Output<List<GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs() {}

    private GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder failoverRules(@Nullable Output<List<GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs>> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(List<GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs> failoverRules) {
         ...
         * 
         */
        public Builder failoverRules(GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs... failoverRules) {
        ...
        public GetPropertyRulesBuilderRulesV20240109BehaviorEdgeLoadBalancingDataCenterArgs build() {
            return $;
        }
    }
