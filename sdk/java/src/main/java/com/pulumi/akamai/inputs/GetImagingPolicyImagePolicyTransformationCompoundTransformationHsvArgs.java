...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs $) {
        this.hue = $.hue;
        this.hueVar = $.hueVar;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationHsvArgs build() {
            return $;
        }
    }
