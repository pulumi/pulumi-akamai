...
public final class PropertyActivationRuleErrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final PropertyActivationRuleErrorArgs Empty = new PropertyActivationRuleErrorArgs();
    ...
    private PropertyActivationRuleErrorArgs() {}

    private PropertyActivationRuleErrorArgs(PropertyActivationRuleErrorArgs $) {
    ...
    public static Builder builder(PropertyActivationRuleErrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PropertyActivationRuleErrorArgs defaults) {
            $ = new PropertyActivationRuleErrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PropertyActivationRuleErrorArgs build() {
            return $;
        }
    }
