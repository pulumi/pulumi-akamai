...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropRegionOfInterestArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropRegionOfInterestArgs> regionOfInterest;

    public Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropRegionOfInterestArgs> regionOfInterest() {
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs(GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder regionOfInterest(Output<GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropRegionOfInterestArgs> regionOfInterest) {
            $.regionOfInterest = regionOfInterest;
            return this;
        }

        public Builder regionOfInterest(GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropRegionOfInterestArgs regionOfInterest) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareRegionOfInterestCropArgs build() {
