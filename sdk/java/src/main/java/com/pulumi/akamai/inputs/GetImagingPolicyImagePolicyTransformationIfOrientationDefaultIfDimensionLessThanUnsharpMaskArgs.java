...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationDefaultIfDimensionLessThanUnsharpMaskArgs build() {
            return $;
        }
    }
