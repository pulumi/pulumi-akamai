...
public final class OriginFailureRecoveryMethodArgs extends com.pulumi.resources.ResourceArgs {

    public static final OriginFailureRecoveryMethodArgs Empty = new OriginFailureRecoveryMethodArgs();
    ...
    private OriginFailureRecoveryMethodArgs() {}

    private OriginFailureRecoveryMethodArgs(OriginFailureRecoveryMethodArgs $) {
    ...
    public static Builder builder(OriginFailureRecoveryMethodArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginFailureRecoveryMethodArgs();
        }

        public Builder(OriginFailureRecoveryMethodArgs defaults) {
            $ = new OriginFailureRecoveryMethodArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OriginFailureRecoveryMethodArgs build() {
            return $;
        }
    }
