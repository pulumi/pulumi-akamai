...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlNetStorageArgs;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlNetStorageArgs> netStorage;

    /**
     * @return Specifies the NetStorage domain that contains the branded 403 page.
     * 
     */
    public Optional<Output<GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlNetStorageArgs>> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs(GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlCloudletPolicyArgs> cloudletPolicy) {
         ...
         * 
         */
        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlCloudletPolicyArgs cloudletPolicy) {
         ...
         * 
         */
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlNetStorageArgs> netStorage) {
         ...
         * 
         */
        public Builder netStorage(GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlNetStorageArgs netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorRequestControlArgs build() {
            return $;
        }
    }
