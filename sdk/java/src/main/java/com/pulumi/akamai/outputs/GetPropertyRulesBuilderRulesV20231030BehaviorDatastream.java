...
@CustomType
public final class GetPropertyRulesBuilderRulesV20231030BehaviorDatastream {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20231030BehaviorDatastream build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20231030BehaviorDatastream();
