...
public final class GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs Empty = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs $) {
        this.aspect = $.aspect;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompositeImageBoxImageTransformationResizeArgs build() {
            return $;
        }
    }
