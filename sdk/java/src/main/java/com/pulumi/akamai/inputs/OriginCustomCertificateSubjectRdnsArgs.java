...
public final class OriginCustomCertificateSubjectRdnsArgs extends com.pulumi.resources.ResourceArgs {

    public static final OriginCustomCertificateSubjectRdnsArgs Empty = new OriginCustomCertificateSubjectRdnsArgs();
    ...
    private OriginCustomCertificateSubjectRdnsArgs() {}

    private OriginCustomCertificateSubjectRdnsArgs(OriginCustomCertificateSubjectRdnsArgs $) {
        this.c = $.c;
        this.cn = $.cn;
        this.o = $.o;
        this.ou = $.ou;
    ...
    public static Builder builder(OriginCustomCertificateSubjectRdnsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginCustomCertificateSubjectRdnsArgs();
        }

        public Builder(OriginCustomCertificateSubjectRdnsArgs defaults) {
            $ = new OriginCustomCertificateSubjectRdnsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OriginCustomCertificateSubjectRdnsArgs build() {
            return $;
        }
    }
