...
public final class OriginNetStorage extends com.pulumi.resources.InvokeArgs {

    public static final OriginNetStorage Empty = new OriginNetStorage();
    ...
    private OriginNetStorage() {}

    private OriginNetStorage(OriginNetStorage $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(OriginNetStorage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginNetStorage();
        }

        public Builder(OriginNetStorage defaults) {
            $ = new OriginNetStorage(Objects.requireNonNull(defaults));
        }
