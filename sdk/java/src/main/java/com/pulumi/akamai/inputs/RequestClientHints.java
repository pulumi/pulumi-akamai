...
public final class RequestClientHints extends com.pulumi.resources.InvokeArgs {

    public static final RequestClientHints Empty = new RequestClientHints();
    ...
    private RequestClientHints(RequestClientHints $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RequestClientHints();
        }

        public Builder(RequestClientHints defaults) {
            $ = new RequestClientHints(Objects.requireNonNull(defaults));
        }
