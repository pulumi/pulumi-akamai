...
public final class GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs Empty = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs();
    ...
    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs() {}

    private GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20241021BehaviorEdgeLoadBalancingDataCenterFailoverRuleArgs build() {
            return $;
        }
    }
