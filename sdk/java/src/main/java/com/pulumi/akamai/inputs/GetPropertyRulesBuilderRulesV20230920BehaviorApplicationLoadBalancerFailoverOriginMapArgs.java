...
public final class GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs Empty = new GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs(GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230920BehaviorApplicationLoadBalancerFailoverOriginMapArgs build() {
            return $;
        }
    }
