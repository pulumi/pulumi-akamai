...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitCompositeImage;
...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitCompositeImage image;

    public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitCompositeImage image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitCompositeImage image) {
            $.image = image;
            return this;
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareIfOrientationPortraitComposite build() {
