...
public final class GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs Empty = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs() {}

    private GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationCompoundTransformationIfDimensionDefaultAspectCropArgs build() {
            return $;
        }
    }
