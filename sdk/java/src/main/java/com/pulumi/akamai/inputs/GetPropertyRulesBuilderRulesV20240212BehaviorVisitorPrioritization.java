...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomCpCode;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization Empty = new GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomCpCode> waitingRoomCpCode() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage;

    /**
     * @return Specifies the NetStorage domain for the waiting room page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomNetStorage> waitingRoomNetStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization() {}

    private GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization(GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder waitingRoomCpCode(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode) {
         ...
         * 
         */
        public Builder waitingRoomNetStorage(@Nullable GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240212BehaviorVisitorPrioritization build() {
            return $;
        }
    }
