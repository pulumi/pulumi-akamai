...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomCpCode;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization Empty = new GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomCpCode> waitingRoomCpCode() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage;

    /**
     * @return Specifies the NetStorage domain for the waiting room page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomNetStorage> waitingRoomNetStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization() {}

    private GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization(GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder waitingRoomCpCode(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode) {
         ...
         * 
         */
        public Builder waitingRoomNetStorage(@Nullable GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240531BehaviorVisitorPrioritization build() {
            return $;
        }
    }
