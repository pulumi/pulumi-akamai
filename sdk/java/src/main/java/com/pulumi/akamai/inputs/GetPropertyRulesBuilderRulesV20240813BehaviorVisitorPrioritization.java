...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomCpCode;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomNetStorage;
...
public final class GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization Empty = new GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization();
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy;

    /**
     * @return Identifies the Cloudlet policy.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationCloudletPolicy> cloudletPolicy() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode;
     ...
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomCpCode> waitingRoomCpCode() {
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage;

    /**
     * @return Specifies the NetStorage domain for the waiting room page.
     * 
     */
    public Optional<GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomNetStorage> waitingRoomNetStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization() {}

    private GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization(GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudletPolicy(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationCloudletPolicy cloudletPolicy) {
         ...
         * 
         */
        public Builder waitingRoomCpCode(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomCpCode waitingRoomCpCode) {
         ...
         * 
         */
        public Builder waitingRoomNetStorage(@Nullable GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritizationWaitingRoomNetStorage waitingRoomNetStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20240813BehaviorVisitorPrioritization build() {
            return $;
        }
    }
