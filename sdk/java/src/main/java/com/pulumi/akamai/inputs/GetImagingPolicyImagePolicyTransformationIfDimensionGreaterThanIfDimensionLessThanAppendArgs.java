...
import com.pulumi.akamai.inputs.GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendImageArgs;
...
public final class GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs Empty = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs();
    ...
    private Output<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendImageArgs> image;

    public Output<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendImageArgs> image() {
        return this.image;
    }
    ...
    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs() {}

    private GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs $) {
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder image(Output<GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendImageArgs> image) {
            $.image = image;
            return this;
        }

        public Builder image(GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendImageArgs image) {
        ...
        public GetImagingPolicyImagePolicyTransformationIfDimensionGreaterThanIfDimensionLessThanAppendArgs build() {
