...
import com.pulumi.akamai.outputs.IamUserUserNotifications;
...
public class IamUser extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="enableMfa", refs={Boolean.class}, tree="[0]")
    private Output</* @Nullable */ Boolean> enableMfa;

    /**
     * @return Indicates whether multi-factor authentication is allowed.
     * 
     */
    public Output<Optional<Boolean>> enableMfa() {
        return Codegen.optional(this.enableMfa);
    }
    /**
    ...
    private Output</* @Nullable */ Boolean> enableTfa;

    /**
     * @return Indicates whether two-factor authentication is allowed.
     * 
     */
    public Output<Optional<Boolean>> enableTfa() {
        return Codegen.optional(this.enableTfa);
    }
    /**
     ...
     * 
     */
    @Export(name="userNotifications", refs={IamUserUserNotifications.class}, tree="[0]")
    private Output<IamUserUserNotifications> userNotifications;

    /**
     * @return Specifies email notifications the user receives for products.
     * 
     */
    public Output<IamUserUserNotifications> userNotifications() {
