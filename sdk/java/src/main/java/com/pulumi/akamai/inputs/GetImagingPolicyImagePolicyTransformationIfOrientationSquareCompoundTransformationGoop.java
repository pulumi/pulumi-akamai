...
public final class GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop Empty = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop();
    ...
    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop() {}

    private GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop $) {
        this.chaos = $.chaos;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationIfOrientationSquareCompoundTransformationGoop build() {
            return $;
        }
    }
