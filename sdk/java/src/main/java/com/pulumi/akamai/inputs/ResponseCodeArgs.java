...
public final class ResponseCodeArgs extends com.pulumi.resources.ResourceArgs {

    public static final ResponseCodeArgs Empty = new ResponseCodeArgs();
    ...
    private ResponseCodeArgs() {}

    private ResponseCodeArgs(ResponseCodeArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(ResponseCodeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ResponseCodeArgs();
        }

        public Builder(ResponseCodeArgs defaults) {
            $ = new ResponseCodeArgs(Objects.requireNonNull(defaults));
        }
