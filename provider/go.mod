...
replace (
	github.com/akamai/terraform-provider-akamai/v9 => ../upstream
...
require (
	github.com/akamai/terraform-provider-akamai/v9 v9.1.0
...
require (
	...
	github.com/akamai/AkamaiOPEN-edgegrid-golang/v12 v12.2.0 // indirect
